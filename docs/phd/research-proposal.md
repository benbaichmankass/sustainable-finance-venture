...
> **Superseded as the canonical statement (2026-08-22).** The question is now held as an architecture rather than a sentence \- one institution-neutral core question and seven strands, each framed for a different advisor profile and all answerable from the same fieldwork. See docs/phd/research-questions.md and data/research-questions.csv. The version below remains the climate-and-poverty framing of the RQ-02 strand and is retained because §1 to §5 of this document are written against it.  
>   
> The scope note above still holds as *a* framing, but geography and population are now deliberately open and adaptable to the programme (decision of 2026-08-22), which is why the experiment menu spans Africa, MENA, Latin America and South Asia rather than Africa/MENA alone.
