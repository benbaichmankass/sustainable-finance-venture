...
// Regenerate with: python3 dashboard/build.py
window.SFV_DATA = {
 "literature": [
  {
   "ID": "LIT-001",
   ...
   "Method": "RCT",
   "Population_Context": "Rural households in VSLA programs",
   "Key_Findings": "Cluster RCT (46 villages, Malawi); positive intent-to-treat effects on savings and consumption smoothing; modest effects on business investment/income",
   "Limitations": "ITT dilutes true effect due to partial compliance; single-country context limits external validity",
   "Relevance_Product": "High",
   "Relevance_Risk": "Medium",
   "Relevance_Impact": "High",
   "Open_Questions": "Does the effect persist beyond the 1-2 year RCT window, and does it survive withdrawal of NGO support?",
   "Link_Citation": "Ksoll et al. 2016 - Impact of Village Savings and Loan Associations",
   "URL": "",
   "Status": "Reviewed"
  },
  {
   ...
   "Population_Context": "VSLA program participants",
   "Key_Findings": "Synthesis of VSLA/savings-group RCTs across countries; savings & resilience effects consistently positive; income/business effects mixed and smaller",
   ...
   "Relevance_Risk": "Medium",
   "Relevance_Impact": "High",
   "Open_Questions": "What governance features drive the best outcomes, and which of them generalise across contexts?",
   "Link_Citation": "Brannen 2016 - Evaluation of the impact of VSLAs",
   "URL": "",
   "Status": "Reviewed"
  },
  {
   ...
   "Population_Context": "Microfinance borrowers",
   "Key_Findings": "Systematic review of microfinance impact studies; average effects on poverty/income are small; strongest evidence for consumption smoothing and female empowerment",
   "Limitations": "Many underlying studies non-experimental; selection bias in who takes loans",
   "Relevance_Product": "Low",
   "Relevance_Risk": "Medium",
   "Relevance_Impact": "High",
   "Open_Questions": "Which subpopulations see the largest effects, and can we screen for them at intake?",
   "Link_Citation": "Duvendack et al. - What is the evidence of microfinance impact",
   "URL": "",
   "Status": "Reviewed"
  },
  {
   ...
   "Geography": "Africa",
   "Method": "Case study / industry report",
   "Population_Context": "MFI loan portfolios",
   "Key_Findings": "Case studies of MFI loan securitization/ABS in Africa (incl. NSIA Cote d'Ivoire, solar securitization Rwanda); shows feasibility but requires scale, standardized data, legal/ratings infrastructure",
   "Limitations": "Small sample of deals; mostly larger MFIs, not yet community-group (VSLA) level assets",
   "Relevance_Product": "High",
   "Relevance_Risk": "High",
   "Relevance_Impact": "Low",
   "Open_Questions": "What legal/regulatory barriers block ABS issuance at community-group level?",
   "Link_Citation": "FSD Africa / BII - microfinance securitization report",
   "URL": "",
   "Status": "Reviewed"
  },
  {
   ...
   "Geography": "Global",
   "Method": "Policy report",
   "Population_Context": "DFIs and private investors",
   "Key_Findings": "G20/OECD review of blended finance de-risking; guarantees and concessional capital mobilize private investment but effectiveness/mobilization ratios vary widely; risk of subsidizing bankable deals",
   ...
   "Open_Questions": "What blended structures have proven replicable at scale, and which fit our risk profile?",
   "Link_Citation": "OECD - Scaling up blended finance in developing countries",
   "URL": "",
   "Status": "Reviewed"
  },
  {
   ...
   "Axis": "3-Securitization",
   "Geography": "Global",
   "Method": "Conceptual/legal review",
   "Population_Context": "MFI loan portfolios",
   "Key_Findings": "Indirect Microcredit-Backed Securitization (IMBS) model: SPV buys receivables from MFI, tranches by risk; senior/junior structure improves rating for senior notes",
   ...
   "Relevance_Risk": "Low",
   "Relevance_Impact": "Low",
   "Open_Questions": "What minimum pool size/data standardization is needed for VSLA-level receivables to be tranche-able?",
   "Link_Citation": "La Torre - Microcredit Securitization",
   "URL": "",
   "Status": "Reviewed"
  },
  {
   "ID": "LIT-007",
   "Axis": "5-Insurance",
   "Geography": "Global (incl. Africa)",
   "Method": "Evidence review",
   "Population_Context": "Low-income households/farmers",
   "Key_Findings": "Parametric microinsurance can improve financial resilience and speed of payout vs indemnity insurance, but take-up remains low without subsidy/bundling",
   "Limitations": "Basis risk (payout doesn't match actual loss) undermines trust and renewal rates",
   "Relevance_Product": "High",
   "Relevance_Risk": "High",
   "Relevance_Impact": "Medium",
   "Open_Questions": "Can parametric triggers be designed around VSLA/group-level shocks (e.g., migrant remittance disruption) rather than only weather?",
   "Link_Citation": "Kousky 2021 - Parametric Microinsurance review",
   "URL": "",
   "Status": "Reviewed"
  },
  {
   "ID": "LIT-008",
   "Axis": "3-Securitization",
   "Geography": "Rwanda / Africa",
   "Method": "Instrument design / case study",
   "Population_Context": "Distributed solar developers/off-grid households",
   "Key_Findings": "Pools many small distributed-asset loans (solar) from multiple originators into one tradable ABS; template for aggregating small, geographically dispersed receivables",
   ...
   "Relevance_Risk": "Medium",
   "Relevance_Impact": "Medium",
   "Open_Questions": "Direct analogue for pooling VSLA/community loans across multiple NGOs into one aggregation vehicle - what standardization is required?",
   "Link_Citation": "Climate Finance Lab - Solar Securitization Rwanda",
   "URL": "",
   "Status": "Reviewed"
  },
  {
   ...
   "Method": "Legal/technical review",
   "Population_Context": "Legal frameworks and capital markets in Europe and Russia",
   "Key_Findings": "Sets out core legal preconditions for securitization: true sale that survives originator insolvency, transferability of receivables, efficient perfection/registration, enforceable security over receivables and collection accounts, tax neutrality, and an insolvency-remote limited-purpose SPV; summarises how several European laws (France, Italy, Spain, Portugal, Greece) addressed these obstacles",
   ...
   "Relevance_Risk": "High",
   "Relevance_Impact": "Low",
   "Open_Questions": "Use its legal checklist to assess whether Israel and target African jurisdictions can support true-sale transfers of VSLA-linked receivables, and whether local or offshore SPVs are feasible.",
   "Link_Citation": "World Bank / IFC 2004 - Securitization: Key Legal and Regulatory Issues",
   "URL": "https://documents1.worldbank.org/curated/en/747401468092077080/pdf/395540Securitization.pdf",
   "Status": "Reviewed"
  },
  {
   "ID": "LIT-010",
   "Axis": "3-Securitization",
   "Geography": "Multi-country (incl. Africa / Europe / Middle East)",
   "Method": "Comparative legal guide",
   "Population_Context": "Securitisation originators and investors across jurisdictions",
   "Key_Findings": "Country-by-country summaries of securitisation rules: SPV requirements, true-sale standards, risk-retention obligations, offering and qualified-investor restrictions, and tax/regulatory constraints; identifies where offshore SPVs are permitted and on what conditions",
   ...
   "Relevance_Risk": "High",
   "Relevance_Impact": "Low",
   "Open_Questions": "Which SPV domiciles and cross-border structures could hold pooled VSLA/community receivables while remaining compliant with local securitisation and investor-protection rules?",
   "Link_Citation": "Baker McKenzie 2020 - A Global Guide to Legal Issues in Securitisation",
   "URL": "https://www.bakermckenzie.com/-/media/files/insight/publications/2020/09/global-securitisation-guide-2020-final_030920.pdf",
   "Status": "Reviewed"
  },
  {
   "ID": "LIT-011",
   "Axis": "3-Securitization",
   "Geography": "Africa",
   "Method": "Policy/market report with case studies",
   "Population_Context": "Capital markets authorities, DFIs, banks and MFIs in African countries",
   "Key_Findings": "A number of African countries have introduced securitisation regulatory frameworks, but deal flow remains thin; closed deals have tended to involve relatively large, standardised portfolios with strong sponsor/DFI involvement; constraints are a shallow institutional investor base, limited rating-agency coverage, and few originators at sufficient scale",
   ...
   "Relevance_Risk": "High",
   "Relevance_Impact": "Medium",
   "Open_Questions": "What transaction sizes and structures (single-country vs regional, single- vs multi-originator) have actually closed in Africa, and what does that imply for minimum viable pool size and aggregation strategy?",
   "Link_Citation": "FSD Africa & BII 2025 - The role of securitisation in developing capital markets in Africa",
   "URL": "https://fsdafrica.org/wp-content/uploads/2025/10/The-role-of-securitisation-in-developing-capital-markets-in-Africa-BII-and-FSD-Africa.pdf",
   "Status": "Reviewed"
  },
  {
   "ID": "LIT-012",
   "Axis": "4-Blended finance",
   "Geography": "Global",
   "Method": "Quantitative survey (180 funds/facilities)",
   "Population_Context": "Blended finance funds and facilities (DFI- and asset-manager-led)",
   "Key_Findings": "Survey of 180 blended vehicles with USD 60.2bn AUM; structured funds with layered junior/senior capital are common; average facility size ~USD 483m and average fund size ~USD 250m; structured funds are more likely to reach >=USD 100m than flat funds; OECD mobilisation methodology attributes 50% of mobilised private capital to official investors in the riskiest tranche",
   ...
   "Relevance_Risk": "High",
   "Relevance_Impact": "Medium",
   "Open_Questions": "What does existing practice imply about sizing the junior/first-loss tranche and the overall vehicle if a VSLA-linked structured product is to attract DFIs and institutional investors?",
   "Link_Citation": "OECD 2019 - Blended Finance Funds and Facilities: 2018 Survey Results (Working Paper 59)",
   "URL": "https://www.oecd.org/content/dam/oecd/en/publications/reports/2019/08/blended-finance-funds-and-facilities_14900999/806991a2-en.pdf",
   "Status": "Reviewed"
  },
  {
   "ID": "LIT-013",
   "Axis": "4-Blended finance",
   "Geography": "Global",
   "Method": "Conceptual / evaluation guidance",
   "Population_Context": "Blended finance instruments and mechanisms (DFIs, donors, evaluators)",
   "Key_Findings": "Typology and evaluation approaches for blended instruments (equity, debt, first-loss capital, guarantees, structured funds, securitisations); first-loss guarantees and junior capital are the key tools in structured funds and securitisations; recommends assessing additionality, mobilisation, financial sustainability and risk; documents the practice of attributing 50% of mobilised private capital to official investors in the riskiest tranche",
   ...
   "Relevance_Risk": "High",
   "Relevance_Impact": "Medium",
   "Open_Questions": "How should a first-loss tranche or pooled guarantee in a VSLA-linked vehicle be designed and documented so DFIs and donors can evaluate additionality and mobilisation against emerging OECD norms?",
   "Link_Citation": "OECD 2021 - Evaluating blended finance instruments and mechanisms",
   "URL": "https://www.oecd.org/content/dam/oecd/en/publications/reports/2021/08/evaluating-blended-finance-instruments-and-mechanisms_c995f112/f1574c10-en.pdf",
   "Status": "Reviewed"
  },
  {
   "ID": "LIT-014",
   "Axis": "1-VSLA",
   "Geography": "East Africa (Tanzania, Uganda, Rwanda; generalisable)",
   "Method": "Policy synthesis",
   "Population_Context": "Savings-group regulators, NGOs and VSLA members",
   "Key_Findings": "Savings groups pose low systemic and AML/CFT risk but face consumer-protection and linkage challenges; argues for proportionate regulation built on voluntary or light-touch registration rather than full prudential rules; recommends delegating registration to local authorities, NGOs and federations and digitising group-level records to increase visibility and enable linkages to banks/MFIs and government support",
   ...
   "Relevance_Risk": "Medium",
   "Relevance_Impact": "High",
   "Open_Questions": "What registration and data-collection model would both protect members and generate the digital, auditable data streams needed to underwrite VSLA-linked credit/insurance and eventual securitisation?",
   "Link_Citation": "CGAP 2025 - Regulating Savings Groups: Only a Proportionate Approach Will Work",
   "URL": "https://www.cgap.org/blog/regulating-savings-groups-only-proportionate-approach-will-work",
   "Status": "Reviewed"
  },
  {
   "ID": "LIT-015",
   ...
   "Geography": "Global",
   "Method": "Policy note",
   "Population_Context": "DFIs, donors and private investors in blended structures",
   "Key_Findings": "Sets out the current menu of first-loss instruments - junior equity, subordinated debt and pooled first-loss guarantees that cover default losses on a first-come, first-served basis - and stresses that concessional instruments are often recyclable or returnable rather than pure grant; frames minimum-concessionality and time-bound support as design norms",
   ...
   "Relevance_Risk": "High",
   "Relevance_Impact": "Medium",
   "Open_Questions": "Which first-loss instrument (junior equity, subordinated debt or pooled guarantee) is the most realistic ask for a first VSLA-linked pilot vehicle, and what tapering plan makes it acceptable to a donor?",
  ...
  },
  {
   ...
   "Relevance_Risk": "High",
   "Relevance_Impact": "Medium",
   "Open_Questions": "Bears directly on OQ-12: if the joint-liability contract is not doing the work, then the underwriting features for RT-2 should describe the group's social structure rather than its liability terms. Raises whether weekly meetings, held constant here, are the actual active ingredient.",
   "Link_Citation": "Gine & Karlan 2009 - Group versus Individual Liability: Long Term Evidence from Philippine Microcredit Lending Groups (Yale EGC WP 970; earlier trial as World Bank WPS4008, 2006; published Journal of Development Economics, 2014)",
   "URL": "https://ideas.repec.org/p/egc/wpaper/970.html",
   "Status": "Reviewed"
  },
  {
   "ID": "LIT-021",
  ...
  },
  {
   ...
   "Link_Citation": "Tankha 2012 - Banking on Self-help Groups: Twenty Years On (ACCESS Development Services / SAGE)",
   "URL": "https://www.findevgateway.org/sites/default/files/publications/files/mfg-en-paper-banking-on-self-help-groups-twenty-years-on-2012.pdf",
   "Status": "Reviewed"
  },
  {
   "ID": "LIT-024",
   ...
   "Relevance_Risk": "High",
   "Relevance_Impact": "High",
   "Open_Questions": "Directly undercuts the novelty claim in docs/phd/phd-proposal-master.md that the literature raises but rarely tests loan-insurance bundling - it has been tested, experimentally, and mandatory bundling reduced take-up. Bears on OQ-16 (field anchor) and on EXP-01, whose design is precisely premium-financed-into-principal compulsory cover. Makes EXP-17 (separating the take-up effect from the protection effect) the live question rather than an add-on. See OQ-17.",
   "Link_Citation": "Gine & Yang 2009 - Insurance, credit, and technology adoption: Field experimental evidence from Malawi (Journal of Development Economics 89(1) 1-11)",
   "URL": "https://www.povertyactionlab.org/evaluation/insurance-credit-and-technology-adoption-malawi",
   "Status": "To read"
  },
  {
   "ID": "LIT-025",
   ...
   "Relevance_Risk": "High",
   "Relevance_Impact": "Medium",
   "Open_Questions": "Answers LC-04's third question - yes, someone has measured bundling's effect on the lender's own book, and it was strongly negative. Any cash-flow model that assumes bundling is retention-neutral is unsupported. Feeds OQ-17 and the RT-6 assumptions.",
   "Link_Citation": "Banerjee, Duflo & Hornbeck 2014 - Bundling Health Insurance and Microfinance in India: There Cannot Be Adverse Selection If There Is No Demand (American Economic Review 104(5) 291-297)",
   "URL": "https://www.aeaweb.org/articles?id=10.1257/aer.104.5.291",
   "Status": "To read"
  },
  {
   "ID": "LIT-026",
   "Axis": "5-Insurance",
   "Geography": "Ghana (northern)",
   "Method": "RCT (field experiment, multiple arms and years)",
   "Population_Context": "Small-scale farmers randomised to cash grants, rainfall index insurance (granted or offered for purchase), or both",
   "Key_Findings": "The counterweight, and the reason the picture is a tension rather than a verdict. The abstract states that demand for index insurance is strong and that insurance leads to significantly larger agricultural investment and riskier production choices; the binding constraint to farmer investment is uninsured risk, not capital - when insured against the primary catastrophic risk, farmers find resources to increase farm spending. Subsequent-year demand rises with the farmer's own payouts, with payouts to others in their social network, and after recent poor rain. Patterns are consistent with meaningful basis risk, imperfect trust that payouts will arrive, and overweighting of recent events.",
  ...
  },
  {
   ...
   "Relevance_Risk": "Medium",
   "Relevance_Impact": "Low",
   "Open_Questions": "Reading the model is now a priority because it may reconcile LIT-024 with LIT-026: Gine and Yang attribute low insured-loan take-up to implicit insurance from limited liability, which is a collateral-environment argument of exactly the kind this paper formalises. Feeds LC-04 and OQ-17.",
   "Link_Citation": "Carter, Cheng & Sarris 2016 - Where and how index insurance can boost the adoption of improved agricultural technologies (Journal of Development Economics 118(C) 59-71)",
   "URL": "https://ideas.repec.org/a/eee/deveco/v118y2016icp59-71.html",
   "Status": "To read"
  },
  {
   "ID": "LIT-028",
  ...
  },
  {
   ...
   "Relevance_Risk": "Medium",
   "Relevance_Impact": "High",
   "Open_Questions": "Bears on OQ-16: certification is a usable organising structure but is NOT an income mechanism to build a welfare claim on - the total-household-income effect is not distinguishable from zero across the whole literature. Any coffee design that leans on the certification premium as the counterfactual improvement needs to say why it expects better than this. Also a methodological warning for the project's own design: a field of 43 studies with no RCT is a field where a well-powered randomised design is itself a contribution.",
   "Link_Citation": "Oya, Schaefer, Skalidou, McCosker & Langer 2017 - Effects of certification schemes for agricultural production on socio-economic outcomes in low- and middle-income countries: a systematic review (3ie Systematic Review 34; Campbell Systematic Reviews 13)",
   "URL": "https://www.3ieimpact.org/sites/default/files/2019-01/sr34-certification-schemes-agricultural-production_0.pdf",
   "Status": "Reviewed"
  },
  {
   "ID": "LIT-033",
   "Axis": "5-Insurance",
   "Geography": "Ethiopia (Sidama Region)",
   "Method": "Cross-sectional household survey with propensity score matching and nearest-neighbour matching",
   "Population_Context": "530 smallholder coffee households - 370 certified, 160 non-certified - drawn from 20 primary co-operatives (12 certified, 8 non-certified) across six woredas",
 ...
 "researchQuestions": [
  {
   ...
   "Tier": "Core",
   "Parent": "",
   "Question": "Can the credit and insurance cash flows originated by community financial structures be made investor-legible - standardised, verifiable, poolable - without degrading the social mechanisms that make them perform, and what does that trade-off cost in risk terms and in welfare terms?",
   "Short_Form": "Can community finance be made investor-legible without breaking what makes it work?",
   "Discipline_Frame": "Development finance / empirical finance",
   "Advisor_Profile": "Any - this is the institution-neutral phrasing every strand narrows from",
   "Method_Implied": "Field experiment plus credit-risk modelling plus structuring simulation",
   "Fits_Programs": "All",
   "Component_Refs": "LC-01; LC-02; LC-07; LC-09",
   "Experiment_Refs": "EXP-12; EXP-13; EXP-22",
   "Evidence_Refs": "LIT-020; LIT-021; LIT-022; LIT-023; LIT-011",
   "Status": "Active"
  },
  {
   "ID": "RQ-02",
   "Tier": "Strand",
   "Parent": "RQ-01",
   "Question": "What is the causal effect of bundling climate or health cover into community-originated credit on household resilience outcomes and on the stability of the resulting repayment stream?",
   "Short_Form": "Does bundling cover into group credit improve resilience and repayment stability?",
   "Discipline_Frame": "Development economics / impact evaluation",
   "Advisor_Profile": "RCT and field-experiment labs; microinsurance and rural finance economists",
   "Method_Implied": "Cluster-randomised trial with pre-registration; stepped wedge as fallback",
   "Fits_Programs": "PHD-15; PHD-22; PHD-27; PHD-21; PHD-44; PHD-48; PHD-52; PHD-51; PHD-30",
   "Component_Refs": "LC-03; LC-04; LC-05; LC-13; LC-26",
   "Experiment_Refs": "EXP-01; EXP-06; EXP-09; EXP-17; EXP-18; EXP-19; EXP-20",
   "Evidence_Refs": "LIT-001; LIT-002; LIT-003; LIT-007",
   "Status": "Active"
  },
  {
   "ID": "RQ-03",
   "Tier": "Strand",
   "Parent": "RQ-01",
   "Question": "Are community-originated loan and claims cash flows stable and well-characterised enough to be modelled with standard credit-risk and actuarial techniques, and what correlation structure and credit enhancement would an investment-grade pool require?",
   "Short_Form": "Can these cash flows be modelled and enhanced to investment grade?",
   "Discipline_Frame": "Empirical finance / actuarial science / credit risk",
   "Advisor_Profile": "Structured-finance, actuarial and quantitative-finance faculty",
   "Method_Implied": "Survival and hazard modelling, loss-given-default estimation, Monte Carlo waterfall simulation",
   "Fits_Programs": "PHD-10; PHD-18; PHD-17; PHD-07; PHD-31; PHD-25; PHD-12",
   "Component_Refs": "LC-07; LC-08; LC-09; LC-11; LC-20",
   "Experiment_Refs": "EXP-25; EXP-26; EXP-27; EXP-28",
   "Evidence_Refs": "LIT-004; LIT-006; LIT-011; LIT-016",
   "Status": "Active"
  },
  {
   "ID": "RQ-04",
   "Tier": "Strand",
   "Parent": "RQ-01",
   "Question": "Which mechanism actually drives repayment in community-originated lending - local information, social sanction, or repeated interaction - and which of those survives when external wholesale capital replaces the community's own money as the funding source?",
   "Short_Form": "What drives repayment, and does it survive external capital?",
   "Discipline_Frame": "Contract theory / behavioural and institutional economics",
   "Advisor_Profile": "Microfinance mechanism scholars; contract theorists; lab-in-field experimentalists",
   "Method_Implied": "Lab-in-field experiments plus randomised variation in funding source and liability structure",
   "Fits_Programs": "PHD-20; PHD-52; PHD-41; PHD-24; PHD-48; PHD-22",
   "Component_Refs": "LC-02; LC-18; LC-01",
   "Experiment_Refs": "EXP-12; EXP-13; EXP-14; EXP-15",
   "Evidence_Refs": "LIT-020; LIT-021; LIT-022; LIT-023",
   "Status": "Active"
  },
  {
   "ID": "RQ-05",
   "Tier": "Strand",
   "Parent": "RQ-01",
   "Question": "Under what conditions does blended credit enhancement actually mobilise private capital into pools of community-originated assets rather than substituting for it, and how is the resulting surplus distributed between investors, intermediaries and originating households?",
   "Short_Form": "When does first-loss capital mobilise rather than substitute, and who captures the gain?",
   "Discipline_Frame": "Development finance / political economy of capital",
   "Advisor_Profile": "Development-finance and sustainable-finance scholars; DFI-linked researchers",
   "Method_Implied": "Deal-level panel analysis, structured elicitation with investors, incidence modelling",
   "Fits_Programs": "PHD-13; PHD-14; PHD-23; PHD-26; PHD-04; PHD-29",
   "Component_Refs": "LC-12; LC-11; LC-18; LC-20",
   "Experiment_Refs": "EXP-23; EXP-24; EXP-27",
   "Evidence_Refs": "LIT-005; LIT-012; LIT-013; LIT-015; LIT-018; LIT-019",
   "Status": "Active"
  },
  {
   "ID": "RQ-06",
   "Tier": "Strand",
   "Parent": "RQ-01",
   "Question": "What is the minimum origination data architecture that makes a community loan or policy book poolable, and what is the marginal operational cost of each additional increment of investability?",
   "Short_Form": "What data must be captured at origination, and what does it cost?",
   "Discipline_Frame": "Information systems / design science / applied microeconomics",
   "Advisor_Profile": "Data-and-decision-science faculty; financial-inclusion technology researchers",
   "Method_Implied": "Design-science build plus randomised protocol comparison and activity-based costing",
   "Fits_Programs": "PHD-12; PHD-14; PHD-30; PHD-38; PHD-26",
   "Component_Refs": "LC-09; LC-14; LC-20; LC-25",
   "Experiment_Refs": "EXP-21; EXP-22; EXP-11",
   "Evidence_Refs": "LIT-009; LIT-010; LIT-011; LIT-014",
   "Status": "Active"
  },
  {
   "ID": "RQ-07",
   "Tier": "Strand",
   "Parent": "RQ-01",
   "Question": "Does geographic and peril diversification of household-level climate exposures reduce basis risk and capital requirements enough to make adaptation finance viable at household scale, and where are the limits of that diversification?",
   "Short_Form": "Can pooling household climate risk make adaptation finance work at household scale?",
   "Discipline_Frame": "Climate and sustainable finance",
   "Advisor_Profile": "Sustainable-finance centres; climate-risk and adaptation-finance researchers",
   "Method_Implied": "Spatial correlation analysis of index triggers plus capital-requirement simulation",
   "Fits_Programs": "PHD-04; PHD-05; PHD-13; PHD-33; PHD-32",
   "Component_Refs": "LC-03; LC-06; LC-08",
   "Experiment_Refs": "EXP-06; EXP-30; EXP-27",
   "Evidence_Refs": "LIT-007; LIT-008; LIT-015",
   "Status": "Active"
  },
  {
   "ID": "RQ-08",
   "Tier": "Strand",
   "Parent": "RQ-01",
   "Question": "How far does a product design and its calibrated risk model travel across institutional forms - savings group, rotating credit association, agricultural cooperative - and across geographies, and which parameters must be re-estimated at each move?",
   "Short_Form": "What transfers across institutional forms and sites, and what must be re-estimated?",
   "Discipline_Frame": "Development studies / external validity and replication",
   "Advisor_Profile": "Development-studies and replication-focused researchers; comparative institutional economists",
   "Method_Implied": "Multi-site replication with a common protocol; hierarchical and Bayesian pooling of effects",
   "Fits_Programs": "PHD-14; PHD-26; PHD-27; PHD-16; PHD-23",
   "Component_Refs": "LC-01; LC-24; LC-26; LC-08",
   "Experiment_Refs": "EXP-09; EXP-29; EXP-28",
   "Evidence_Refs": "LIT-002; LIT-003; LIT-023",
   "Status": "Active"
  },
  {
   "ID": "RQ-09",
   "Tier": "Sub",
   "Parent": "RQ-02",
   "Question": "Does automatic cover financed into loan principal produce different resilience and repayment effects than opt-in cover at the same actuarial price, and how much of any difference is take-up rather than protection?",
   "Short_Form": "Automatic versus opt-in cover: protection effect or take-up effect?",
   "Discipline_Frame": "",
   "Advisor_Profile": "",
   "Method_Implied": "Cluster RCT with a price-equalised opt-in arm",
   "Fits_Programs": "",
   "Component_Refs": "LC-03; LC-04",
   "Experiment_Refs": "EXP-01; EXP-17",
   "Evidence_Refs": "",
   "Status": "Active"
  },
  {
   ...
   "Tier": "Sub",
   "Parent": "RQ-02",
   "Question": "Are the resilience gains from bundling concentrated in the tail - households actually hit by a shock - and is a design powered for mean effects powered for the effect that matters?",
   "Short_Form": "Are the gains in the tail, and are we powered for them?",
   "Discipline_Frame": "",
   "Advisor_Profile": "",
   "Method_Implied": "Tail-powered cluster RCT with shock-conditional pre-specified subgroups",
   "Fits_Programs": "",
   "Component_Refs": "LC-05; LC-26",
   "Experiment_Refs": "EXP-01; EXP-06",
   "Evidence_Refs": "",
   "Status": "Active"
  },
  {
   ...
   "Tier": "Sub",
   "Parent": "RQ-02",
   "Question": "Does bundling shift the composition of who borrows, and does any measured improvement in portfolio performance reflect real risk reduction or selection into the treated pool?",
   "Short_Form": "Risk reduction or selection?",
   "Discipline_Frame": "",
   "Advisor_Profile": "",
   "Method_Implied": "Randomised access with full applicant-side data capture",
   "Fits_Programs": "",
   "Component_Refs": "LC-04; LC-13",
   "Experiment_Refs": "EXP-01; EXP-20",
   "Evidence_Refs": "",
   "Status": "Active"
  },
  {
   ...
   "Tier": "Sub",
   "Parent": "RQ-03",
   "Question": "What hazard specification best fits time-to-default and time-to-claim in community-originated books, and how badly does a short panel bias the resulting loss curve?",
   "Short_Form": "Which hazard model fits, and what does a short panel cost?",
   "Discipline_Frame": "",
   "Advisor_Profile": "",
   "Method_Implied": "Survival analysis on partner administrative data with horizon sensitivity",
   "Fits_Programs": "",
   "Component_Refs": "LC-07",
   "Experiment_Refs": "EXP-26; EXP-25",
   "Evidence_Refs": "",
   "Status": "Active"
  },
  {
   ...
   "Tier": "Sub",
   "Parent": "RQ-03",
   "Question": "How correlated are defaults across groups, villages and agro-climatic zones, and does the covariate component dominate the idiosyncratic component that community structures are good at managing?",
   "Short_Form": "How much of the risk is covariate rather than idiosyncratic?",
   "Discipline_Frame": "",
   "Advisor_Profile": "",
   "Method_Implied": "Multi-level correlation estimation on pooled originator data",
   "Fits_Programs": "",
   "Component_Refs": "LC-08; LC-03",
   "Experiment_Refs": "EXP-25; EXP-27",
   "Evidence_Refs": "",
   "Status": "Active"
  },
  {
   ...
   "Tier": "Sub",
   "Parent": "RQ-03",
   "Question": "What first-loss thickness, originator diversification and reserve design bring a modelled pool to investment-grade loss characteristics, and how sensitive is that answer to each assumption?",
   "Short_Form": "What enhancement gets to investment grade, and how fragile is that?",
   "Discipline_Frame": "",
   "Advisor_Profile": "",
   "Method_Implied": "Monte Carlo waterfall simulation with systematic sensitivity analysis",
   "Fits_Programs": "",
   "Component_Refs": "LC-09; LC-12",
   "Experiment_Refs": "EXP-27",
   "Evidence_Refs": "",
   "Status": "Active"
  },
  {
   ...
   "Tier": "Sub",
   "Parent": "RQ-04",
   "Question": "When a group's loan book is funded externally rather than from members' own savings, does repayment behaviour change, and through which of the screening, monitoring and enforcement channels?",
   "Short_Form": "Does external funding change repayment behaviour, and how?",
   "Discipline_Frame": "",
   "Advisor_Profile": "",
   "Method_Implied": "Randomised funding-source substitution within matched groups",
   "Fits_Programs": "",
   "Component_Refs": "LC-02; LC-18",
   "Experiment_Refs": "EXP-13",
   "Evidence_Refs": "",
   "Status": "Active"
  },
  {
   ...
   "Tier": "Sub",
   "Parent": "RQ-04",
   "Question": "Does moving the creditor relationship from the member to the group - lending to the collective which then on-lends - preserve or destroy the local information advantage?",
   "Short_Form": "Does lending to the group instead of the member preserve local information?",
   "Discipline_Frame": "",
   "Advisor_Profile": "",
   "Method_Implied": "Randomised assignment of lending level with performance and information measures",
   "Fits_Programs": "",
   "Component_Refs": "LC-02; LC-01",
   "Experiment_Refs": "EXP-12",
   "Evidence_Refs": "",
   "Status": "Active"
  },
  {
   ...
   "Tier": "Sub",
   "Parent": "RQ-04",
   "Question": "Which group governance rules - buffer size, emergency-fund design, disclosure between members - causally affect default and resilience, and are they substitutes for or complements to formal underwriting?",
   "Short_Form": "Which group rules actually move default, and do they substitute for underwriting?",
   "Discipline_Frame": "",
   "Advisor_Profile": "",
   "Method_Implied": "Randomised governance-rule variation at group level",
   "Fits_Programs": "",
   "Component_Refs": "LC-02; LC-01",
   "Experiment_Refs": "EXP-14; EXP-15",
   "Evidence_Refs": "",
   "Status": "Active"
  },
  {
   ...
   "Tier": "Sub",
   "Parent": "RQ-05",
   "Question": "What mobilisation ratio do first-loss and guarantee instruments achieve for community-originated asset pools specifically, as against the blended-finance average, and what explains any shortfall?",
   "Short_Form": "What do these pools actually mobilise, versus the blended-finance average?",
   "Discipline_Frame": "",
   "Advisor_Profile": "",
   "Method_Implied": "Deal-level analysis benchmarked against Convergence and OECD series",
   "Fits_Programs": "",
   "Component_Refs": "LC-12; LC-11",
   "Experiment_Refs": "EXP-23",
   "Evidence_Refs": "",
   "Status": "Active"
  },
  {
   ...
   "Tier": "Sub",
   "Parent": "RQ-05",
   "Question": "What do investors and structurers actually require of a community-originated data tape before they will price it, and how much of the required disclosure is informative rather than conventional?",
   "Short_Form": "What disclosure do investors need, and how much of it is informative?",
   "Discipline_Frame": "",
   "Advisor_Profile": "",
   "Method_Implied": "Framed field experiment and structured elicitation with investors and raters",
   "Fits_Programs": "",
   "Component_Refs": "LC-09; LC-12",
   "Experiment_Refs": "EXP-23; EXP-24",
   "Evidence_Refs": "",
   "Status": "Active"
  },
  {
   ...
   "Tier": "Sub",
   "Parent": "RQ-05",
   "Question": "How is the spread between what the pool earns and what households pay divided across the structuring, servicing and origination layers, and does securitisation lower or raise the household's cost of credit?",
   "Short_Form": "Who captures the spread, and does securitisation help or hurt the borrower?",
   "Discipline_Frame": "",
   "Advisor_Profile": "",
   "Method_Implied": "Incidence analysis on the unit-economics model with pilot cost data",
   "Fits_Programs": "",
   "Component_Refs": "LC-20; LC-17",
   "Experiment_Refs": "EXP-22; EXP-27",
   "Evidence_Refs": "",
   "Status": "Active"
  },
  {
   ...
   "Tier": "Sub",
   "Parent": "RQ-06",
   "Question": "Which origination fields are load-bearing for pricing and pooling, and which are collected because a template asked for them?",
   "Short_Form": "Which data fields actually carry pricing information?",
   "Discipline_Frame": "",
   "Advisor_Profile": "",
   "Method_Implied": "Predictive contribution analysis against the RT-1 field set",
   "Fits_Programs": "",
   "Component_Refs": "LC-09; LC-14",
   "Experiment_Refs": "EXP-22",
   "Evidence_Refs": "",
   "Status": "Active"
  },
  {
   ...
   "Tier": "Sub",
   "Parent": "RQ-06",
   "Question": "What is the marginal operational cost per household of securitisation-ready capture relative to standard practice, and at what portfolio size does it pay for itself?",
   "Short_Form": "What does investability cost per household, and when does it pay back?",
   "Discipline_Frame": "",
   "Advisor_Profile": "",
   "Method_Implied": "Randomised protocol comparison with activity-based costing",
   "Fits_Programs": "",
   "Component_Refs": "LC-20; LC-14",
   "Experiment_Refs": "EXP-22; EXP-21",
   "Evidence_Refs": "",
   "Status": "Active"
  },
  {
   ...
   "Tier": "Sub",
   "Parent": "RQ-06",
   "Question": "Does digitising the group ledger change repayment behaviour itself, so that the measurement instrument is also an intervention?",
   "Short_Form": "Does digitising the ledger change the thing it measures?",
   "Discipline_Frame": "",
   "Advisor_Profile": "",
   "Method_Implied": "Randomised rollout of digital ledgers with behavioural outcomes",
   "Fits_Programs": "",
   "Component_Refs": "LC-14; LC-25",
   "Experiment_Refs": "EXP-21",
   "Evidence_Refs": "",
   "Status": "Active"
  },
  {
   ...
   "Tier": "Sub",
   "Parent": "RQ-07",
   "Question": "How spatially correlated are parametric triggers across candidate origination sites, and how many uncorrelated sites does a pool need before diversification meaningfully cuts required capital?",
   "Short_Form": "How many uncorrelated sites does diversification actually need?",
   "Discipline_Frame": "",
   "Advisor_Profile": "",
   "Method_Implied": "Spatial and temporal correlation analysis of index series",
   "Fits_Programs": "",
   "Component_Refs": "LC-03; LC-08; LC-06",
   "Experiment_Refs": "EXP-06; EXP-27",
   "Evidence_Refs": "",
   "Status": "Active"
  },
  {
   ...
   "Tier": "Sub",
   "Parent": "RQ-07",
   "Question": "Does reducing basis risk through better loss verification raise measured welfare effects enough to justify its cost, or is cheap-and-imperfect the efficient design?",
   "Short_Form": "Is lower basis risk worth what it costs?",
   "Discipline_Frame": "",
   "Advisor_Profile": "",
   "Method_Implied": "Randomised comparison of index verification methods",
   "Fits_Programs": "",
   "Component_Refs": "LC-03; LC-05",
   "Experiment_Refs": "EXP-30",
   "Evidence_Refs": "",
   "Status": "Active"
  },
  {
   ...
   "Tier": "Sub",
   "Parent": "RQ-07",
   "Question": "Which adaptation outcomes does household-level climate cover actually shift - asset retention, input adoption, distress sales - and which are unmoved?",
   "Short_Form": "Which adaptation outcomes does cover actually move?",
   "Discipline_Frame": "",
   "Advisor_Profile": "",
   "Method_Implied": "Cluster RCT with pre-specified adaptation outcome family",
   "Fits_Programs": "",
   "Component_Refs": "LC-05; LC-06",
   "Experiment_Refs": "EXP-06; EXP-01",
   "Evidence_Refs": "",
   "Status": "Active"
  },
  {
   ...
   "Tier": "Sub",
   "Parent": "RQ-08",
   "Question": "Do effects estimated in savings groups replicate in agricultural cooperatives and rotating credit associations, or is the institutional form itself a treatment moderator?",
   "Short_Form": "Does the institutional form moderate the effect?",
   "Discipline_Frame": "",
   "Advisor_Profile": "",
   "Method_Implied": "Common-protocol replication across institutional forms",
   "Fits_Programs": "",
   "Component_Refs": "LC-01; LC-24",
   "Experiment_Refs": "EXP-09; EXP-29",
   "Evidence_Refs": "",
   "Status": "Active"
  },
  {
   ...
   "Tier": "Sub",
   "Parent": "RQ-08",
   "Question": "Which risk-model parameters are portable across sites and which must be re-estimated locally, and what does that imply for the cost of entering a new geography?",
   "Short_Form": "Which risk parameters travel, and which do not?",
   "Discipline_Frame": "",
   "Advisor_Profile": "",
   "Method_Implied": "Hierarchical model with site-level partial pooling",
   "Fits_Programs": "",
   "Component_Refs": "LC-08; LC-07",
   "Experiment_Refs": "EXP-25; EXP-28",
   "Evidence_Refs": "",
   "Status": "Active"
  },
  {
   ...
   "Tier": "Sub",
   "Parent": "RQ-08",
   "Question": "Can a protocol developed in a logistically easy, well-regulated setting be transferred to a harder field site without losing identification, and what is lost in the move?",
   "Short_Form": "Does a protocol developed somewhere easy survive somewhere hard?",
   "Discipline_Frame": "",
   "Advisor_Profile": "",
   "Method_Implied": "Sequential two-site design with a shared pre-registered protocol",
   "Fits_Programs": "",
   "Component_Refs": "LC-25; LC-26",
   "Experiment_Refs": "EXP-29; EXP-09",
   "Evidence_Refs": "",
   "Status": "Active"
  }
 ],
 "litComponents": [
  {
   "ID": "LC-01",
   "Component": "Savings groups and community finance institutions",
   "Axis": "1-VSLA",
   "Priority": "P1",
   "Why_It_Matters": "The origination layer itself. Everything downstream assumes these institutions are durable and that their behaviour is characterisable; the matrix supports the first claim better than the second.",
   "Serves_RQs": "RQ-01; RQ-04; RQ-08",
   "Questions_To_Answer": "How durable are savings groups over multiple cycles? What is the institutional taxonomy (VSLA, ROSCA, ASCA, SHG, cooperative) and how do the forms differ in governance and cash-flow behaviour? What are the documented failure modes?",
   "Search_Terms": "village savings and loan association; savings group; ROSCA; ASCA; self-help group; accumulating savings and credit association; group durability; savings group dropout",
   "Current_Anchors": "LIT-001; LIT-002; LIT-014; LIT-023",
   "Target_Anchors": "10",
   "Output_Memo": "MEMO-1 (extend)",
   "Status": "Partially covered"
  },
  {
   "ID": "LC-02",
   "Component": "Group-lending mechanisms: information, sanction, repeat interaction",
   "Axis": "2-Microfinance",
   "Priority": "P1",
   "Why_It_Matters": "This is the mechanism the whole thesis turns on. OQ-12 is partially answered and OQ-13 is fully open; both need this component deeper than four anchors.",
   "Serves_RQs": "RQ-01; RQ-04",
   "Questions_To_Answer": "Which channel actually drives repayment, and how were the channels separated empirically? What evidence exists on what happens when the funding source changes? Is there any prior work on group-level versus member-level lending?",
   "Search_Terms": "joint liability; group lending; peer monitoring; peer screening; social collateral; dynamic incentives; individual liability conversion; SHG bank linkage; social capital microfinance",
   "Current_Anchors": "LIT-020; LIT-021; LIT-022; LIT-023",
   "Target_Anchors": "12",
   "Output_Memo": "MEMO-4",
   "Status": "Partially covered"
  },
  {
   "ID": "LC-03",
   "Component": "Index and parametric insurance: demand, basis risk, impact",
   "Axis": "5-Insurance",
   "Priority": "P1",
   "Why_It_Matters": "FIRST PASS DONE 2026-08-22, and it compounds the LC-04 finding rather than softening it. Three things now stand on the record. (1) LIT-029, the authoritative review, states take-up has been DISAPPOINTINGLY LOW WITHOUT LARGE AND SUSTAINED SUBSIDIES - and our EXP-01 design does the opposite of subsidising, it adds the premium to the amount owed. (2) LIT-028 shows low demand may be RATIONAL rather than a behavioural failure: with basis risk, optimal demand for an index product is zero for the infinitely risk-averse and nonmonotonic in risk aversion, wealth and price. If that is right, compelling purchase overrides a correct decision instead of correcting a mistake. (3) LIT-030 measures basis risk directly and finds it, plus spatiotemporal adverse selection, materially drives demand - and the adverse-selection half is a warning for the pool's loss distribution, not just for take-up. Remaining: the empirical demand literature proper (Cole et al. on barriers to household risk management is the obvious next read), the impact side, and index-based livestock insurance outcomes.",
   "Serves_RQs": "RQ-02; RQ-07",
   "Questions_To_Answer": "What does the RCT evidence say about take-up and welfare effects of index insurance? How large is basis risk in practice and what reduces it? Why is demand persistently low at actuarially fair prices? What does the index-based livestock insurance record show?",
   "Search_Terms": "index insurance; weather index insurance; parametric insurance; basis risk; index based livestock insurance; picture based insurance; insurance demand puzzle; agricultural insurance take-up",
   "Current_Anchors": "LIT-007; LIT-028; LIT-029; LIT-030",
   "Target_Anchors": "12",
   "Output_Memo": "MEMO-5",
   "Status": "Partially covered"
  },
  ...
  {
   "ID": "LC-05",
   "Component": "Resilience and consumption-smoothing outcome measurement",
   "Axis": "2-Microfinance",
   "Priority": "P1",
   "Why_It_Matters": "Flagged as a gap in research-proposal.md. Memo 2 concludes the defensible claim is resilience and smoothing rather than income, which makes the measurement of resilience the load-bearing methodological choice. OPENED 2026-08-22, one anchor of eight. LIT-039 (FAO RIMA short questionnaire) supplies a citable, CC-licensed instrument and answers the operationalisation and survey-instrument questions: a latent-variable Resilience Capacity Index over four pillars, 41 questions in short form, with a shocks module. It does NOT answer the hardest question in this component - distinguishing consumption SMOOTHING from consumption LEVEL - and it measures resilience to food insecurity specifically, which is not the same estimand as a credit-and-insurance outcome.",
   "Serves_RQs": "RQ-02; RQ-07",
   "Questions_To_Answer": "How is household resilience operationalised and which indices are defensible? How are shocks timed and verified? What recall periods and survey instruments are standard? How is consumption smoothing distinguished from consumption level?",
   "Search_Terms": "resilience measurement household; consumption smoothing measurement; coping strategies index; asset based resilience; food insecurity experience scale; shock module household survey",
   "Current_Anchors": "LIT-039",
   "Target_Anchors": "8",
   "Output_Memo": "MEMO-5",
   "Status": "In progress"
  },
  ...
  {
   "ID": "LC-07",
   "Component": "Credit-risk modelling in thin-data settings",
   "Axis": "3-Securitization",
   "Priority": "P1",
   "Why_It_Matters": "RQ-03 is a whole strand and has no methodological anchors at all. The technical claim that these cash flows can be modelled needs the modelling literature behind it. OPENED 2026-08-22, one anchor of ten. LIT-038 gives RQ-03 the method it lacked - Pluto-Tasche upper confidence bounds for a portfolio with zero or near-zero observed defaults - and, more usefully, locates where the modelling is load-bearing: the PD bound is a function of an ASSET CORRELATION that is assumed, not estimated. That is the same parameter LC-08 says nobody has measured for this asset class, so LC-07 and LC-08 are one problem, not two. Still unanchored here: loss given default with few recoveries, competing risks of default and prepayment, short-panel corrections, and model-risk disclosure.",
   "Serves_RQs": "RQ-01; RQ-03; RQ-08",
   "Questions_To_Answer": "Which hazard and survival specifications are standard for small-ticket unsecured credit? How is loss-given-default estimated with few observed recoveries? What are the small-sample and short-panel corrections? How is model risk disclosed?",
   "Search_Terms": "survival analysis credit default; hazard model loan default; loss given default estimation; probability of default low default portfolio; microfinance credit scoring; competing risks default prepayment",
   "Current_Anchors": "LIT-038",
   "Target_Anchors": "10",
   "Output_Memo": "MEMO-7",
   "Status": "In progress"
  },
  ...
  {
   "ID": "LC-09",
   "Component": "Securitisation eligibility, data tapes and rating criteria",
   "Axis": "3-Securitization",
   "Priority": "P1",
   "Why_It_Matters": "OQ-3 and RQ-06 both need the target specification: what a data tape must contain before anyone will price it. The matrix has the deal-level view but not the field-level requirement.",
   "Serves_RQs": "RQ-01; RQ-03; RQ-05; RQ-06",
   "Questions_To_Answer": "What loan-level fields do standard reporting templates require? What eligibility criteria are typical for EM consumer and microfinance ABS? What do rating methodologies require of originator track record and servicing? Will an agency engage pre-track-record?",
   "Search_Terms": "ABS loan level data template; European DataWarehouse; securitisation eligibility criteria; rating methodology consumer ABS; originator servicer review; data tape structured finance",
   "Current_Anchors": "LIT-004; LIT-006; LIT-011",
   "Target_Anchors": "10",
   "Output_Memo": "MEMO-7",
   "Status": "Partially covered"
  },
  {
   "ID": "LC-10",
   "Component": "Securitisation law, true sale and SPV domicile",
   "Axis": "3-Securitization",
   "Priority": "P2",
   "Why_It_Matters": "OQ-1 is blocked on counsel, not literature, but the thesis still needs the doctrinal frame written up rather than a checklist.",
   "Serves_RQs": "RQ-05; RQ-06",
   "Questions_To_Answer": "What makes an assignment a true sale across candidate jurisdictions? How is insolvency remoteness achieved where local trust law is thin? What changed with the EU Securitisation Regulation and Basel III/IV since LIT-009?",
   "Search_Terms": "true sale securitisation; insolvency remote SPV; assignment of receivables law; EU Securitisation Regulation; securitisation law Africa; STS securitisation",
   "Current_Anchors": "LIT-009; LIT-010",
   "Target_Anchors": "8",
   "Output_Memo": "MEMO-8",
   "Status": "Partially covered"
  },
  {
   "ID": "LC-11",
   "Component": "African and emerging-market capital-market depth",
   "Axis": "3-Securitization",
   "Priority": "P2",
   "Why_It_Matters": "OQ-2's pool-size answer depends on who could actually buy the paper, in what currency, under what mandate.",
   "Serves_RQs": "RQ-03; RQ-05",
   "Questions_To_Answer": "Which African markets have functioning securitisation frameworks and completed deals? Who are the domestic institutional buyers? How is currency risk handled in local-currency structures? What did the deals that closed have in common?",
   "Search_Terms": "African securitisation market; local currency bond market Africa; pension fund allocation Africa; domestic institutional investors frontier markets; currency hedging development finance",
   "Current_Anchors": "LIT-008; LIT-011; LIT-012",
   "Target_Anchors": "8",
   "Output_Memo": "MEMO-8",
   "Status": "Partially covered"
  },
  {
   "ID": "LC-12",
   "Component": "Blended finance, first-loss and guarantees",
   "Axis": "4-Blended finance",
   "Priority": "P2",
   "Why_It_Matters": "Well covered for structuring mechanics; thin on whether mobilisation claims survive scrutiny, which is exactly what RQ-05 asks.",
   "Serves_RQs": "RQ-05; RQ-03",
   "Questions_To_Answer": "What counterfactual evidence exists that concessional capital mobilises rather than substitutes? How are mobilisation ratios computed and how contested are they? What does the additionality critique say?",
   "Search_Terms": "blended finance mobilisation; catalytic first loss capital; private capital mobilisation additionality; guarantee mobilisation development; concessionality measurement; crowding out development finance",
   "Current_Anchors": "LIT-005; LIT-012; LIT-013; LIT-015; LIT-017; LIT-018; LIT-019",
   "Target_Anchors": "6",
   "Output_Memo": "MEMO-8",
   "Status": "Partially covered"
  },
  {
   "ID": "LC-13",
   "Component": "Microcredit impact evidence and the meta-analytic record",
   "Axis": "2-Microfinance",
   "Priority": "P2",
   "Why_It_Matters": "The canonical evidence base a development-economics examiner will expect the candidate to know cold. Currently one anchor for an entire literature.",
   "Serves_RQs": "RQ-02",
   "Questions_To_Answer": "What do the seven coordinated microcredit RCTs find and how does the Bayesian hierarchical re-analysis change the reading? Where is treatment-effect heterogeneity real rather than noise? What are the standard critiques of the RCT canon?",
   "Search_Terms": "microcredit randomized evaluations; miracle of microfinance; Bayesian hierarchical microcredit; Meager microcredit; microfinance systematic review; heterogeneous treatment effects microcredit",
   "Current_Anchors": "LIT-003",
   "Target_Anchors": "10",
   "Output_Memo": "MEMO-4",
   "Status": "Partially covered"
  },
  {
   "ID": "LC-14",
   "Component": "Digital financial rails and origination data capture",
   "Axis": "6-Data and technology",
   "Priority": "P2",
   "Why_It_Matters": "RQ-06 asks what data capture costs. The answer depends on the rails available, which is a literature the repo has not touched at all.",
   "Serves_RQs": "RQ-06",
   "Questions_To_Answer": "What does the evidence say about digitising savings-group records? How do mobile money rails change transaction cost and data availability? What are the documented failure modes of MIS deployments in low-connectivity settings?",
   "Search_Terms": "digital savings groups; mobile money savings group; e-recording VSLA; digital financial services evidence; MIS microfinance implementation; digitisation informal finance",
   "Current_Anchors": "",
   "Target_Anchors": "8",
   "Output_Memo": "MEMO-9",
   "Status": "Not started"
  ...
  {
   "ID": "LC-15",
   "Component": "PAYGO and energy-access receivables finance",
   "Axis": "3-Securitization",
   "Priority": "P2",
   "Why_It_Matters": "EXP-02 and EXP-08 depend on it and it is the closest existing analogue to what this project proposes: small-ticket receivables already being pooled.",
   "Serves_RQs": "RQ-03; RQ-06",
   "Questions_To_Answer": "How are PAYGO solar receivables financed and securitised today? What default and repossession behaviour is documented? What data standards has the sector converged on?",
   "Search_Terms": "PAYGO solar receivables; off grid solar securitisation; pay as you go energy financing; solar home system default; GOGLA data standards",
   "Current_Anchors": "LIT-008",
   "Target_Anchors": "6",
   "Output_Memo": "MEMO-9",
   "Status": "Not started"
  },
  {
   "ID": "LC-16",
   "Component": "Agricultural value chains, warehouse receipts and price risk",
   "Axis": "5-Insurance",
   "Priority": "P2",
   "Why_It_Matters": "EXP-04, EXP-09 and EXP-11 all sit here, and the coffee cluster cannot be assessed without it.",
   "Serves_RQs": "RQ-02; RQ-08",
   "Questions_To_Answer": "What is the evidence on warehouse receipt finance and post-harvest lending? How do price-stabilisation instruments perform for smallholders? How does value-chain finance interact with group structures?",
   "Search_Terms": "warehouse receipt finance; inventory credit smallholder; value chain finance agriculture; price risk management smallholder; commodity price hedging cooperatives; post harvest loss lending",
   "Current_Anchors": "",
   "Target_Anchors": "8",
   "Output_Memo": "MEMO-9",
   "Status": "Not started"
  ...
  {
   "ID": "LC-17",
   "Component": "Over-indebtedness, consumer protection and credit ethics",
   "Axis": "2-Microfinance",
   "Priority": "P2",
   "Why_It_Matters": "The do-no-harm section of the framework needs an evidence base, and bundling a financed premium into a loan raises exactly the concern this literature documents.",
   "Serves_RQs": "RQ-02; RQ-05",
   "Questions_To_Answer": "What drives over-indebtedness in microcredit markets? What consumer-protection standards apply to bundled and financed insurance? What does the mis-selling record in microinsurance look like?",
   "Search_Terms": "microfinance over-indebtedness; client protection principles; microinsurance mis-selling; consumer protection financial inclusion; multiple borrowing microfinance; responsible finance",
   "Current_Anchors": "",
   "Target_Anchors": "6",
   "Output_Memo": "MEMO-4",
   "Status": "Not started"
  ...
  {
   "ID": "LC-18",
   "Component": "Financialisation of community institutions",
   "Axis": "1-VSLA",
   "Priority": "P2",
   "Why_It_Matters": "The intellectual counterweight to the thesis. A proposal that does not engage the critique that external capital corrodes community institutions will be read as naive, and RQ-04 is built on taking it seriously.",
   "Serves_RQs": "RQ-01; RQ-04; RQ-05",
   "Questions_To_Answer": "What does the critical literature say about formalising informal finance? What is the record of external capital entering member-owned institutions? What happened to the SHG-Bank Linkage Programme and to microfinance commercialisation?",
   "Search_Terms": "financialisation of development; mission drift microfinance; commercialisation microfinance; formalising informal finance; cooperative demutualisation; social capital erosion credit",
   "Current_Anchors": "LIT-023",
   "Target_Anchors": "8",
   "Output_Memo": "MEMO-4",
   "Status": "Partially covered"
  },
  {
   "ID": "LC-19",
   "Component": "Regulation of savings groups and microinsurance",
   "Axis": "1-VSLA",
   "Priority": "P2",
   "Why_It_Matters": "Determines whether a product is legal before it is desirable, and sets the ceiling on what data can be demanded at origination.",
   "Serves_RQs": "RQ-05; RQ-06",
   "Questions_To_Answer": "How are savings groups regulated across candidate jurisdictions? What licensing does a microinsurance product require? Who may lawfully hold and share member data?",
   "Search_Terms": "savings group regulation; proportionate regulation financial inclusion; microinsurance regulation IAIS; agent banking regulation; data protection law financial services Africa",
   "Current_Anchors": "LIT-014",
   "Target_Anchors": "6",
   "Output_Memo": "MEMO-8",
   "Status": "Partially covered"
  },
  {
   "ID": "LC-20",
   "Component": "Microfinance cost-to-serve and unit economics",
   "Axis": "2-Microfinance",
   "Priority": "P2",
   "Why_It_Matters": "RT-6 runs on assumptions the repo labels stubborn. RQ-06 and RQ-20 need real operating-cost benchmarks.",
   "Serves_RQs": "RQ-05; RQ-06; RQ-03",
   "Questions_To_Answer": "What are benchmark operating expense ratios by institution type and loan size? How does cost-to-serve scale with portfolio size? What does group methodology cost per member relative to individual lending?",
   "Search_Terms": "microfinance operating expense ratio; cost per borrower; efficiency microfinance institutions; MIX Market benchmarks; cost to serve rural finance; group lending transaction costs",
   "Current_Anchors": "LIT-016; LIT-017",
   "Target_Anchors": "6",
   "Output_Memo": "MEMO-9",
   "Status": "Partially covered"
  },
  {
   "ID": "LC-21",
   "Component": "Microsavings and household financial behaviour",
   "Axis": "2-Microfinance",
   "Priority": "P3",
   "Why_It_Matters": "The savings side of the group is the part with the most robust evidence, and it is the mechanism behind the resilience effects the framework measures.",
   "Serves_RQs": "RQ-02",
   "Questions_To_Answer": "What is the causal evidence on savings access and household outcomes? What role do commitment devices and mental accounting play? How does saving interact with borrowing in the same group?",
   "Search_Terms": "microsavings randomized; commitment savings; savings constraints poor; mental accounting savings; behavioural barriers saving",
   "Current_Anchors": "",
   "Target_Anchors": "6",
   "Output_Memo": "MEMO-4",
   "Status": "Not started"
  ...
  {
   "ID": "LC-22",
   "Component": "Remittances and migrant financial arrangements",
   "Axis": "2-Microfinance",
   "Priority": "P3",
   "Why_It_Matters": "Underpins EXP-07 and the Israel migrant-worker track (EXP-29).",
   "Serves_RQs": "RQ-08",
   "Questions_To_Answer": "How do remittance flows interact with household risk management? What products link remittances to savings or insurance? What is documented about migrant-worker financial arrangements in destination countries?",
   "Search_Terms": "remittances risk sharing; remittance linked savings; migrant worker financial inclusion; diaspora finance; remittance cost corridor",
   "Current_Anchors": "",
   "Target_Anchors": "5",
   "Output_Memo": "MEMO-9",
   "Status": "Not started"
  ...
  {
   "ID": "LC-23",
   "Component": "Gender, group composition and intra-household allocation",
   "Axis": "1-VSLA",
   "Priority": "P3",
   "Why_It_Matters": "Savings groups are predominantly women's institutions; a design that ignores intra-household bargaining will mis-measure its own outcomes.",
   "Serves_RQs": "RQ-02; RQ-04",
   "Questions_To_Answer": "How does group composition affect performance? What is the evidence on women's economic empowerment through group finance? How does intra-household allocation mediate measured effects?",
   "Search_Terms": "women's savings groups; gender microfinance empowerment; intra-household bargaining credit; group composition homogeneity; female borrower repayment",
   "Current_Anchors": "",
   "Target_Anchors": "6",
   "Output_Memo": "MEMO-4",
   "Status": "Not started"
  ...
  {
   "ID": "LC-25",
   "Component": "Data governance, consent and privacy in field research",
   "Axis": "6-Data and technology",
   "Priority": "P3",
   "Why_It_Matters": "CLAUDE.md section 8 and the ethics section of the framework both depend on it, and IRB approval will require it in writing.",
   "Serves_RQs": "RQ-06",
   "Questions_To_Answer": "What consent standards apply in low-literacy multilingual settings? How is participant data governed when a commercial partner co-holds it? What are the norms on data sharing and retention in development field research?",
   "Search_Terms": "informed consent low literacy; research ethics development economics; data protection field research; participant data governance; IRB international field research",
   "Current_Anchors": "",
   "Target_Anchors": "5",
   "Output_Memo": "MEMO-9",
   "Status": "Not started"
  ...
  {
   "ID": "LC-26",
   "Component": "Impact-evaluation method advances",
   "Axis": "2-Microfinance",
   "Priority": "P3",
   "Why_It_Matters": "The framework makes design choices - clustering, stepped wedge, tail-powered outcomes, multiple hypotheses - that each have a methods literature a methods examiner will know.",
   "Serves_RQs": "RQ-02; RQ-08",
   "Questions_To_Answer": "How is power computed for cluster designs with realistic ICCs? What are the current standards on multiple-hypothesis correction and pre-analysis plans? How are spillovers handled? When is a stepped wedge identified?",
   "Search_Terms": "cluster randomized trial power; intracluster correlation development; pre-analysis plan; multiple hypothesis testing experiments; stepped wedge design; spillover effects experiments; randomization inference",
   "Current_Anchors": "",
   "Target_Anchors": "8",
   "Output_Memo": "MEMO-6",
   "Status": "Not started"
 ...
 "openQuestions": [
  {
   "ID": "OQ-1",
   "Question": "What cross-border legal/regulatory framework (jurisdiction, SPV domicile) will govern pooling Israeli and African-originated receivables into a single securitization vehicle?",
   "Category": "Securitization Structure",
   "Linked_Area": "Partner Tracker / Product Design",
   "Status": "Partially answered",
   "Owner": "BB",
   "Notes": "Need input from securities counsel in Israel + target African jurisdiction; determine whether a single offshore SPV (e.g., Cayman/Luxembourg) or parallel local SPVs feed a master trust. LIT-009 supplies the legal-precondition checklist (true sale, assignability, perfection, enforceable security, tax neutrality, insolvency-remote SPV); LIT-010 supplies jurisdiction-by-jurisdiction rules and shows offshore SPVs are widely permitted where local assignment and tax rules are respected. Remaining work is jurisdiction-specific counsel review, not literature.",
   "Evidence_Refs": "LIT-009; LIT-010; LIT-011"
  },
  {
   "ID": "OQ-2",
   "Question": "What is the minimum viable receivables pool size (number of VSLAs / loan count / $ notional) needed to make a securitization economically viable given fixed legal/structuring costs?",
   "Category": "Securitization Structure",
  ...
  {
   "ID": "OQ-3",
   "Question": "What standardized data schema and underwriting variables must be captured at origination to make VSLA-level receivables poolable and ratings-agency legible later?",
   "Category": "Data Architecture",
   "Linked_Area": "Data / Product Design",
   "Status": "Partially answered",
   "Owner": "BB",
   "Notes": "Draft a canonical schema (borrower ID, loan terms, repayment history, group guarantee structure, geospatial/agro-climate tags) benchmarked against existing microfinance MIS + ABS reporting templates (e.g., European DataWarehouse loan-level data templates). LIT-014 adds the policy constraint: the schema must be light enough to sit inside a proportionate registration regime delegated to local authorities/NGOs. Approach decided 2026-08-02: GREENFIELD minimal schema designed for VSLA field reality first, mapped to ABS/MIS templates (European DataWarehouse, CGAP) later - lightest for origination; sanity-check the greenfield fields against ABS templates during design to bound future rework. CROSS-REFERENCE added 2026-08-07: OQ-12 constrains this schema and has a deadline that this question does not. The mechanism evidence (LIT-020, LIT-021) points at group social structure rather than liability terms as the predictive signal, which makes meeting frequency and attendance candidate first-class fields rather than optional metadata. RT-1 is still v0 and not field-tested, so these can still be added - but only until collection starts, after which the gap cannot be backfilled for loans already originated. Settle the variable list against OQ-12 before the first field deployment.",
   "Evidence_Refs": "LIT-014; LIT-006; LIT-009; LIT-020; LIT-021"
  },
  {
   "ID": "OQ-4",
   ...
   "Status": "Partially answered",
   "Owner": "BB",
   "Notes": "Direction set 2026-08-02: the flagship portfolio is 2-3 parallel, lean, pre-registered RCTs sharing a single verification partner (Africa/MENA focus). Cluster randomization at the group/village level is the default; stepped-wedge where a partner resists withholding treatment. The specific design per experiment is to be co-developed with the verification partner (OQ-7). Cluster randomization likely cleaner where the pilot is smaller and controlled. OQ-5 (PhD field-research design) was merged into this question on 2026-08-02.",
   "Evidence_Refs": "LIT-001; LIT-002"
  },
  {
   "ID": "OQ-5",
   "Question": "Should PhD field research (Israel first, Africa second) use cluster randomization or a stepped-wedge design?",
   "Category": "PhD / Research Design",
   "Linked_Area": "PhD Programs",
   "Status": "Dropped",
   "Owner": "BB",
   "Notes": "Merged into OQ-4 on 2026-08-02: this fully overlaps OQ-4 (cluster vs stepped-wedge) and the field-design direction is now set there. Kept as a stub for the stable ID; see OQ-4.",
   "Evidence_Refs": "LIT-001"
  },
  {
   "ID": "OQ-6",
   "Question": "What is the best blended-finance / first-loss structure for the initial pilot (Israel and Africa) to attract anchor investors before a full public securitization is feasible?",
   "Category": "Securitization Structure",
   "Linked_Area": "Partner Tracker / Pilot Design",
   "Status": "Partially answered",
   "Owner": "BB",
   "Notes": "Decision 2026-08-02: pursue the blended first-loss structure design NOW, as a commercial track running in parallel with the grant-funded research pilots rather than deferring it to post-pilot. Practical scope: there is no warehouse-able receivables pool yet, so 'now' means the structure design, early DFI engagement and a target waterfall spec; first-loss capital deploys once a pool exists (see M-22). Explore DFI first-loss tranches (IFC, FMO, British International Investment, AFD/Proparco - not USAID, which was dissolved in 2025) layered with local bank senior debt; benchmark against blended microfinance funds (responsAbility, BlueOrchard). LIT-012/LIT-013 confirm the junior tranche is the mobilisation lever; LIT-015 sets out the instrument menu (junior equity, sub debt, pooled guarantee).",
   "Evidence_Refs": "LIT-012; LIT-013; LIT-015"
  },
  {
   "ID": "OQ-7",
   "Question": "Which verification partners (local NGOs, auditors, academic field teams) can provide independent, ideally double-blind, data verification for pilot outcomes?",
   "Category": "Partnerships / Verification",
   "Linked_Area": "Partner Tracker",
   "Status": "Open",
   "Owner": "BB",
   "Notes": "NOW GATING (2026-08-02): the chosen field design - 2-3 parallel lean RCTs sharing one partner (OQ-4, OQ-11) - makes securing this partner a prerequisite for the flagship portfolio. Approach decided 2026-08-02: cast wide - approach several candidates in PARALLEL (J-PAL / PT-05, 3ie-linked evaluators, and university research centres in the target Africa/MENA countries), each logged and coordinated through the partner tracker to avoid duplicate cold contact. Still Open until one commits. Confirm data-sharing and IRB requirements. Feeds the anchor grant application (FUND-02/FUND-03) and milestone M-20.",
   "Evidence_Refs": "EXP-01; EXP-02; EXP-06"
  },
  {
   "ID": "OQ-8",
   "Question": "Should community receivables (PL-1) and agrivoltaic PPA cash flows (PL-2) be pooled in a single vehicle, or kept in separate homogeneous pools?",
   "Category": "Securitization Structure",
   "Linked_Area": "Product Design / Product Lines",
   "Status": "Answered",
   "Owner": "BB",
   "Notes": "Resolved 2026-08-02: keep SEPARATE homogeneous pools - rating agencies and investors prefer homogeneity, and blending an unproven asset (PL-1) with a legible one (PL-2) risks contaminating the legible line rather than lifting the other; capture the PL-1/PL-2 diversification at the fund/investor level instead of inside one pool. Retained reasoning: The case for blending: the two lines are close to uncorrelated (different obligors, macro exposure and failure modes), which is exactly the diversification the SDS work plan argued for. Neither achieves it alone - PL-2 in particular is only superficially diversified, since many small projects still face one offtaker and one regulator. The case against: investors and rating agencies generally prefer homogeneous pools, and mixing an unproven asset class with a legible one risks contaminating the legible one rather than lifting the other. Likely resolved by structuring advice rather than literature - raise with PT-08 (impact asset managers) and PT-09 (counsel).",
  ...
  },
  {
   ...
   "Status": "Answered",
   "Owner": "BB",
   "Notes": "Resolved 2026-08-02 from the research-first scoring pass (OQ-9). Flagship trio: EXP-01 (crop drought-index, rural smallholders), EXP-02 (clean-energy PAYGO, energy/enterprise), EXP-06 (multi-peril parametric climate cover, urban informal settlements). Chosen for three uncorrelated risk drivers (the pooling thesis) plus clean measurability; EXP-01 and EXP-06 share a parametric measurement design, making parallel RCTs under one verification partner affordable. Selection is subject to the verification partner confirming design feasibility (OQ-7). SUPERSEDED 2026-08-22 by OQ-15. The flagship-trio answer no longer stands: the 30-experiment scoring pass placed EXP-01, EXP-02 and EXP-06 in the Reserve band, and BB resolved OQ-15 as a sequenced portfolio instead - two desk-executable falsification tests first (EXP-25, EXP-22), then a single field anchor. The trio is not dropped: EXP-01 and EXP-06 remain field-anchor candidates alongside EXP-09 and EXP-10 under OQ-16. Row kept per CLAUDE.md section 3 - superseded is marked, not deleted.",
   "Evidence_Refs": "EXP-01; EXP-02; EXP-06; OQ-15; OQ-16"
  },
  {
   "ID": "OQ-12",
  ...
  {
   "ID": "OQ-13",
   "Question": "Should the securitisation attach one level up - loans to the collective (VSLA/SHG) which then originates and carries the individual loans - rather than to individual receivables? The aim is to keep community risk management intact where it works while using the pool to diversify idiosyncratic individual risk.",
   "Category": "Securitization Structure",
  ...
  {
   "ID": "OQ-14",
   "Question": "Which of the seven research-question strands (RQ-02..RQ-08) should lead the primary PhD proposal, with the others held as adaptations?",
   "Category": "Research Design",
   "Linked_Area": "PhD Track / Research Questions",
   "Status": "Open",
   "Owner": "BB",
   "Notes": "Raised 2026-08-22 with the research-question architecture (docs/phd/research-questions.md, data/research-questions.csv). Deliberately left open: the lead strand should be decided by which advisor engages first, not chosen in advance - that is what the architecture is for. All seven strands are answerable from the same fieldwork, so the choice changes the framing and the primary supervisor, not the field design. Resolve by marking exactly one RQ row Status=Lead once a supervisor conversation is live. Sequencing note: the P1 literature components (data/lit-components.csv) are shared across strands, so reading is not blocked on this. RE-AFFIRMED 2026-08-22: left open a second time, deliberately, on unchanged reasoning. Nothing in the OQ-16 or OQ-17 decisions of the same date bears on it - the coffee setting and the deferred novelty relocation are both compatible with all seven strands.",
   "Evidence_Refs": ""
  },
  {
   "ID": "OQ-15",
   "Question": "The 2026-08-22 scoring pass over the expanded 30-experiment menu ranks the OQ-11 flagship trio (EXP-01, EXP-02, EXP-06) in the Reserve band, below nine desk-feasible studies. Does the flagship set change, and if so to what?",
   "Category": "Research Design",
   "Linked_Area": "Research Proposal / Pilot Design",
   "Status": "Answered",
   "Owner": "BB",
   "Notes": "RESOLVED 2026-08-22 by BB: a SEQUENCED portfolio, not a replacement. STEP 1 - run the two cheap falsification tests first, before any field money is committed: EXP-25 (default correlation across groups, regions and agro-climatic zones, estimated from historical partner MIS data) and EXP-22 (securitisation-ready origination protocol against the originator's standard protocol, with activity-based costing of both). Each maps to a row in the research-framework section 11 falsification table: EXP-25 tests whether default is covariate rather than idiosyncratic, which would mean diversification buys too little for pooling to work; EXP-22 tests whether the marginal cost of investability exceeds the value it unlocks, which would leave the structuring layer with no business model. Both run on administrative data and a costing exercise, so both can kill the thesis cheaply. Their Status is now Selected. STEP 2 - one field pilot as the anchor, chosen with the advisor and the site actually available. Which one is NOT decided here; it is logged as OQ-16. WHY A SEQUENCE AND NOT A SWAP: the rubric weights PhD feasibility at 30 percent, so desk-executable studies outrank multi-year field pilots by construction. That is a real constraint rather than an artefact, but it means the ranking cannot be read as a portfolio on its own - EXP-25, EXP-26 and EXP-28 all re-analyse data that exists only because somebody else ran a field pilot, and a thesis assembled purely from secondary-data studies has no field contribution and does not support RQ-02 at all. CONSEQUENCE FOR OQ-11: its answer is superseded. EXP-01, EXP-02 and EXP-06 return to Idea; EXP-01, EXP-06, EXP-09 and EXP-10 are the field-anchor candidates under OQ-16. Delivery is tracked as M-32 (run the kill-tests) and M-33 (choose the anchor).",
   "Evidence_Refs": "EXP-22; EXP-25; OQ-11; OQ-16; OQ-9; M-32; M-33"
  },
  {
   "ID": "OQ-16",
   "Question": "Which single field pilot becomes the anchor experiment, once the two falsification tests have run?",
   "Category": "Research Design",
   "Linked_Area": "Research Proposal / Pilot Design",
   "Status": "Partially answered",
   "Owner": "BB",
   "Notes": "Raised 2026-08-22 as the part of OQ-15 that was deliberately NOT decided. The sequence is settled (kill-tests first, then one field anchor); which field pilot is the anchor is not, and should not be forced now because it depends on three things that do not yet exist. GATED ON: (1) an advisor - the lead RQ strand shapes which pilot is the right one, and that is OQ-14, also open by choice; (2) partner and site access, which has not been tested with anyone (M-03, M-04 all still Not started); (3) two literature reads - LC-04, because if bundling has already been trialled the novelty moves onto the second randomisation layer and changes what the pilot is for, and LC-24, because the coffee cluster's scores rest on untested assumptions about partner reachability and certification data. CANDIDATES: EXP-01 (crop drought-index, Sahel/East Africa, 3.15), EXP-06 (multi-peril parametric, urban, 2.90), EXP-09 (coffee cooperative price stabilisation plus climate cover, 3.60), EXP-10 (coffee leaf-rust and heat index, 3.60). On current scores the coffee pair leads on partner access and existing data rails, but that advantage is exactly what LC-24 has to verify rather than assume. Whichever is chosen should carry the second randomisation layer (funding source) from research-framework section 3, since that is the design contribution and it needs a field setting. Resolve at M-33; then set that row to Selected and spec it against docs/research/experiment-spec-template.md. DECISION 2026-08-22: the anchor SETTING is the coffee cooperative cluster - EXP-09 and EXP-10 - chosen ahead of the LC-24 read that was raised to test it. Status is Partially answered, not Answered, because the question asks for a SINGLE pilot and two candidates remain: EXP-09 (pre-harvest credit through the cooperative with a climate trigger and price stabilisation) and EXP-10 (a climate index calibrated to leaf rust and heat stress rather than rainfall). RESIDUAL: EXP-09 versus EXP-10, at M-33. EXP-01 and EXP-06 are hereby out of contention as the anchor. WHAT THIS CHANGES ABOUT LC-24: it was promoted to P1 to inform this choice and now verifies a commitment already made. The coffee pair's 3.60 composite rests on ASSUMED partner reachability and ASSUMED certification data rails; if LC-24 finds either assumption wrong the cost is a reversal rather than a redirection, so LC-24 moves to the front of the P1 queue. Whichever of the two is chosen must still carry the second randomisation layer (funding source) from research-framework section 3, since that is the design contribution and it needs a field setting. LC-24 READ 2026-08-22, AND THE BET SURVIVES. Both assumptions the coffee choice rested on are now evidenced. Cooperatives do intermediate credit: LIT-031 has Root Capital stating that borrower enterprises on-lend to individual producers, bear the repayment risk, and run origination, disbursement, monitoring and repayment through an internal credit fund - so the cooperative is a lender of record with a portfolio, which is the object of study, not merely a marketing channel. Member registers do work as a sampling frame: LIT-033 compiled the cooperative and certification map from the regional Cooperatives Agency and the Sidama union, then drew 12 certified and 8 noncertified cooperatives at random and 530 households proportional to membership; Sidama alone holds about 57 primary cooperatives and around 85,000 farmers, so the universe is large enough for a clustered design. NO REVERSAL IS REQUIRED. But three things changed and they should govern the pilot. (1) LIT-031 describes internal credit funds as often informal and unregulated, names weak internal controls and accounting as the most commonly observed deficiency, and says credit decisions can be politically or personally motivated - so the data rail must be BUILT and budgeted for, not assumed to exist. (2) Certification cannot carry the welfare claim: LIT-032, a 43-study systematic review that found no RCTs anywhere in this literature, reports price +14% and produce income +11% both significant, but total household income +6% NOT significant and worker wages -13% significantly negative; LIT-034 replicates the household-income null across three continents. Certification organises the population; the outcome has to come from elsewhere. (3) The residual EXP-09 versus EXP-10 choice is unchanged and still sits at M-33, but EXP-09 now has a named comparator - LIT-035 records that Colombia launched a Coffee Price Stabilization Fund in February 2020, which is both a partner opportunity and a displacement risk under OQ-11's logic.",
   "Evidence_Refs": "EXP-01; EXP-06; EXP-09; EXP-10; OQ-15; OQ-14; LC-04; LC-24; M-33; LIT-031; LIT-032; LIT-033; LIT-034; LIT-035; MEMO-9"
  },
  {
   "ID": "OQ-17",
   "Question": "The proposal's stated novelty - that the literature raises but rarely tests loan-insurance bundling - is contradicted by the evidence. Where does the novelty claim move to?",
   "Category": "Research Design",
   "Linked_Area": "PhD Track / Research Proposal",
   "Status": "Open",
   "Owner": "BB",
   "Notes": "Raised 2026-08-22 by the LC-04 first pass, which is exactly why that component was read first. WHAT THE EVIDENCE SAYS: bundling has been tested experimentally, at least twice, and both times compulsory bundling suppressed demand. LIT-024 (Gine & Yang 2009, Malawi): rainfall cover required with a seed loan at actuarially fair rates, take-up 13 percentage points lower against a 33.0% uninsured base; the authors attribute it to limited liability already providing implicit insurance, so the premium read as a rate rise. LIT-025 (Banerjee, Duflo & Hornbeck 2014, India): mandatory actuarially fair health cover, 16 percentage point (23 percent) increase in drop-out from microfinance - and this one measures the LENDER's book, which LC-04 had listed as an open question. THE COUNTERWEIGHT: LIT-026 (Karlan et al. 2014, Ghana) finds uninsured risk, not capital, is the binding constraint on farm investment, and demand for index insurance offered SEPARATELY is strong. LIT-027 (Carter, Cheng & Sarris 2016) treats standalone-versus-interlinked as the theoretical question and conditions the answer on risk structure and the collateral environment. SO THE HONEST READING: the contrast is not bundling-good versus bundling-bad, it is offered-separately versus compulsorily-priced-into-the-loan. That distinction is the finding. WHAT THIS COSTS US: EXP-01 as currently written - premium financed into loan principal so cover is automatic rather than opt-in - is precisely the design that failed twice. It cannot be proposed as novel, and should not be proposed at all without addressing why it would go differently. CANDIDATE RELOCATIONS FOR THE NOVELTY CLAIM, none yet chosen: (a) the second randomisation layer on funding source, community capital versus external wholesale capital, which no study in the matrix does (RQ-04, EXP-13); (b) lender-side CASH-FLOW characterisation for securitisation - LIT-025 measured drop-out, not loss curves, correlation or a data tape, and that gap looks real; (c) EXP-17's three-arm separation of the take-up effect from the protection effect, which LIT-024 and LIT-026 together make the obvious next experiment. TO RESOLVE: pick a relocation, then correct the claim in docs/phd/phd-proposal-master.md and the framing in docs/research/research-framework.md section 3. Do not leave the current wording in front of an advisor - a microinsurance economist will know these papers. STRENGTHENED 2026-08-22 by the LC-03 pass, which makes the case against compulsory priced-in cover harder rather than softer. LIT-029 (Annual Review stock-take) states take-up has been disappointingly low WITHOUT LARGE AND SUSTAINED SUBSIDIES - and financing a premium into loan principal is the opposite of a subsidy. LIT-028 (Clarke 2016) shows that with basis risk, optimal demand for an index product is zero for the infinitely risk-averse and nonmonotonic in risk aversion, wealth and price - so low take-up may be RATIONAL, in which case compelling purchase overrides a correct decision rather than fixing a mistake, which is a do-no-harm issue as much as a demand one. LIT-030 measures basis risk directly and finds it and spatiotemporal adverse selection materially drive demand. Taken with LIT-024 and LIT-025, candidate relocation (c) - EXP-17's separation of take-up from protection - now has the strongest literature behind it, and its SUBSIDISED opt-in arm has the strongest prior of the three arms. DECISION 2026-08-22: the relocation is deliberately DEFERRED, not chosen. The four unread P1 components - LC-05, LC-06, LC-07, LC-08 - are to be read first, on the grounds that one of them may move the answer again. LC-08 is the most likely to: LIT-030 already sits there and ties basis risk to the pool's loss distribution, which is candidate relocation (b). CONSEQUENCE, stated plainly: docs/phd/phd-proposal-master.md keeps its CORRECTION PENDING banner and must not go to an advisor until this closes, so there is no proposal-led outreach in the interim. Candidate (c) - EXP-17's separation of the take-up effect from the protection effect - remains the standing front-runner on current evidence and is the default if the four reads do not displace it. Tracked at M-35. BEARS ON THE PENDING CHOICE, from the LC-24 read of 2026-08-22: the coffee setting chosen under OQ-16 turns out to be dominated by TWO covariate shocks, which sharpens candidate relocation (b) considerably. LIT-031 records leaf rust affecting more than half of Central America's total coffee-growing area at once, an estimated 40% cut to Central American output, El Salvador production down 60% in 2013/2014, 40% of Peru's coffee area affected, and 80% production drops at some financed producer organisations in Selva Central. LIT-035 adds the price channel: 45 of 260 reporting days flagged as excessively variable in coffee year 2019/20, roughly one trading day in six. A coffee loan pool is therefore close to a worst case for poolability and, for exactly that reason, the best available case for MEASURING correlation - which is what candidate (b) proposes to do and what EXP-25 tests. This does not decide OQ-17, and it does not displace candidate (c), which still has the strongest direct literature. It does mean the choice between (b) and (c) is now also a choice about whether the anchor's covariate structure is the subject or the obstacle. LC-08 FIRST PASS 2026-08-22 STRENGTHENS CANDIDATE (b) FURTHER, but does not close this question. Two results. First, LIT-038: the standard method for estimating a default probability in a portfolio with no observed defaults - Pluto-Tasche - produces the estimate as an upper confidence bound that is a FUNCTION OF AN ASSET CORRELATION SUPPLIED BY ASSUMPTION. Second, LIT-036 and LIT-037: the historical correlation channel in microfinance is institutional and market-level - concentrated competition, multiple borrowing, social-network contagion, and market penetration above roughly 10 per cent of population - and explicitly NOT the macroeconomy; individual lender growth does not predict deterioration while market-level growth does. Put together, the parameter that does the most work in pricing these cash flows is one that nobody has measured for this asset class, and the obvious way to measure it is not the obvious one, because the channel is institutional rather than environmental. That is candidate (b) with a specific deliverable attached. It still does not beat candidate (c) on directness of literature support, and LC-05, LC-06 and LC-07 remain one anchor deep, so the deferral stands until M-35 completes.",
   "Evidence_Refs": "LIT-024; LIT-025; LIT-026; LIT-027; LC-04; EXP-01; EXP-13; EXP-17; OQ-16; LIT-028; LIT-029; LIT-030; LC-03; EXP-30; LIT-031; LIT-035; LC-24; LIT-036; LIT-037; LIT-038; LC-08"
  }
 ],
 "productLines": [
  {
   "ID": "PL-1",
   "Name": "Community credit & insurance",
   "Origination_Layer": "VSLAs, MFIs, NGOs, employer networks",
   "Underlying_Asset": "Loan repayments and insurance premiums",
   "Tenor": "Months",
   "Status": "Concept - pilot design pending",
   "Evidence_Base": "Strong",
   "Precedent_Refs": "LIT-001; LIT-002; LIT-003; LIT-004; LIT-006; LIT-007; LIT-014",
   "Path": "product-design/product-lines/community-credit-and-insurance.md",
   "Notes": "Leads the venture because it carries the research programme and the PhD. The binding constraint is data capture at origination (OQ-3), not demand or asset quality."
  },
  {
   "ID": "PL-2",
   "Name": "Agrivoltaic project finance (BFAV)",
   "Origination_Layer": "Farmers / landholders via our project vehicle",
   "Underlying_Asset": "PPA revenue from the electric utility",
   "Tenor": "15-25 years",
   "Status": "Concept - partially specified",
   "Evidence_Base": "Thin - no equivalent impact literature yet",
   "Precedent_Refs": "LIT-008",
 ...
 "riskTools": [
  {
   ...
   "Tests": "Schema self-check and dataset validation (validate_schema.py), runs in CI",
   "Path": "risk-tools/rt-1-origination-schema.md",
   "Blocked_By": "OQ-3",
   "Notes": "v0.1 field list built: 57 fields across 5 entities, 45 critical path. Not yet field-tested - see risk-tools/schema/README.md for what would move it to v1. FIELD-TEST ROUTE NAMED 2026-08-22: EXP-22 is the experiment that would move this from v0.1 to v1 - it runs the full 57-field set against a live origination pipeline, costs each field, and uses validate_schema.py on the output, so a field the validator keeps rejecting surfaces as a schema defect rather than an officer error. Its H3 deliverable is a ranked per-field cost curve, which is what would let an originator adopt the schema incrementally instead of all at once."
  },
  {
   "ID": "RT-2",
   ...
   "Version": "0.1",
   "Stack": "Python",
   "Tests": "Monotonicity in leverage; every decline/refer carries a reason (test_toolchain.py, CI)",
   "Path": "risk-tools/rt-2-underwriting-engine.md",
   "Blocked_By": "RT-1; pilot data",
   "Notes": "Rules-based scorecard running against synthetic RT-1 data. Emits a band, a limit and the reasons in both directions - an unexplained decline is not defensible under the consumer-protection framing in LIT-014. Two rules only exist because the schema captures cycle length and livelihood: the share-out constraint and correlated agricultural exposure. Uncalibrated; no ML until there is a repayment history to backtest this baseline against."
  },
  {
   "ID": "RT-3",
   ...
   "Version": "0.1",
   "Stack": "Python",
   "Tests": "Arrears-lead-loss property asserted point-in-time (test_toolchain.py, CI)",
   "Path": "risk-tools/rt-3-monitoring-early-warning.md",
   "Blocked_By": "RT-1",
   "Notes": "Monitor running over the RT-1 event stream: PAR30/PAR90, arrears concentration by group, region and originator, and threshold alerts with --as-of for point-in-time evaluation. Demonstrated to fire while under 20% of eventual write-offs have been booked - roughly 4-7 months of lead in the synthetic run. Thresholds are judgement, not estimates."
  },
  {
   "ID": "RT-4",
  ...
  },
  {
   ...
   "Version": "0.1",
   "Stack": "Python",
   "Tests": "Waterfall conservation assertion on every path; deterministic seed",
   "Path": "risk-tools/rt-5-securitisation-model.md",
   "Blocked_By": "RT-1",
   "Notes": "Synthetic scaffold running: pool generator, single-factor correlated loss model, sequential waterfall, six macro stress scenarios. Uncalibrated - outputs are structural, not evidential. Already yields a derived OQ-2 answer via --sweep: fixed costs dominate the junior tranche below roughly USD 5m and flatten around USD 20-40m. CALIBRATION ROUTE NAMED 2026-08-22: EXP-25's respec includes an explicit step to recover a single-factor asset correlation from partner loan panels, which is exactly the input this model currently sweeps. Until that lands the correlation sweep stays the honest output."
  },
  {
   "ID": "RT-6",
 ...
 "macroIndicators": [
  ...
  {
   "ID": "MAC-13",
   "Indicator": "USD/ILS representative exchange rate",
   "Category": "Currency risk",
   "Why_It_Matters_Here": "The dominant pair for the Israel pilot. Any hard-currency tranche over shekel-denominated receivables is an unhedged mismatch, and this is the rate that mismatch is measured in. MAC-12 covers the euro leg, which only matters if notes are placed with EU investors.",
   "Product_Lines": "PL-1; PL-2",
   "Source": "Bank of Israel",
   "URL": "https://www.boi.org.il/en/economic-roles/statistics/exchange-rates/",
   "Cadence": "Daily"
  },
  {
   "ID": "MAC-14",
   "Indicator": "FAO Cereals Price Index",
   "Category": "Borrower shock driver",
   "Why_It_Matters_Here": "The staple-grain sub-index of MAC-06. Worth tracking separately because it moves earlier and harder than the headline, and because staples are what the PL-1 cohort actually spends its marginal shekel or shilling on - a headline index diluted by meat and dairy understates the shock to a subsistence household.",
   "Product_Lines": "PL-1",
   "Source": "FAO",
   "URL": "https://www.fao.org/worldfoodsituation/foodpricesindex/en/",
   "Cadence": "Monthly"
  },
  {
   ...
   "Category": "Cost of capital",
   "Why_It_Matters_Here": "The long-rate anchor. MAC-01 prices the short end, but a PL-2 PPA asset runs 15-25 years and is discounted off something much closer to the 10-year. The gap between the two is also the clearest single read on whether the curve is telling us long money is getting cheaper or dearer.",
   "Product_Lines": "PL-2; PL-1",
   "Source": "FRED (St Louis Fed)",
  ...
  },
  {
   ...
   "Category": "Project economics",
   "Why_It_Matters_Here": "Sits behind two separate channels: the tariff and procurement environment for PL-2, and the fuel and fertiliser costs that feed into the food prices in MAC-06. One of the few places where the two product lines share a risk driver - which is worth knowing precisely because the diversification case for running both assumes they mostly do not.",
   "Product_Lines": "PL-2; PL-1",
   "Source": "FRED (St Louis Fed)",
 ...
 "macroScenarios": [
  {
   ...
   "Driver": "none",
   "Macro_Refs": "",
   "Shock_Description": "No shock. Portfolio assumptions as configured, correlation as configured. The comparator every other scenario is read against.",
   "Rate_Shock_Pp": "0.0",
   "Default_Multiplier": "1.0",
   "Recovery_Multiplier": "1.0",
   "Prepay_Multiplier": "1.0",
   "Correlation_Override": "",
   "Rationale": "Not a forecast. A reference point - the scenario in which nothing in particular happens, which is itself unlikely."
  },
  {
   "ID": "SC-1",
   "Scenario": "Rates up",
   "Driver": "Cost of capital",
   "Macro_Refs": "MAC-01; MAC-02; MAC-03; MAC-15",
   "Shock_Description": "Policy and long rates rise 300bp. Senior coupon reprices; the concessional layer has to work harder for the same mobilisation.",
   "Rate_Shock_Pp": "3.0",
   "Default_Multiplier": "1.15",
   "Recovery_Multiplier": "1.0",
   "Prepay_Multiplier": "0.9",
   "Correlation_Override": "",
   "Rationale": "LIT-012 and LIT-013: the junior tranche is the mobilisation lever, and its required size moves with the return private capital demands. The modest default multiplier reflects second-order pressure on borrowers via local lending rates rather than a direct channel - most PL-1 loans are fixed-charge and short, so a rate move does not hit the existing book directly."
  },
  {
   "ID": "SC-2",
   "Scenario": "Food price shock",
   "Driver": "Borrower stress",
   "Macro_Refs": "MAC-06; MAC-14; MAC-16",
   "Shock_Description": "Staple food prices rise sharply, on the scale of the 2007-08 and 2010-11 episodes visible in the MAC-06 history.",
   "Rate_Shock_Pp": "0.0",
   "Default_Multiplier": "2.2",
   "Recovery_Multiplier": "0.75",
   "Prepay_Multiplier": "0.8",
   "Correlation_Override": "0.45",
   "Rationale": "The most direct macro-to-repayment channel for PL-1 (Memo 1). Critically this is a CORRELATED shock - it hits a whole region at once - so correlation is overridden upward rather than left at the base. Recovery falls because distressed borrowers in a distressed region have less to recover from."
  },
  {
   "ID": "SC-3",
   "Scenario": "Energy shock",
   "Driver": "Project economics",
   "Macro_Refs": "MAC-16; MAC-09",
   "Shock_Description": "Sustained oil price spike. Feeds the PL-2 tariff and procurement environment, and pushes fuel and fertiliser costs into food prices.",
   "Rate_Shock_Pp": "0.5",
   "Default_Multiplier": "1.4",
   "Recovery_Multiplier": "0.9",
   "Prepay_Multiplier": "0.9",
   "Correlation_Override": "0.3",
   "Rationale": "One of the few drivers that moves both product lines at once (PL-2 doc, OQ-8). Worth modelling precisely because the diversification case for running both lines assumes shared drivers are rare."
  },
  {
   "ID": "SC-4",
   "Scenario": "FX shock",
   "Driver": "Currency risk",
   "Macro_Refs": "MAC-12; MAC-13",
   "Shock_Description": "Local currency depreciates 25% against the hard currency the notes are denominated in.",
   "Rate_Shock_Pp": "0.0",
   "Default_Multiplier": "1.3",
   "Recovery_Multiplier": "0.85",
   "Prepay_Multiplier": "1.0",
   "Correlation_Override": "0.25",
   "Rationale": "Named as a live risk in the business plan. Local-currency receivables against a hard-currency tranche is an unhedged mismatch; the default multiplier captures import-price pass-through to borrowers, not the translation loss itself - that is applied at the tranche level, not the loan level."
  },
  {
   "ID": "SC-5",
   "Scenario": "Combined stress",
   "Driver": "Multiple",
   "Macro_Refs": "MAC-01; MAC-06; MAC-13; MAC-15",
   "Shock_Description": "Rates up, food prices up and currency down together. Not a forecast - a coherence test.",
   "Rate_Shock_Pp": "2.0",
   "Default_Multiplier": "2.8",
   "Recovery_Multiplier": "0.7",
   "Prepay_Multiplier": "0.8",
   "Correlation_Override": "0.55",
   "Rationale": "These drivers are not independent in the real world: a rate-hiking cycle, a commodity spike and EM currency pressure have historically arrived together. A structure that only survives them one at a time has not been stress tested."
  }
 ],
 "rt5Results": [
  {
   "Scenario_ID": "SC-0",
   "Scenario": "Base",
   "Pool_Principal_USD": "18708720.93",
   "Loans": "35966",
   "Mean_Loss_Rate_Pct": "1.356",
   "P95_Loss_Rate_Pct": "2.49",
   "P99_Loss_Rate_Pct": "2.99",
   "Cost_Drag_Pct_Of_Pool": "4.336",
   "Fixed_Cost_Pct_Of_Pool": "1.336",
   "Mean_Junior_Loss_Pct": "18.96",
   "Junior_Wipeout_Prob_Pct": "0.0",
   "Senior_Shortfall_Prob_Pct": "0.0",
   "Correlation_Used": "0.2",
   "Default_Multiplier": "1.0",
   "Model_Version": "0.1",
  ...
  },
  {
   ...
   "Pool_Principal_USD": "18708720.93",
   "Loans": "35966",
   "Mean_Loss_Rate_Pct": "1.611",
   "P95_Loss_Rate_Pct": "2.764",
   "P99_Loss_Rate_Pct": "3.6",
   "Cost_Drag_Pct_Of_Pool": "4.336",
   "Fixed_Cost_Pct_Of_Pool": "1.336",
   "Mean_Junior_Loss_Pct": "37.82",
   "Junior_Wipeout_Prob_Pct": "0.0",
   "Senior_Shortfall_Prob_Pct": "0.0",
   "Correlation_Used": "0.2",
   "Default_Multiplier": "1.15",
  ...
  },
  {
   ...
   "Pool_Principal_USD": "18708720.93",
   "Loans": "35966",
   "Mean_Loss_Rate_Pct": "3.666",
   "P95_Loss_Rate_Pct": "7.028",
   "P99_Loss_Rate_Pct": "8.87",
   "Cost_Drag_Pct_Of_Pool": "4.336",
   "Fixed_Cost_Pct_Of_Pool": "1.336",
   "Mean_Junior_Loss_Pct": "36.08",
   "Junior_Wipeout_Prob_Pct": "0.0",
   "Senior_Shortfall_Prob_Pct": "0.0",
   "Correlation_Used": "0.45",
   "Default_Multiplier": "2.2",
   "Model_Version": "0.1",
   "Basis": "SYNTHETIC - illustrative only, not calibrated to field data"
  },
  {
   ...
   "Pool_Principal_USD": "18708720.93",
   "Loans": "35966",
   "Mean_Loss_Rate_Pct": "2.041",
   "P95_Loss_Rate_Pct": "3.768",
   "P99_Loss_Rate_Pct": "4.742",
   "Cost_Drag_Pct_Of_Pool": "4.336",
   "Fixed_Cost_Pct_Of_Pool": "1.336",
   "Mean_Junior_Loss_Pct": "26.85",
   "Junior_Wipeout_Prob_Pct": "0.0",
   "Senior_Shortfall_Prob_Pct": "0.0",
   "Correlation_Used": "0.3",
   "Default_Multiplier": "1.4",
   "Model_Version": "0.1",
   "Basis": "SYNTHETIC - illustrative only, not calibrated to field data"
  },
  {
   ...
   "Pool_Principal_USD": "18708720.93",
   "Loans": "35966",
   "Mean_Loss_Rate_Pct": "2.068",
   "P95_Loss_Rate_Pct": "3.648",
   "P99_Loss_Rate_Pct": "5.272",
   "Cost_Drag_Pct_Of_Pool": "4.336",
   "Fixed_Cost_Pct_Of_Pool": "1.336",
   "Mean_Junior_Loss_Pct": "24.28",
   "Junior_Wipeout_Prob_Pct": "0.0",
   "Senior_Shortfall_Prob_Pct": "0.0",
   "Correlation_Used": "0.25",
   "Default_Multiplier": "1.3",
   "Model_Version": "0.1",
   "Basis": "SYNTHETIC - illustrative only, not calibrated to field data"
  },
  {
   ...
   "Pool_Principal_USD": "18708720.93",
   "Loans": "35966",
   "Mean_Loss_Rate_Pct": "5.061",
   "P95_Loss_Rate_Pct": "10.076",
   "P99_Loss_Rate_Pct": "13.906",
   "Cost_Drag_Pct_Of_Pool": "4.336",
   "Fixed_Cost_Pct_Of_Pool": "1.336",
   "Mean_Junior_Loss_Pct": "57.4",
   "Junior_Wipeout_Prob_Pct": "3.5",
   "Senior_Shortfall_Prob_Pct": "0.0",
   "Correlation_Used": "0.55",
   "Default_Multiplier": "2.8",
   "Model_Version": "0.1",
   "Basis": "SYNTHETIC - illustrative only, not calibrated to field data"
  }
 ...
 "partners": [
  {
   "ID": "PT-01",
   "Partner_Name": "VisionFund / World Vision (Israel microfinance arm or local equivalent)",
  ...
  {
   "ID": "PT-02",
   "Partner_Name": "Israeli community development NGOs (e.g., Ma'agalim, Koret Israel Economic Development)",
  ...
  {
   "ID": "PT-03",
   "Partner_Name": "VSL Associates / CARE VSLA network",
  ...
  {
   "ID": "PT-04",
   "Partner_Name": "CGAP (Consultative Group to Assist the Poor)",
  ...
  {
   "ID": "PT-05",
   "Partner_Name": "J-PAL (Abdul Latif Jameel Poverty Action Lab) regional office",
  ...
  {
   "ID": "PT-06",
   "Partner_Name": "Local Israeli university research center (Hebrew University / Tel Aviv University behavioral/dev econ lab)",
  ...
  {
   "ID": "PT-07",
   "Partner_Name": "IFC / FMO / other DFI blended-finance desk",
  ...
  {
   "ID": "PT-08",
   "Partner_Name": "responsAbility / BlueOrchard (impact asset managers)",
  ...
  {
   "ID": "PT-09",
   "Partner_Name": "Local securities law firm (Israel) + African jurisdiction counsel",
 ...
 "phdPrograms": [
  {
   ...
   "Department_Program": "Bogen International Graduate Program, Dept of Economics (direct PhD)",
   "Country": "Israel",
   "City": "Jerusalem",
   "Region": "Israel",
   "URL": "https://en.economics.huji.ac.il/bogen-internation-graduate-program",
   "Format": "Full-time only, 5 yrs (2 coursework + 3 research). English-taught.",
   "Funding_Summary": "Merit scholarships + travel/visit support; tuition normally waived. Stipend figure not published. Competitive.",
   "Key_Supervisors": "Victor Lavy (development/education econ, field + quasi-experimental methods)",
   "Advantages": "Best-in-class impact-evaluation training in exactly his methods; direct-from-BA entry possible; same ecosystem as HUJI Business School finance + Milken Innovation Center.",
   "Disadvantages": "Pure economics: no securitization/tranching expertise in-house; full-time only, coursework-heavy; GRE required.",
  ...
  },
  {
   ...
   "Department_Program": "Coller School of Management, Doctoral Program (Finance)",
   "Country": "Israel",
   "City": "Tel Aviv",
   "Region": "Israel",
   "URL": "https://en-coller.tau.ac.il/the-programs/degree/doctoral",
   "Format": "Full-time research model, up to 5 yrs; English available (TAU International).",
   "Funding_Summary": "TAU PhD stipends for full-time students (progress-contingent); tuition normally waived. Coller-specific figure unverified.",
   "Key_Supervisors": "Danny Ben-Shahar (housing/household finance, mortgage + credit markets); Sivan Frenkel (contracts, information econ, financial regulation)",
   "Advantages": "Top Israeli management school; deep finance bench for pricing/tranching/securitization mechanics; Ben-Shahar anchors the lending-analytics layer; Tel Aviv = centre of migrant-worker population.",
   "Disadvantages": "No published development-finance/microfinance/impact-eval specialist (needs econ co-advisor from Berglas); GMAT-quant or psychometric required; thesis master's expected; venture tolerance undocumented.",
  ...
  },
  {
   ...
   "Department_Program": "Dept of Public Policy & Management / Dept of Economics",
   "Country": "Israel",
   "City": "Beer Sheva",
   "Region": "Israel",
   "URL": "https://www.bgu.ac.il/en/u/faculties/business-and-management/departments/public-policy-and-management/about/",
   "Format": "Research (thesis) PhD track; format/language not fully published. Likely more Hebrew-centric.",
   "Funding_Summary": "Standard Israeli PhD funding/fellowships; lower cost of living. Figures unverified.",
   "Key_Supervisors": "Ofer Azar (behavioral economics) - not development finance; policy supervisors To identify",
   "Advantages": "Policy framing; potentially strong funding vs cost of living; social-policy specialization aligns with the development-impact angle.",
   "Disadvantages": "No verified microfinance/securitization/impact-eval supervisor; likely more Hebrew; farther from the central-Israel migrant-worker pilot.",
  ...
  },
  {
   "ID": "PHD-10",
   "University": "Hebrew University of Jerusalem",
   "Department_Program": "Jerusalem School of Business Administration, PhD (Finance / Risk)",
   "Country": "Israel",
   "City": "Jerusalem",
   "Region": "Israel",
   "URL": "https://bschool-en.huji.ac.il/phd",
   "Format": "Full-time, phased (~2+2+2.5 yrs); flexible supervisor-built curriculum (only ~12 mandatory credits). Outside PART-TIME employment explicitly permitted (no full employment).",
   "Funding_Summary": "School + research-foundation scholarships plus TA income (progress/excellence-contingent). Fee coverage not published. Competitive.",
   "Key_Supervisors": "Orly Sade (financial inclusion, financial literacy, fintech, household finance); Yishay Yafeh (banking, emerging markets; Milken Innovation Center); Anat Bracha (behavioral econ, poverty; IPA affiliate)",
   "Advantages": "Single best supervisor-and-topic match in Israel; flexible research-led structure; outside part-time work allowed (most venture-tolerant funded route); plugged into Milken blended-finance lab + IPA RCT network.",
   "Disadvantages": "Effectively requires a master's; stipend size + English-track PhD supervision must be confirmed in writing; cannot combine with full employment.",
  ...
  },
  {
   "ID": "PHD-11",
   "University": "Tel Aviv University",
   "Department_Program": "Eitan Berglas School of Economics (Economics PhD)",
   "Country": "Israel",
   "City": "Tel Aviv",
   "Region": "Israel",
   "URL": "https://en-econ.tau.ac.il/phd/main",
   "Format": "Full-time, up to 5 yrs; standard (from MA) or direct (from BA) track; substantial coursework. English info provided.",
   "Funding_Summary": "Full-time PhD stipends for 4 yrs (progress-contingent); tuition normally waived. Competitive.",
   "Key_Supervisors": "Analia Schlosser (labor + development econ, immigration; quasi-experimental/field methods; IZA/CEPR)",
   "Advantages": "Rigorous development/applied-micro training; funded; Schlosser a genuine impact-evaluation fit; natural co-advising with Coller finance.",
   "Disadvantages": "Heavy coursework, full-time, least venture-flexible TAU route; no securitization/finance-structuring in-house.",
  ...
  },
  {
   ...
   "Department_Program": "Faculty of Data & Decision Sciences (PhD)",
   "Country": "Israel",
   "City": "Haifa",
   "Region": "Israel",
   "URL": "https://dds.technion.ac.il/tracks/phd-en/phd/",
   "Format": "Multiple tracks ~3.5-5 yrs; English track available; supervisor-first admission.",
   "Funding_Summary": "Best-documented funding here: tuition-exempt + monthly scholarship ~NIS 6,000-6,500+/mo, plus excellence awards.",
   "Key_Supervisors": "Quantitative finance / operations research / decision-science faculty (structuring, risk, monitoring). Development/impact specialist To identify.",
   "Advantages": "Clear, generous, documented funding; English track; strong quantitative methods for the structuring engine (tranching, first-loss, monitoring ops).",
   "Disadvantages": "Engineering/quant faculty: no development-econ/microfinance/impact-eval specialist; Haifa-based (farther from central-Israel pilot).",
  ...
  },
  {
   ...
   "Department_Program": "Oxford Sustainable Finance Group, via DPhil Geography & the Environment",
   "Country": "UK",
   "City": "Oxford",
   "Region": "UK",
   "URL": "https://www.ox.ac.uk/admissions/graduate/courses/dphil-geography-and-environment",
   "Format": "Direct DPhil (no compulsory MRes), 3-4 yrs full-time; residency-heavy. No standalone Smith School DPhil - OSFG supervises via SoGE.",
   "Funding_Summary": "Clarendon Fund + ESRC Grand Union DTP cover fees+stipend, open to internationals but extremely competitive. No OSFG-specific stipend advertised.",
   "Key_Supervisors": "Ben Caldecott (sustainable finance, stranded assets, climate/nature risk) - Director OSFG",
   "Advantages": "World-leading sustainable-finance brand and convening power; strong for the securitizable green/impact-asset framing; Clarendon open to internationals.",
   "Disadvantages": "DPhil sits in Geography, not finance - structured-finance + RCT-econometrics supervision must be sourced elsewhere; residency clashes with venture; funding fierce; no named community-lending/microinsurance supervisor.",
  ...
  },
  {
   ...
   "Department_Program": "MRes/PhD Finance (also MRes/PhD International Development)",
   "Country": "UK",
   "City": "London",
   "Region": "UK",
   "URL": "https://www.lse.ac.uk/study-at-lse/graduate/mresphd-finance",
   "Format": "2-yr MRes + 3-4-yr PhD, full-time; part-time only in limited circumstances. Finance route GRE/GMAT-gated.",
   "Funding_Summary": "LSE + ESRC (LISS-DTP) + departmental scholarships, open to home + overseas but very competitive.",
   "Key_Supervisors": "Deep finance + development-econ + impact-eval benches; specific community-lending/microinsurance supervisor To identify (do not assume).",
   "Advantages": "Best-in-class impact-evaluation + finance-theory methods; the International Development MRes/PhD route is more fieldwork/venture-tolerant while keeping LSE econometrics.",
   "Disadvantages": "Finance route coursework-heavy, full-time, GRE-gated, not venture-designed; overseas funding scarce; securitization craft not an LSE Finance signature.",
  ...
  },
  {
   ...
   "Department_Program": "Judge Business School PhD (Finance pathway); CISL is master's-only",
   "Country": "UK",
   "City": "Cambridge",
   "Region": "UK",
   "URL": "https://www.jbs.cam.ac.uk/phd-research-masters/pathways/finance/",
   "Format": "9-month MPhil/MRes + 4-yr PhD, full-time, coursework-heavy, residency-based. CISL offers NO PhD.",
   "Funding_Summary": "Strong: Judge guarantees maintenance at research-council rate (approx GBP 20,285 for 2024/25) + fees yrs 1-3; Cambridge Trust/Gates/college awards; shortfall covered.",
   "Key_Supervisors": "Finance faculty lean corporate finance/asset pricing/fintech; Elroy Dimson (responsible investing) NOT available as principal supervisor. Topic match weak.",
   "Advantages": "Best UK funding certainty of the shortlist; Cambridge brand; strong finance methods.",
   "Disadvantages": "Weak named supervisor fit for community-lending securitization; full-time, coursework-heavy, residency-based; CISL cannot host the PhD.",
  ...
  },
  {
   ...
   "Department_Program": "Sustainable Development, Economic Growth & Finance PhD (Business School)",
   "Country": "UK",
   "City": "Loughborough",
   "Region": "UK",
   "URL": "https://www.lboro.ac.uk/study/postgraduate/research-degrees/phd-opportunities/sustainable-development-economic-growth/",
   "Format": "PhD, 3 yrs FT / 6 yrs PT, October start.",
   "Funding_Summary": "This advertised opportunity is SELF-FUNDED (UK ~GBP 5,238/yr; intl ~GBP 23,100/yr). Separate funded studentships advertised individually. 2026 deadline (31 Jul) has passed - expect reopening.",
   "Key_Supervisors": "No named supervisor on listing; theme covers financial inclusion, green finance, climate risk, inclusive growth. Contact To identify.",
   "Advantages": "Explicitly inclusive-finance-friendly theme (closest stated scope to his question); part-time route available; lower-pressure entry than Oxbridge/LSE.",
   "Disadvantages": "Advertised route self-funded; no named supervisor confirmed; less structured-finance depth than a specialist finance school.",
  ...
  },
  {
   ...
   "Department_Program": "MPhil/PhD Development Economics; Centre for Sustainable Finance / Centre for Global Finance",
   "Country": "UK",
   "City": "London",
   "Region": "UK",
   "URL": "https://www.soas.ac.uk/study/find-course/mphil/phd-development-economics",
   "Format": "MPhil upgrading to PhD; 3 yrs +1 FT or 6 yrs +1 PART-TIME (on-campus London, not distance).",
   "Funding_Summary": "Home fee ~GBP 5,055; intl ~GBP 23,390. ESRC (Bloomsbury DTP), Felix (developing-country nationals), SOAS Teaching, Tibawi. Intl funding competitive; self-fund often the default.",
   "Key_Supervisors": "Ulrich Volz (development/sustainable/climate finance, financial-market development; Director, SOAS Centre for Sustainable Finance)",
   "Advantages": "Arguably the strongest UK thematic home for development finance + financial inclusion + sustainable finance in one place; part-time route; Felix/DTP funding; regional strengths fit migrant-worker + African field sites.",
   "Disadvantages": "Lighter on hard structured-finance/tranching technique and quant asset pricing than a finance school; intl funding competitive; part-time still needs London presence.",
  ...
  },
  {
   ...
   "Department_Program": "Global Development Institute (PhD); Alliance MBS for finance co-supervision",
   "Country": "UK",
   "City": "Manchester",
   "Region": "UK",
   "URL": "https://www.gdi.manchester.ac.uk/study/phd-opportunities/",
   "Format": "PhD 3-4 yrs FT; part-time available; proposal-driven, supervisor-first.",
   "Funding_Summary": "ESRC NWSSDTP + President's Doctoral Scholar awards (intl-eligible, competitive); GDI funds few per year.",
   "Key_Supervisors": "Kunal Sen (development econ, growth); Antonio Savoia (development finance, governance); Dereje Regasa (financial development, banking); Armando Barrientos (social protection - insurance/safety-net angle)",
   "Advantages": "Genuine development-finance + social-protection cluster with named, sourced fits; strong impact-evaluation + fieldwork culture; large DTP; African field sites core.",
   "Disadvantages": "Development-studies, not a finance faculty - tranching/securitization needs an Alliance MBS co-supervisor; intl funding competitive.",
  ...
  },
  {
   ...
   "Department_Program": "School of Global Development (PhD)",
   "Country": "UK",
   "City": "Norwich",
   "Region": "UK",
   "URL": "https://www.uea.ac.uk/about/school-of-global-development/phd-programmes",
   "Format": "PhD 3-4 yrs; part-time available; proposal-driven.",
   "Funding_Summary": "SeNSS DTP studentships cover fees for BOTH UK and international students + stipend (genuinely intl-friendly DTP); January deadlines; competitive.",
   "Key_Supervisors": "Arjan Verschoor (field/lab experiments on risk, agricultural investment and weather-index insurance in Uganda - RCT + microinsurance core)",
   "Advantages": "Possibly the single best UK methodological supervisor fit for microinsurance + experimental impact evaluation; intl-eligible DTP funding; part-time possible; African fieldwork standard.",
   "Disadvantages": "Development-studies base - securitization/tranching needs a finance co-supervisor; smaller finance footprint.",
  ...
  },
  {
   ...
   "Department_Program": "Centre for Development Studies (Dept of Social & Policy Sciences), PhD",
   "Country": "UK",
   "City": "Bath",
   "Region": "UK",
   "URL": "",
   "Format": "PhD FT/PT available; proposal-driven. Confirm exact CDS PhD entry page.",
   "Funding_Summary": "SWDTP (ESRC South West DTP) studentships, intl-eligible but competitive.",
   "Key_Supervisors": "Susan Johnson (financial inclusion + microfinance; long ties to FSD Kenya)",
   "Advantages": "Rare named fit on financial inclusion in African contexts with real practitioner (FSD Kenya) ties - very close to the African field-site plan; part-time route possible.",
   "Disadvantages": "Development-studies base (not finance) - securitization technique needs a co-supervisor; confirm Johnson's current supervising availability + exact PhD route/URL.",
  ...
  },
  {
   ...
   "Department_Program": "ICMA Centre (Henley Business School), PhD in Finance",
   "Country": "UK",
   "City": "Reading",
   "Region": "UK",
   "URL": "https://www.icmacentre.ac.uk/study/phd-dba/phd-in-finance",
   "Format": "Full-time only, 3-4 yrs, September start.",
   "Funding_Summary": "Henley/ICMA departmental scholarships, regional bursaries, Felix (developing-country nationals). Funded seats limited.",
   "Key_Supervisors": "Lisa Schopohl (programme director). Capital-markets/derivatives/structured-products school; community-lending topic supervisor To identify.",
   "Advantages": "Real structured-finance/securitization/market-microstructure technique - the strongest of the pure-finance homes for the tranching craft; Felix funding for developing-country nationals.",
   "Disadvantages": "Full-time only (venture-unfriendly); development/impact-evaluation is not ICMA's strength; community-lending supervisor unverified.",
  ...
  {
   "ID": "PHD-18",
   "University": "Bayes Business School (City St George's, University of London)",
   "Department_Program": "Faculty of Actuarial Science & Insurance, PhD / Executive PhD",
   "Country": "UK",
   "City": "London",
   "Region": "UK",
   "URL": "https://www.bayes.citystgeorges.ac.uk/study/phd/actuarial-science",
   "Format": "PhD full-time; also an Executive PhD in Actuarial Science (part-time, fee-paying, practitioner-oriented).",
   "Funding_Summary": "Bayes PhD studentships limited/competitive; Executive PhD is self-funded.",
   "Key_Supervisors": "Ioannis Kyriakou (actuarial finance). UK-leading insurance/actuarial faculty; named microinsurance/index-insurance supervisor To identify.",
   "Advantages": "Best UK actuarial/insurance faculty for the microinsurance pricing/underwriting/first-loss layer; the part-time Executive PhD is unusually venture-compatible.",
   "Disadvantages": "Weak on development-economics/impact-evaluation and African fieldwork; standard PhD funding limited; Executive PhD self-funded.",
  ...
  },
  {
   ...
   "Department_Program": "PhD by Research (degree awarded by Sussex)",
   "Country": "UK",
   "City": "Brighton",
   "Region": "UK",
   "URL": "https://www.ids.ac.uk/learn-at-ids/phd-by-research/",
   "Format": "3-4 yrs FT; 8 yrs PT but UK RESIDENTS ONLY (intl students cannot do PT on a student visa).",
   "Funding_Summary": "No direct IDS/Sussex funding; ESRC SEDarc/SeNSS DTP routes. Intl PT barred.",
   "Key_Supervisors": "Historic financial-inclusion/social-protection strength but currently-accepting supervisors rotate; verify a matched, available supervisor (do not assume).",
   "Advantages": "World-leading development-studies brand; deep social-protection/financial-inclusion heritage; values field experience.",
   "Disadvantages": "No in-house funding; part-time closed to international students; current advertised supervisors do not match; light on structured finance.",
  ...
  },
  {
   ...
   "Department_Program": "PhD in Finance with Swiss Finance Institute (GFRI/GSEM)",
   "Country": "Switzerland",
   "City": "Geneva",
   "Region": "Europe",
   "URL": "https://www.unige.ch/gfri/education/phd-finance-sfi",
   "Format": "Full-time, ~4-5 yrs (1 coursework + 3 research); English. Funded via SFI fellowship or assistantship. No part-time.",
   "Funding_Summary": "Tuition only CHF 500/semester; fellowship/assistantship covers living (high Swiss stipends). Very competitive.",
   "Key_Supervisors": "Bernd Balkenhol (Professor of Micro-Finance, GFRI; ex-ILO Social Finance - EMERITUS, confirm capacity); Catalina Martinez Gutierrez (impact investing); Giuseppe Ugazio (behavioral philanthropy)",
   "Advantages": "Elite finance training + a genuine microfinance chair and impact-investing lecturer; near-zero tuition + funded; Geneva hub for development finance/impact investing/ILO.",
   "Disadvantages": "No part-time; demanding first coursework year; a finance PhD - RCT/field-experiment supervision thinner; Balkenhol emeritus; very competitive quant bar.",
  ...
  {
   "ID": "PHD-08",
   "University": "IESEG School of Management / KU Leuven / University of Lille",
   "Department_Program": "Joint IESEG-KU Leuven Doctoral Program in Business Economics; or Lille (SESAM) route",
   "Country": "France/Belgium",
   "City": "Lille / Paris / Leuven",
   "Region": "Europe",
   "URL": "https://www.ieseg.fr/en/programs/phd-programs/joint-ieseg-kuleuven-doctoral-program-business-economics/",
   "Format": "Joint: full-time, 4 yrs, FULLY FUNDED, salaried Teaching/Research Assistant, no tuition; ~100 teaching hrs/yr; English. Lille route 3-5 yrs, funding project-dependent. No part-time.",
   "Funding_Summary": "Salaried assistant contract (or scholarship), competitive, no fees - one of the cleaner funding propositions.",
   "Key_Supervisors": "IESEG via LEM lab; on-topic microfinance supervisor at IESEG To identify. KU Leuven side offers Bert D'Espallier (microfinance) - confirm he can co-supervise on this track.",
   "Advantages": "Salaried, fee-free, English; dual French-Belgian brand; publication-oriented; Paris/Lille workable for European venture activity.",
   "Disadvantages": "Full-time salaried assistant + teaching load competes with venture time; thematic fit hinges on securing an on-topic supervisor; business-economics framing may favour archival over field RCTs.",
  ...
  {
   "ID": "PHD-20",
   "University": "Universite libre de Bruxelles / Universite de Mons (CERMi)",
   "Department_Program": "Centre for European Research in Microfinance (CERMi); PhD via ULB/UMONS doctoral schools",
   "Country": "Belgium",
   "City": "Brussels / Mons",
   "Region": "Europe",
   "URL": "https://www.cermi.eu/",
   "Format": "PhD ~4 yrs, English-capable; often salaried research positions or FNRS/FRESH fellowships. CERMi periodically advertises doctoral fellowships.",
   "Funding_Summary": "Belgian funded-PhD models (salaried positions / FNRS fellowships) available; fellowship/position-dependent - timing matters.",
   "Key_Supervisors": "Marek Hudon (microfinance ethics, social enterprise); Ariane Szafarz (microfinance, gender/discrimination in lending, asset mgmt); Marc Labie (microfinance, financial inclusion); Hubert Tchakoute-Tchuigoua (loan contracts, credit risk, CSR in microfinance)",
   "Advantages": "The single most on-topic research home in Europe for microfinance/financial inclusion/social finance - matches VSLA/microinsurance structuring, mission-drift, credit-risk and securitization questions; deep microfinance-industry ties (ADA Luxembourg, European Microfinance Programme).",
   "Disadvantages": "Funding fellowship/position-dependent (not guaranteed cohort intake); more economics/management-of-microfinance than securitization engineering (bring the tranching layer yourself); dual-institution admin.",
  ...
  {
   "ID": "PHD-21",
   "University": "Geneva Graduate Institute (IHEID)",
   "Department_Program": "Centre for Finance and Development (CFD); PhD in International Economics",
   "Country": "Switzerland",
   "City": "Geneva",
   "Region": "Europe",
   "URL": "https://www.graduateinstitute.ch/cfd",
   "Format": "PhD in International Economics (development-heavy); English; scholarships competitive; Swiss cost base.",
   "Funding_Summary": "Scholarships available (competitive), not a guaranteed salaried post; high Swiss living costs. Confirm package.",
   "Key_Supervisors": "Lore Vandewalle (field experiments/RCTs on financial inclusion, self-help groups, microfinance); Ugo Panizza (development finance, sovereign debt); Nathan Sussman (international finance)",
   "Advantages": "Vandewalle is one of the best individual supervisor matches on the whole list (RCTs + financial inclusion); CFD's impact-investing/development-finance framing fits the private-capital-mobilization thesis precisely; Geneva ecosystem (UN, multilaterals, impact funds) ideal for pilots.",
   "Disadvantages": "Funding scholarship-competitive; high Swiss living costs; full-time (part-time not standard).",
  ...
  },
  {
   ...
   "Department_Program": "Faculty of Economics and Business (PhD)",
   "Country": "Netherlands",
   "City": "Groningen",
   "Region": "Europe",
   "URL": "https://www.rug.nl/staff/b.w.lensink/",
   "Format": "Dutch PhDs commonly salaried employee positions (~4 yrs) - funding advantage; English. Entry position-dependent.",
   "Funding_Summary": "Salaried-PhD model (must match a funded vacancy or bring funding). Strong funding structure.",
   "Key_Supervisors": "Robert Lensink (development finance; microfinance + microinsurance + RCT impact evaluation; J-PAL affiliate)",
   "Advantages": "Salaried-PhD model; Lensink combines microfinance + microinsurance + RCTs - nearly exact methodological fit for the verification-heavy design.",
   "Disadvantages": "Entry is vacancy/position-dependent; full-time; securitization technique still needs a finance angle.",
  ...
  },
  {
   ...
   "Department_Program": "Institute of Development Policy (IOB), PhD in Development Studies",
   "Country": "Belgium",
   "City": "Antwerp",
   "Region": "Europe",
   "URL": "https://www.uantwerpen.be/en/about-uantwerp/faculties/institute-of-development-policy/development-studies/phd-programme/",
   "Format": "PhD (monograph or article-based) + doctoral training; must secure an IOB supervisor before applying; English.",
   "Funding_Summary": "Not automatic: Belgian salaried positions / VLIR-UOS / FWO fellowships where available; some self/externally funded. Verify route early.",
   "Key_Supervisors": "Danny Cassimon (development finance / finance-for-development, innovative financing mechanisms, debt sustainability, real options for development financing)",
   "Advantages": "Cassimon a genuine development-finance/blended-finance supervisor - strong fit for mobilizing private capital + structuring; development-studies framing welcomes impact/RCT and policy relevance.",
   "Disadvantages": "Funding not guaranteed (self-source or win a fellowship); fewer pure structured-finance specialists.",
  ...
  },
  {
   ...
   "Department_Program": "Faculty of Economics & Business / LICOS (PhD in Economics)",
   "Country": "Belgium",
   "City": "Leuven",
   "Region": "Europe",
   "URL": "https://feb.kuleuven.be/research/PhD/Economics/Economics",
   "Format": "Funded PhD positions via annual FEB call; Belgian salaried/fellowship models; ~4 yrs; English.",
   "Funding_Summary": "Funded positions (competitive annual call). Salaried/fellowship.",
   "Key_Supervisors": "Bert D'Espallier (microfinance institutions, performance, inclusion; CERMi network); LICOS for development/institutional economics",
   "Advantages": "Microfinance supervisor + top-ranked economics department + funded positions; also the KU Leuven side of the IESEG joint route (potential co-supervision).",
   "Disadvantages": "Competitive funded-position entry; confirm D'Espallier's current supervision availability.",
  ...
  },
  {
   ...
   "Department_Program": "Doctoral Program (Finance / Economics)",
   "Country": "Germany",
   "City": "Frankfurt",
   "Region": "Europe",
   "URL": "https://www.frankfurt-school.de/en/study/doctoral",
   "Format": "Full-time, up to 5 yrs; English; 100% time commitment. No part-time.",
   "Funding_Summary": "Fully funded via Foundation Doctoral Scholarship up to EUR 2,320/mo tax-exempt from yr 1 + research/travel budgets; competitive.",
   "Key_Supervisors": "Deep institutional microfinance/financial-inclusion heritage sits in the Advisory Services arm, not necessarily the academic PhD faculty - named academic supervisor To identify (verify before applying).",
   "Advantages": "Fully funded, English, finance-rigorous, in a major financial centre; the microfinance/financial-inclusion consulting network is unmatched for practitioner ties + potential pilot partners.",
   "Disadvantages": "Full-time 100%-commitment scholarship (hard to run a venture); academic microfinance chair unconfirmed - heritage is advisory, not necessarily supervision.",
  ...
  {
   "ID": "PHD-26",
   "University": "UNU-MERIT / Maastricht University",
   "Department_Program": "PhD in Innovation, Economics, Governance & Sustainable Development",
   "Country": "Netherlands",
   "City": "Maastricht",
   "Region": "Europe",
   "URL": "https://unu.edu/merit/phd-programme/phd-programme-innovation-economics-governance-and-sustainable-development",
   "Format": "Two tracks: (a) full-time 4-yr; (b) 'Dual Career' PhD for working professionals with limited on-site presence + online support (the part-time/venture-parallel option). English.",
   "Funding_Summary": "Full-time funding via grants/scholarships (not guaranteed by program; ~10 fellowships in past cycles). Dual Career track typically self/employer-funded.",
   "Key_Supervisors": "Distinguished development-economics/impact-evaluation faculty; on-topic financial-inclusion/RCT supervisor To identify (verify).",
   "Advantages": "The Dual Career track is a rare explicit part-time/venture-parallel route; UN affiliation + SDG framing fit the development-impact and capital-mobilization narrative.",
   "Disadvantages": "Full-time funding not automatic; Dual Career usually self-funded; finance-structuring specialization thin.",
  ...
  },
  {
   ...
   "Department_Program": "Development Economics Group (PhD)",
   "Country": "Netherlands",
   "City": "Wageningen",
   "Region": "Europe",
   "URL": "https://www.wur.nl/en/chair-groups/section-economics/development-economics",
   "Format": "Dutch salaried-PhD model common (~4 yrs); also externally/sandwich-funded PhDs; English.",
   "Funding_Summary": "Salaried-PhD potential (position-dependent).",
   "Key_Supervisors": "Erwin Bulte (development econ; field experiments/RCTs, risk, insurance, resilience; IGC/CEPR/ATAI-adjacent)",
   "Advantages": "RCT-heavy group; agricultural/rural-finance + index-insurance expertise fits the microinsurance and African-field-site angle; salaried-PhD potential.",
   "Disadvantages": "More agricultural/rural development than structured finance; entry position-dependent.",
  ...
  {
   "ID": "PHD-28",
   "University": "Universite Clermont Auvergne (CERDI)",
   "Department_Program": "Centre for Studies and Research on International Development (PhD)",
   "Country": "France",
   "City": "Clermont-Ferrand",
   "Region": "Europe",
   "URL": "https://cerdi.uca.fr/english-version",
   "Format": "PhD via doctoral college, ~3 yrs; funded doctoral contracts (salaried) awarded competitively; some admin in French; English supervision per supervisor.",
   "Funding_Summary": "Fully funded doctoral contracts (contrats doctoraux), competitive annual selection.",
   "Key_Supervisors": "Large development-economics faculty (development financing, Sub-Saharan Africa focus); named microfinance/microinsurance supervisor To identify.",
   "Advantages": "Funded salaried contracts; one of Europe's heavyweight development-economics centres; deep African-fieldwork + impact-evaluation tradition.",
   "Disadvantages": "Competitive fixed-cycle funded-contract entry; some administration in French; supervisor fit unverified.",
  ...
  {
   "ID": "PHD-29",
   "University": "University of Mannheim / ZEW",
   "Department_Program": "Economics PhD (with ZEW research)",
   "Country": "Germany",
   "City": "Mannheim",
   "Region": "Europe",
   "URL": "https://www.zew.de/en/team/rdh",
   "Format": "Top-tier economics PhD, typically funded; English.",
   "Funding_Summary": "Funded (competitive); German structured-PhD norms.",
   "Key_Supervisors": "Ralph de Haas (ZEW; also EBRD Director of Research, KU Leuven) - leading development-finance / financial-inclusion scholar",
   "Advantages": "Top-tier economics PhD + a leading development-finance supervisor (de Haas) with EBRD ties - strong for the capital-mobilization + banking angle.",
   "Disadvantages": "Very competitive; confirm de Haas supervising availability given multiple affiliations; more empirical banking than securitization engineering.",
  ...
  {
   "ID": "PHD-30",
   "University": "Krea University (IFMR Graduate School of Business)",
   "Department_Program": "PhD in Management + affiliated LEAD at Krea (financial inclusion/RCT centre)",
   "Country": "India",
   "City": "Sri City",
   "Region": "Asia",
   "URL": "https://krea.edu.in/ifmrgsb/phd-programme-krea/",
   "Format": "BOTH full-time (4 yrs, +1) and PART-TIME (hybrid: in-person + hybrid lectures, on-campus exams). English.",
   "Funding_Summary": "Full-time: tuition waiver + monthly stipend + conference funding. Part-time: self-funded.",
   "Key_Supervisors": "Jyoti Prasad Mukhopadhyay (PhD chair; development/financial-services econ); LEAD at Krea - Sharon Buteau (financial inclusion, enterprise growth); Financial Well-being & Social Protection research vertical",
   "Advantages": "The heartland of Indian financial-inclusion research; LEAD does exactly the RCT/impact-evaluation work the project needs; part-time route exists; genuine field access.",
   "Disadvantages": "Part-time self-funded; less global brand prestige than NUS/HKUST; securitization/structured-finance depth thinner (partner with a finance advisor).",
  ...
  },
  {
   ...
   "Department_Program": "Lee Kong Chian School of Business, PhD (Finance); also SMU-PHBS DBA in Economics (part-time)",
   "Country": "Singapore",
   "City": "Singapore",
   "Region": "Asia",
   "URL": "https://business.smu.edu.sg/faculty/profile/981/hao-liang",
   "Format": "Full-time PhD (stipend + fees); plus a part-time/executive SMU-PHBS DBA in Economics (with Peking Univ HSBC BS). English.",
   "Funding_Summary": "PhD funded (SMU norm); DBA self-funded/executive.",
   "Key_Supervisors": "Hao Liang (sustainable finance, impact investing, 'Globalization and Affordability of Microfinance'; co-director Singapore Green Finance Centre)",
   "Advantages": "Arguably the best-sourced individual supervisor match in Asia (microfinance + sustainable finance + impact investing); Singapore hub; both a research PhD and an executive DBA route exist.",
   "Disadvantages": "PhD full-time on-campus (relocation); DBA is a professional degree (practice-weighted credibility).",
  ...
  },
  {
   ...
   "Department_Program": "NUS Business School, Dept of Finance; NUS Sustainable & Green Finance Institute (SGFIN)",
   "Country": "Singapore",
   "City": "Singapore",
   "Region": "Asia",
   "URL": "https://bschool.nus.edu.sg/finance/phd/phd-how-to-apply/",
   "Format": "Full-time, on-campus, ~4-5 yrs; English; GMAT/GRE optional.",
   "Funding_Summary": "Full scholarship (tuition + living) + conference/overseas-research funding. Strongly funded.",
   "Key_Supervisors": "Johan Sulaeman (Director SGFIN; sustainability/impact measurement in finance). Microfinance/VSLA-specific supervisor To identify.",
   "Advantages": "Singapore green-finance hub; strong funding; sustainable finance an explicit departmental theme; SGFIN gives a structuring/impact-measurement home.",
   "Disadvantages": "Full-time on-campus (incompatible with running the venture from Israel); technique-heavy (asset pricing), may not centre development/RCT; on-topic supervisor unconfirmed.",
  ...
  },
  {
   ...
   "Department_Program": "Nanyang Business School, Finance; Centre for Sustainable Finance Innovation + Insurance Risk & Finance Research Centre",
   "Country": "Singapore",
   "City": "Singapore",
   "Region": "Asia",
   "URL": "https://www.ntu.edu.sg/business/academic-divisions/banking-finance",
   "Format": "Full-time PhD, ~4-5 yrs; English; GMAT/GRE.",
   "Funding_Summary": "NTU research scholarships (stipend + tuition for admitted PhDs).",
   "Key_Supervisors": "Chang Xin 'Simba' (Director CSFI; sustainable/corporate finance); Jun-Koo Kang (Director, Insurance Risk & Finance Research Centre - the insurance leg); Hong Ru (credit/development-adjacent finance)",
   "Advantages": "A dedicated sustainable-finance centre PLUS an insurance-risk centre - an unusually good structural match for lending + microinsurance securitization; strong funding.",
   "Disadvantages": "Full-time, relocation; microfinance/RCT development-field angle not the centre's core (leans corporate ESG).",
  ...
  },
  {
   ...
   "Department_Program": "Department of Finance (PhD)",
   "Country": "Hong Kong SAR",
   "City": "Hong Kong",
   "Region": "Asia",
   "URL": "https://fina.hkust.edu.hk/programs/phd/program-structure-and-requirement",
   "Format": "Full-time PhD, ~4 yrs; English; GMAT/GRE; HKPFS application ~1 Dec.",
   "Funding_Summary": "Among the most generous globally: Hong Kong PhD Fellowship Scheme HK$340,800/yr (~US$43,730) x4 + HK$14,200/yr travel + full tuition waiver; HKUST RedBird top-ups.",
   "Key_Supervisors": "Darwin Choi (socially responsible investing); Zhanhui Chen (asset pricing linked to insurance, fintech, sustainable finance); Chu Zhang (financial markets/institutions). No verified microfinance/development-field specialist.",
   "Advantages": "Exceptional funding; top-ranked finance department; ESG/green-finance + insurance-adjacent supervisors.",
   "Disadvantages": "Full-time relocation + HK student visa; very quantitative, thin on RCT/development-field methods; VSLA supervisor not confirmed.",
   "Venture_Pilot_Fit": "Low (relocation).",
   "Tier": "2",
  ...
  {
   "ID": "PHD-35",
   "University": "BRAC University (joint with SOAS, University of London)",
   "Department_Program": "Joint PhD in Global Development",
   "Country": "Bangladesh",
   "City": "Dhaka",
   "Region": "Asia",
   "URL": "https://www.bracu.ac.bd/admissions/joint-phd-admission",
   "Format": "Joint PhD in Global Development (SOAS-BRAC). Confirm FT/PT + residency split. English.",
   "Funding_Summary": "Confirm - joint programs sometimes carry studentships; assume competitive/partly self-funded until verified.",
   "Key_Supervisors": "BRAC (birthplace of large-scale microfinance) field ecosystem + SOAS development-economics supervision. Named supervisors To identify.",
   "Advantages": "Best-in-world microfinance field ecosystem (BRAC's own microfinance operations) paired with a UK-degree development-economics supervision.",
   "Disadvantages": "New program; funding/format need confirmation; Bangladesh residency component.",
  ...
  },
  {
   ...
   "Department_Program": "Open University Business School, PhD (Accounting & Finance / Economics)",
   "Country": "UK",
   "City": "Milton Keynes",
   "Region": "Remote",
   "URL": "https://business-school.open.ac.uk/research/research-degrees",
   "Format": "FT (Milton Keynes) and PT. CAVEAT: research-degree PT students 'normally resident in the UK and attend regular meetings' - verify overseas PT eligibility (the make-or-break question).",
   "Funding_Summary": "Fully-funded FT studentships via ESRC Grand Union DTP; PT is self-funded.",
   "Key_Supervisors": "Departments include Accounting & Finance and Public Leadership & Social Enterprise; named supervisor To identify.",
   "Advantages": "Genuine PhD; distance-friendly institutional culture; funded FT route exists.",
   "Disadvantages": "PT normally UK-resident (key blocker for an Israel-based applicant) - confirm overseas eligibility first.",
  ...
  {
   "ID": "PHD-37",
   "University": "Heriot-Watt University (Edinburgh Business School)",
   "Department_Program": "DBA (Doctor of Business Administration)",
   "Country": "UK",
   "City": "Edinburgh (online / Dubai)",
   "Region": "Remote",
   "URL": "https://www.hw.ac.uk/ebs/study/dba",
   "Format": "Fully online / distance-capable, part-time professional research doctorate (DBA, not PhD).",
   "Funding_Summary": "Self-funded (DBA norm). Cost/duration not published - request from EBS.",
   "Key_Supervisors": "Not listed; EBS is a reputable UK degree-awarding institution (higher credibility than most online DBAs). Supervisor To identify.",
   "Advantages": "Genuinely remote - the best pure-distance fit for staying in Israel; UK university with real degree-awarding powers.",
   "Disadvantages": "DBA (practice-weighted, not academic-career grade); self-funded; supervisor-on-topic unverified; less RCT methodological depth than a research PhD.",
  ...
  },
  {
   ...
   "Department_Program": "DBA (also a separate full-time academic PhD in Management)",
   "Country": "Spain",
   "City": "Madrid",
   "Region": "Remote",
   "URL": "https://www.ie.edu/business-school/programs/doctorates/dba/",
   "Format": "Part-time blended DBA, 4 yrs (2 coursework + 2 dissertation); only 3 residency periods in Spain (2 weeks each); English. Triple-accredited.",
   "Funding_Summary": "Self-funded (fees not published - request from admissions).",
   "Key_Supervisors": "Not named on page; IE is AACSB/EQUIS/AMBA triple-accredited (high DBA credibility). Supervisor To identify.",
   "Advantages": "Only ~6 weeks total on-site over 4 years - very venture-compatible; strong brand; English.",
   "Disadvantages": "Executive-level entry expectation; DBA credibility tier (below a research PhD); self-funded.",
   "Venture_Pilot_Fit": "High.",
   "Tier": "2",
   "Verification_Status": "Program verified; supervisor to verify",
  ...
  {
   "ID": "PHD-39",
   "University": "University of Reading (Henley Business School)",
   "Department_Program": "DBA (Doctor of Business Administration)",
   "Country": "UK",
   "City": "Henley-on-Thames (also Johannesburg)",
   "Region": "Remote",
   "URL": "https://www.henley.ac.uk/study/phds/doctor-of-business-administration-dba",
   "Format": "Part-time, hybrid, 4-6 yrs; DBA (not PhD); English. Triple-accredited.",
   "Funding_Summary": "Self-funded: ~GBP 14,500/yr (yrs 1-3), GBP 11,500 (yr 4), GBP 7,500 (yrs 5-6).",
   "Key_Supervisors": "Ruth Sealy (programme director); Finance & Accounting research area exists. Supervisor To identify.",
   "Advantages": "Prestigious, triple-accredited; hybrid (limited residency); a Finance & Accounting research theme.",
   "Disadvantages": "Requires minimum 5 yrs managerial experience; some Henley/Johannesburg presence; DBA (practice-framed); self-funded.",
  ...
  },
  {
   ...
   "Department_Program": "School of Economics / CREDIT (PhD Economics)",
   "Country": "UK",
   "City": "Nottingham",
   "Region": "UK",
   "URL": "https://www.nottingham.ac.uk/economics/",
   "Format": "PhD (MRes+PhD or direct with strong master's); FT (PT possible - confirm).",
   "Funding_Summary": "Midlands Graduate School ESRC DTP; Nottingham studentships; intl-eligible but limited.",
   "Key_Supervisors": "Oliver Morrissey (development econ; development finance, aid, trade, fiscal policy). Microfinance/impact co-supervisor To identify.",
   "Advantages": "Established development-economics centre (CREDIT); solid econometrics.",
   "Disadvantages": "Less on securitization + microinsurance specifically; intl funding competitive.",
  ...
  {
   "ID": "PHD-41",
   "University": "Toulouse School of Economics / Paris School of Economics",
   "Department_Program": "Economics PhD (development / contract theory / RCTs)",
   "Country": "France",
   "City": "Toulouse / Paris",
   "Region": "Europe",
   "URL": "",
   "Format": "Elite funded economics PhDs, English; funded doctoral contracts.",
   "Funding_Summary": "Funded (competitive); French doctoral contracts salaried.",
   "Key_Supervisors": "Strong development + contract-theory (TSE) and development-economics/RCT clusters (PSE, J-PAL Europe ties). Named supervisor To identify.",
   "Advantages": "Top-tier economics training + funding; PSE especially strong for impact evaluation.",
   "Disadvantages": "Very competitive; no verified microfinance-specialized supervisor yet; full-time.",
  ...
  {
   "ID": "PHD-42",
   "University": "University of Gothenburg / Stockholm School of Economics",
   "Department_Program": "Economics PhD (Environment for Development / SITE) - Nordic salaried model",
   "Country": "Sweden",
   "City": "Gothenburg / Stockholm",
   "Region": "Europe",
   "URL": "https://www.gu.se/en/economics/doctoral-studies",
   "Format": "Salaried PhD employee positions (~5 yrs, strong funding advantage); English; competitive annual intake.",
   "Funding_Summary": "Fully salaried Nordic PhD (best funding model).",
   "Key_Supervisors": "Environmental + development economics, RCT/field capacity (EfD network; SITE at SSE). On-topic financial-inclusion supervisor To identify.",
   "Advantages": "Fully salaried; development + environmental/climate-finance angle fits the sustainability dimension.",
   "Disadvantages": "Finance-structuring thin; microfinance-specific supervisor unverified; relocation to Sweden.",
  ...
  {
   "ID": "PHD-43",
   "University": "Erasmus University Rotterdam (ISS)",
   "Department_Program": "International Institute of Social Studies, PhD",
   "Country": "Netherlands",
   "City": "The Hague",
   "Region": "Europe",
   "URL": "https://www.iss.nl/en/research/phd-programme",
   "Format": "4-yr doctorate, largely SELF-FUNDED (must prove funds); English.",
   "Funding_Summary": "Self-funded: tuition ~EUR 8,000/yr; total incl. living/fieldwork ~EUR 92,750. Waiver possible on request.",
   "Key_Supervisors": "Development-studies strength (social/political economy of development); finance/microfinance supervisor To identify.",
   "Advantages": "Development-studies depth; fieldwork-oriented; The Hague policy hub.",
   "Disadvantages": "Self-funded model is the weakest funding fit here; finance-structuring expertise unverified.",
 ...
 "milestones": [
  {
   "ID": "M-01",
   "Phase": "Days 1-30",
   "Milestone": "Finalize lit-matrix anchors",
   "Detail": "Target 10-15 anchors. Now at 15 (LIT-001 to LIT-015) after adding cross-border SPV law, African ABS market depth, blended-finance first-loss and savings-group regulation anchors.",
   "Status": "Done",
   "Owner": "BB",
   "Linked_Refs": "LIT-009..LIT-015"
  },
  {
   "ID": "M-02",
   "Phase": "Days 1-30",
   "Milestone": "Complete 3 synthesis memos",
   "Detail": "All three drafted and now updated against the new anchors; moving from Drafted to Reviewed.",
   "Status": "Done",
   "Owner": "BB",
   "Linked_Refs": "MEMO-1; MEMO-2; MEMO-3"
  },
  {
   "ID": "M-03",
   "Phase": "Days 1-30",
   "Milestone": "Identify 3-5 concrete market gaps via partner outreach",
   "Detail": "Partner Tracker has 10 candidates; contact not yet begun.",
   "Status": "Not started",
   "Owner": "BB",
   "Linked_Refs": "PT-01..PT-10"
  },
  {
   "ID": "M-04",
   "Phase": "Days 31-60",
   "Milestone": "Screen and interview 3-5 candidate originator/verification partners",
   "Detail": "Prioritise PT-03 (CARE VSLA network), PT-05 (J-PAL) and PT-01/PT-02 for the Israel pilot.",
   "Status": "Not started",
   "Owner": "BB",
   "Linked_Refs": "PT-01; PT-02; PT-03; PT-05"
  },
  {
   "ID": "M-05",
   "Phase": "Days 31-60",
   "Milestone": "Select Israel pilot use-case and draft product/operating model",
   "Detail": "Loan vs insurance vs bundled product decision still open.",
   "Status": "Not started",
   "Owner": "BB",
   "Linked_Refs": "OQ-3"
  },
  {
   "ID": "M-06",
   "Phase": "Days 31-60",
   "Milestone": "Begin PhD supervisor outreach",
   "Detail": "See the outreach plan per program in the PhD pipeline.",
   "Status": "Not started",
   "Owner": "BB",
  ...
  },
  {
   "ID": "M-07",
   "Phase": "Days 31-60",
   "Milestone": "Resolve Open Questions 1-3 (legal, pool size, data schema)",
   "Detail": "All three now partially answered from the literature; remaining work is counsel review (OQ-1), a warehousing plan (OQ-2) and a drafted schema (OQ-3).",
   "Status": "In progress",
   "Owner": "BB",
   "Linked_Refs": "OQ-1; OQ-2; OQ-3"
  },
  {
   "ID": "M-08",
   "Phase": "Days 61-90",
   "Milestone": "Draft pilot design doc",
   "Detail": "20-50 VSLA or Israel equivalent cohort, RCT/quasi-experimental design per OQ-4.",
   "Status": "Not started",
   "Owner": "BB",
   "Linked_Refs": "OQ-4; OQ-5"
  },
  {
   "ID": "M-09",
   "Phase": "Days 61-90",
   "Milestone": "Secure 1 anchor originator + 1 verification partner commitment",
   "Detail": "Dependent on M-03 and M-04.",
   "Status": "Not started",
   "Owner": "BB",
   "Linked_Refs": "PT-03; PT-05"
  },
  {
   "ID": "M-10",
   "Phase": "Days 61-90",
   "Milestone": "Outline first-loss/blended-finance structure with 1-2 DFI/impact fund contacts",
   "Detail": "Working assumption: junior tranche in the 10-20% range, benchmarked against OECD/IFC practice.",
   "Status": "Not started",
   "Owner": "BB",
   "Linked_Refs": "OQ-6; LIT-012; LIT-013; LIT-015"
  },
  {
   "ID": "M-11",
   "Phase": "Days 61-90",
   "Milestone": "Submit first PhD applications where cycles allow",
   "Detail": "Dependent on M-06.",
   "Status": "Not started",
   "Owner": "BB",
   "Linked_Refs": "PHD-01..PHD-09"
  },
  {
   ...
   "Detail": "docs/phd/research-proposal.md assembled: research question narrowed to climate + poverty in Africa/MENA, five deliverables mapped to their homes, lit-review section framed from existing memos with gaps flagged. Deep drafting is the follow-on.",
   "Status": "In progress",
   "Owner": "BB",
  ...
  },
  {
   ...
   "Detail": "docs/research/methodology-opportunity-mapping.md now carries the resolved research-first weighting (OQ-9) and the first scoring pass produced the flagship trio EXP-01/EXP-02/EXP-06 (OQ-11). Axis-X evidence anchors still to fill.",
   "Status": "Done",
   "Owner": "BB",
  ...
  },
  {
   ...
   "Detail": "docs/research/methodology-impact-measurement.md: outcome metrics (climate resilience + poverty), causal-design hierarchy (builds on OQ-4/OQ-5) and independent verification (OQ-7). Metric selection per experiment follows OQ-11.",
   "Status": "In progress",
   "Owner": "BB",
  ...
  },
  {
   ...
   "Detail": "docs/venture/funding-pipeline.md plus data/funders.csv (FUND-01..FUND-10): four funder lanes, cost buckets and a sequenced ask. Funder-research pass (verify live, calls, deadlines, URLs) is the follow-on.",
   "Status": "In progress",
   "Owner": "BB",
  ...
  },
  {
   "ID": "M-20",
   "Phase": "Days 31-60",
   "Milestone": "Approach verification partners (in parallel) and co-design the 3-experiment measurement",
   "Detail": "Gating prerequisite for the flagship portfolio. Per OQ-7, approach several candidates in parallel - J-PAL (PT-05), 3ie-linked evaluators, and university research centres in the target Africa/MENA countries - coordinated through the partner tracker to avoid duplicate contact. Co-develop the shared parametric measurement architecture with whichever commits.",
   "Status": "Not started",
   "Owner": "BB",
  ...
  },
  {
   "ID": "M-22",
   "Phase": "Days 31-60",
   "Milestone": "Start the blended first-loss structure design (parallel commercial track)",
   "Detail": "Per OQ-6, pursue the blended structure now alongside the grant-funded pilots rather than deferring: draft a target first-loss/senior waterfall spec and open early DFI engagement (IFC, FMO, British International Investment, AFD/Proparco). First-loss capital deploys once a warehouse-able pool exists; this milestone is the design and relationship groundwork.",
   "Status": "Not started",
   "Owner": "BB",
   "Linked_Refs": "OQ-6; LIT-012; LIT-013; LIT-015; PT-07"
  },
  {
   "ID": "M-21",
   "Phase": "Days 31-60",
  ...
  },
  {
   "ID": "M-26",
   "Phase": "Days 1-45",
   "Milestone": "Close the P1 literature gap",
   "Detail": "Read the ten P1 components in data/lit-components.csv (96 targets, 26 filled as of 2026-08-22, so 70 new anchors) and draft synthesis memos 5, 6 and 7. LC-04, LC-03 and LC-24 are done as first passes. LC-04 and LC-03 between them falsified the proposal's novelty claim (OQ-17); LC-24 audited the coffee anchor decision and cleared it, while moving the risk onto data rails and covariate correlation (MEMO-9). The remaining queue is LC-05, LC-06, LC-07 and LC-08, which gate OQ-17 (see M-35), then LC-01, LC-02 and LC-09.",
   "Status": "In progress",
   "Owner": "BB",
   "Linked_Refs": "LC-04; LC-03; LC-05; LC-07; LC-08; LC-24; MEMO-5; MEMO-6; MEMO-7; M-01; OQ-16; LC-06; OQ-17; M-35; MEMO-9"
  },
  {
   "ID": "M-27",
   "Phase": "Days 1-30",
   "Milestone": "Resolve OQ-15: fix the experiment portfolio and its sequence",
   "Detail": "Resolved 2026-08-22. Decision: a SEQUENCED portfolio rather than a replacement of the OQ-11 trio. Two desk-executable falsification tests run first - EXP-25 (default correlation on historical partner MIS) and EXP-22 (securitisation-ready origination protocol with activity-based costing) - because either can kill the thesis before field money is committed. One field anchor follows, chosen with the advisor; which one is deferred to OQ-16. EXP-22 and EXP-25 are now Selected; EXP-01, EXP-02 and EXP-06 return to Idea. OQ-11 marked superseded, not deleted. Delivery is M-32 and M-33.",
   "Status": "Done",
   "Owner": "BB",
   "Linked_Refs": "OQ-15; OQ-11; EXP-22; EXP-25; EXP-09"
  },
  {
   "ID": "M-28",
   "Phase": "Days 30-70",
   "Milestone": "Calibrate the research framework and draft the pre-registration template",
   "Detail": "Fill the parameters docs/research/research-framework.md section 6 leaves open: intra-cluster correlations from LC-01 and LC-26, expected shock incidence, baseline default rates. Then draft the pre-registration template. No minimum detectable effect is quotable until this is done. Feeds M-08.",
   "Status": "Not started",
   "Owner": "BB",
   "Linked_Refs": "M-26; M-08; OQ-4; OQ-7; RT-4"
  },
  {
   "ID": "M-29",
   "Phase": "Days 30-90",
   "Milestone": "Complete the application pack and run a first wave of three approaches",
   "Detail": "Fill the CV and the personal sections of the Vault application pack, then approach three Priority-tier programmes from the scoring rubric - deliberately not the top three, so the pack can be revised on real replies before the best targets are used. Verify each supervisor is active and taking students first. Log every contact through the partner-outreach skill into private/phd-applications.csv.",
   "Status": "Not started",
   "Owner": "BB",
   "Linked_Refs": "M-06; M-11; OQ-14; RQ-01"
  },
  {
   "ID": "M-30",
   "Phase": "Days 45-90",
   "Milestone": "Spec three to five experiments against the write-up template",
   "Detail": "Expand the shortlisted experiments from tracker rows into full specs at docs/research/experiments/, using the template in docs/research/experiment-spec-template.md. Three to five, no more. Gated on M-27 deciding which ones. STARTED 2026-08-22: EXP-25 specced at docs/research/experiments/exp-25-default-correlation.md, and it is a RESPEC not a first draft - the LC-08 read showed the tracker row's single-correlation framing would have hidden the finding, so the estimand is now a variance decomposition separating the institutional channel from the environmental one. EXP-22 is next and is not blocked. Directory docs/research/experiments/ created. EXP-22 specced 2026-08-22 - two of three to five done. Writing it up caught two defects in the tracker row: it named two primary outcomes running on incompatible clocks (cost is weeks, default predictability is a year-plus), and it assumed the control arm was a coherent protocol, which LIT-031 shows is not true of cooperative internal credit funds. Both fixed in the spec. Net effect on the critical path: RQ-21 moves to EXP-25's retrospective panels, removing about a year of seasoning wait.",
   "Status": "In progress",
   "Owner": "BB",
   "Linked_Refs": "M-27; OQ-15; EXP-22; EXP-25; LC-08"
  },
  {
   "ID": "M-31",
   "Phase": "Days 1-30",
   "Milestone": "Move the personal credentials out of the public-linked Drive workfolder",
   "Detail": "Ten personal files (transcripts, degree certificates, psychometric scores) sit in an \"Application Docs\" folder inside the SFV workfolder, which docs/ops/drive-vault.md documents as the publicly-linked folder and which the dashboard links to. They belong in the Vault, in the Credentials subfolder of 02-applications-phd/General Application, which was created on 2026-08-22 and is empty. The move could not be automated: the files are owned by a different Google account than the tooling authenticates as, and Drive returns a permission error. Drive currently reports the workfolder as owner-only so nothing is exposed today, but the repo treats that folder as public. Two-minute manual fix from the owning account; delete the emptied folder afterwards.",
   "Status": "Not started",
   "Owner": "BB",
   "Linked_Refs": "M-29"
  },
  {
   "ID": "M-32",
   "Phase": "Days 1-60",
   "Milestone": "Secure partner data access and run the two falsification tests",
   "Detail": "The earliest substantive research work, and the gate on the field anchor. EXP-25 needs historical management-information-system data from one or more originators across regions to estimate default correlation; EXP-22 needs an originator willing to run two origination protocols side by side with costing. Neither needs a field pilot, a grant or ethics approval on the scale a trial does - which is the point of running them first. The partner ask here is materially smaller than a pilot proposal: five years of anonymised portfolio data is a request an MFI network can answer in a week, where hosting a multi-year randomised trial takes a year. Lead outreach (M-03, M-04) with this ask. If EXP-25 finds default is covariate rather than idiosyncratic, or EXP-22 finds capture costs exceed the value they unlock, the pooling thesis needs restructuring before any field money is spent - see the falsification table in docs/research/research-framework.md. ASK SHARPENED 2026-08-22 by the EXP-25 respec. The request is no longer 'share your portfolio data'. It is: pseudonymised loan-level records covering a window that CONTAINS A SHOCK, from TWO lenders in the same market. Two lenders per market is a design minimum, not a preference - with one lender the institutional channel is unidentified and a near-zero market correlation would be an artefact of the design rather than a finding. The ask also now carries an offer: every participating lender gets its own variance decomposition back, which is a number none of them currently has about their own book. And it is explicitly pseudonymised, with no personal identifiers requested, which lowers the barrier to a yes. Screen any offered dataset for a shock in the window BEFORE accepting it - a quiet panel produces a falsely reassuring near-zero covariate component, which is the most dangerous failure mode here because it looks like success. OUTREACH SEQUENCING, from the EXP-22 spec: approach a new originator with EXP-22 FIRST, not EXP-25. EXP-22 asks only for permission to vary a process and observe it - no historical data disclosure - and it gives the originator something immediately usable: a costed answer to what it would take for their book to be investable, a validated field list, and a time-and-motion baseline of their own origination that most originators do not have. That is a far easier first yes, and the relationship it builds is what makes EXP-25's loan-level data request plausible later. Also screen every candidate for CLUSTER COUNT before anything else - 10 to 40 branches is typical and is the binding constraint on EXP-22's design.",
   "Status": "Not started",
   "Owner": "BB",
   "Linked_Refs": "OQ-15; EXP-22; EXP-25; M-03; M-04; RT-5; RT-1"
  },
  {
   "ID": "M-33",
   "Phase": "Days 60-120",
   "Milestone": "Choose between EXP-09 and EXP-10 as the field anchor (OQ-16 residual)",
   "Detail": "PARTIALLY RESOLVED 2026-08-22: the anchor setting is the coffee cooperative cluster, so EXP-01 and EXP-06 are out of contention. What remains is the instrument - EXP-09 (pre-harvest credit with a climate trigger and price stabilisation) or EXP-10 (an index calibrated to leaf rust and heat stress). Still gated on a supervisor conversation (OQ-14), on site and partner access actually being tested (M-32, M-03, M-04), and on LC-24, which now verifies the coffee bet rather than informing it. Whichever is chosen must carry the second randomisation layer (funding source) from research-framework section 3, then move to Selected and get a full spec against docs/research/experiment-spec-template.md.",
   "Status": "Not started",
   "Owner": "BB",
   "Linked_Refs": "OQ-16; OQ-14; M-26; M-29; M-30; M-32; LC-24"
  },
  {
   "ID": "M-34",
   "Phase": "Days 1-30",
  ...
  },
  {
   "ID": "M-35",
   "Phase": "Days 1-45",
   "Milestone": "Read LC-05 to LC-08, then close OQ-17 and lift the proposal hold",
   "Detail": "The gate on all proposal-led advisor outreach. OQ-17 was deliberately left open on 2026-08-22 pending these four reads: LC-05 (resilience and consumption-smoothing outcome measurement), LC-06 (climate and adaptation finance), LC-07 (credit-risk modelling in thin-data settings) and LC-08 (portfolio correlation and covariate risk). LC-08 is the one most likely to move the answer - LIT-030 already sits there and ties basis risk to the pool's loss distribution, which is candidate relocation (b). On completion: pick a relocation, correct the novelty claim in docs/phd/phd-proposal-master.md, remove its CORRECTION PENDING banner, and re-frame research-framework section 3 to match. If the four reads do not displace it, the default is candidate (c) - EXP-17's separation of the take-up effect from the protection effect. Until this is done phd-proposal-master.md does not go to an advisor. PROGRESS 2026-08-22: first anchors landed on all four. LC-08 is now Partially covered with six anchors and its framing corrected - the dominant historical correlation channel is institutional and market-level (LIT-036, LIT-037), not macro or weather, though LIT-031 shows the environmental channel is severe in the chosen coffee setting. LC-05, LC-06 and LC-07 are In progress with one anchor each (LIT-039 RIMA, LIT-040 CPI, LIT-038 Pluto-Tasche). OQ-17 is NOT yet closable: LC-08's finding strengthens candidate relocation (b) - a correlation nobody has measured, in an asset class where the standard PD method takes it as an input - but LC-05, LC-06 and LC-07 are each one anchor deep and cannot yet be said to have been read.",
   "Status": "In progress",
   "Owner": "BB",
   "Linked_Refs": "OQ-17; LC-05; LC-06; LC-07; LC-08; LIT-030; EXP-17; M-26; M-29; LIT-036; LIT-037; LIT-038; LIT-039; LIT-040; MEMO-7"
  }
 ],
 "memos": [
  {
  ...
  },
  {
   "ID": "MEMO-4",
   "Memo_No": "4",
   "Title": "The repayment mechanism and its critics",
   "Covers_Axis": "2-Microfinance / 1-VSLA",
   "Status": "Outline",
   "Path": "literature/notes/memo-4-the-repayment-mechanism-and-its-critics.md",
   "Key_Takeaways": "Scope: what actually drives repayment in community lending, and what the critical literature says happens when external capital enters member-owned institutions. Carries OQ-12 and OQ-13. Not yet drafted."
  },
  {
   "ID": "MEMO-5",
   "Memo_No": "5",
   "Title": "Insurance, bundling, and what resilience means",
   "Covers_Axis": "5-Insurance / 2-Microfinance",
   "Status": "Drafted",
   "Path": "literature/notes/memo-5-insurance-bundling-resilience.md",
   "Key_Takeaways": "PARTIAL - LC-04 and LC-03 read, LC-05 outstanding; all seven sources verified from abstracts or publisher summary pages, not full texts. BUNDLING (LC-04): not untested. Compulsory bundling suppressed demand in two RCTs - Gine & Yang 2009 Malawi (take-up 13 points lower off a 33.0% base) and Banerjee, Duflo & Hornbeck 2014 India (16 point, 23 percent rise in drop-out, measured on the lender's book). Karlan et al. 2014 Ghana is the counterweight: uninsured risk rather than capital binds, and demand for SEPARATELY offered cover is strong. The reconciling distinction is offered-separately versus compulsorily-priced-into-the-loan. INDEX INSURANCE (LC-03) compounds it: Carter et al. 2017 report take-up disappointingly low WITHOUT LARGE AND SUSTAINED SUBSIDIES; Clarke 2016 shows low demand can be RATIONAL under basis risk (optimal demand zero for the infinitely risk-averse, nonmonotonic in risk aversion, wealth and price); Jensen et al. 2018 measures basis risk directly and finds it and spatiotemporal adverse selection drive demand - the latter also a warning for the pool's loss distribution, so cross-referenced to LC-08. CONSEQUENCES: the proposal's novelty claim is false as written (OQ-17), EXP-01 is on the wrong side of the subsidy variable, EXP-17 becomes the centrepiece with its subsidised arm carrying the strongest prior, EXP-30's basis-risk premise is supported, and RT-6 cannot treat bundling as retention-neutral."
  },
  {
   "ID": "MEMO-6",
   "Memo_No": "6",
   "Title": "The climate financing gap and how to measure a response",
   "Covers_Axis": "4-Blended finance / 2-Microfinance",
   "Status": "Outline",
   "Path": "literature/notes/memo-6-the-climate-financing-gap-and-how-to-measure-a-response.md",
   "Key_Takeaways": "Scope: authoritative adaptation and energy-access gap estimates, and the impact-evaluation methods needed to credibly measure a response. P1. Not yet drafted."
  },
  {
   "ID": "MEMO-7",
   "Memo_No": "7",
   "Title": "Can these cash flows be modelled",
   "Covers_Axis": "3-Securitization",
   "Status": "Outline",
   "Path": "literature/notes/memo-7-can-these-cash-flows-be-modelled.md",
   "Key_Takeaways": "Scope: credit-risk modelling in thin-data settings (LC-07) and portfolio correlation and covariate risk (LC-08). First anchors landed 2026-08-22 and they turn out to be one problem, not two. LC-07's method (LIT-038, Pluto-Tasche for low default portfolios) estimates a PD as an upper confidence bound whose value depends on an ASSET CORRELATION supplied by assumption; LC-08 is the question of what that correlation actually is, and the answer is not yet known for this asset class. On LC-08 the historical evidence reframes the question: LIT-036 (four national repayment crises - PAR over 30 days above 10 per cent in three of four markets by June 2009, Nicaragua affecting all 22 major MFIs) attributes them to concentrated competition, multiple borrowing and social-network contagion, explicitly NOT to the global recession; LIT-037 sharpens it - individual MFI growth does not predict deterioration, but market-level borrower growth above 63 per cent a year and active loans above 10 per cent of population do. The correlation channel that matters historically is institutional and market-level, so diversifying geographically does not address it and pooling across lenders within one market may make it worse. Meanwhile LIT-031 shows the environmental channel is severe in the coffee setting now chosen. Two separable channels; EXP-25 should decompose them rather than estimate a single correlation. Not yet drafted as prose."
  },
  {
   "ID": "MEMO-8",
   "Memo_No": "8",
   "Title": "Legal and market preconditions",
   "Covers_Axis": "3-Securitization / 1-VSLA",
   "Status": "Outline",
   "Path": "literature/notes/memo-8-legal-and-market-preconditions.md",
   "Key_Takeaways": "Scope: true sale and SPV structuring across candidate jurisdictions, African and EM capital-market depth, and the regulation of savings groups and microinsurance. Not yet drafted."
  },
  {
   "ID": "MEMO-9",
   "Memo_No": "9",
   "Title": "Sector and infrastructure notes",
   "Covers_Axis": "6-Data and technology / 5-Insurance",
   "Status": "Drafted",
   "Path": "literature/notes/memo-9-sector-and-infrastructure-notes.md",
   "Key_Takeaways": "LC-24 section written 2026-08-22; the rest still outline. VERDICT ON THE COFFEE BET: it survives on both assumptions it was made on, but the risk moves rather than disappearing. (1) Cooperatives DO intermediate credit - LIT-031 has Root Capital stating that borrower enterprises on-lend to individual producers, bear the repayment risk, and run origination, disbursement, monitoring and repayment through an internal credit fund. That fund is the cash-flow object this project exists to make legible. (2) Member registers DO work as a sampling frame - LIT-033 compiled the cooperative and certification map from the Cooperatives Agency and the union, then sampled 20 cooperatives and 530 households proportional to membership; Sidama alone holds about 57 primary cooperatives and 85,000 farmers. (3) BUT certification cannot carry the welfare claim: LIT-032 (43 studies, no RCTs anywhere in the literature) finds price +14% and produce income +11% significant, while TOTAL household income is +6% and NOT significant, and worker wages are -13% and significant; LIT-034 replicates the null on household income across three continents. (4) THE UNASKED FINDING: coffee is close to a worst case for correlation. Leaf rust hit more than half of Central America's coffee area at once, cut El Salvador production 60%, and drove 80% output drops at some financed producer organisations; LIT-035 adds price, with 45 of 260 days flagged excessively variable in 2019/20. Two covariate shocks, both regional or global. That is the hardest case for poolability and the best case for MEASURING correlation - which of those the project wants is OQ-17's business, not an inheritance. Colombia's Coffee Price Stabilization Fund (Feb 2020) is a live sovereign comparator for EXP-09 and a displacement risk under OQ-11. Also notable for underwriting: LIT-031 discloses NO repayment, default or portfolio-at-risk figure, and public loss data on cooperative internal credit funds may simply not exist."
  }
 ],
 "resources": [
  {
   ...
   "Type": "Git",
   "Location": "GitHub",
   "URL": "https://github.com/benbaichmankass/sustainable-finance-venture",
   "Notes": "Canonical source of truth for project docs, trackers, methods and data"
  },
  {
   "ID": "RES-02",
   ...
   "URL": "",
   "Notes": "Private artifacts that do not belong in a public repo. Link resolves from the private overlay. See docs/ops/drive-vault.md."
  },
  {
   "ID": "RES-03",
  ...
  },
  {
   ...
   "Type": "Open-access library",
   "Location": "Web",
   "URL": "https://www.oecd.org/en/topics/blended-finance.html",
  ...
  },
  {
   ...
   "Type": "Open-access library",
   "Location": "Web",
   "URL": "https://www.convergence.finance/",
  ...
  {
   "ID": "RES-32",
   "Title": "Sweet Maria's Coffee Atlas - origins reference",
   "Category": "Reference source",
   "Type": "Website",
   "Location": "Web",
   "URL": "",
   "Notes": "Origin-by-origin reference on coffee growing regions, varietals and producer structures. Background for the coffee cluster (EXP-09, EXP-10, EXP-11) and literature component LC-24. URL deliberately blank: the page returned HTTP 403 to an automated check on 2026-08-22, which reads as bot protection rather than a dead link, but the repo rule is that an unverified URL is left blank rather than guessed. Confirm in a browser and fill it in."
  }
 ],
 "experiments": [
  {
   ...
   "Population": "Rainfed smallholder farming households in savings groups",
   ...
   "Design": "Cluster RCT: villages randomised to bundled cover versus loan-only, premium financed into principal",
   "Primary_Outcome": "Consumption smoothing conditional on index-measured drought exposure; 90-day-past-due incidence",
   "Toolbox_Fit": "RT-1 schema captures agro-climate and geospatial tags; RT-3 monitor watches rainfall-index triggers; impact module measures consumption smoothing through shocks. ⚠️ EVIDENCE WARNING 2026-08-22: this design - premium financed into principal so cover is compulsory rather than opt-in - is precisely what was tested and failed in LIT-024 (Malawi, take-up 13 points lower) and LIT-025 (India, 16 point rise in drop-out). Do not carry it forward as written without answering why it would go differently here. See OQ-17.",
   "RQ_Refs": "RQ-02; RQ-09; RQ-10; RQ-26",
   "Candidate_Partners": "VSL Associates / CARE VSLA network; J-PAL regional office; a local index-insurance underwriter",
   "Candidate_Funders": "J-PAL King Climate Action Initiative; 3ie; IDRC",
   "Research_Significance": "4",
   "PhD_Feasibility": "2",
   "Partner_Availability": "3",
   "Implementation_Ease": "2",
   "Grant_Exposure": "5",
   "Composite": "3.15",
   "Priority_Band": "Reserve",
   "Linked_Refs": "PL-1; OQ-3; OQ-11; OQ-15; OQ-16; LIT-024; LIT-025; OQ-17",
   "Status": "Idea"
  },
  {
   "ID": "EXP-02",
   ...
   "Population": "Off-grid rural households reached through savings groups",
   ...
   "Design": "Staggered rollout across group clusters with matched difference-in-differences; RCT where a distributor will randomise",
   "Primary_Outcome": "Repayment completion rate on the asset loan; clean-energy adoption and biomass displaced",
   ...
   "RQ_Refs": "RQ-02; RQ-03",
   "Candidate_Partners": "PAYGO solar distributors; VSLA networks; energy-access sector bodies",
   "Candidate_Funders": "Shell Foundation; IKEA Foundation; FSD Africa",
   "Research_Significance": "3",
   "PhD_Feasibility": "2",
   "Partner_Availability": "4",
   "Implementation_Ease": "3",
   "Grant_Exposure": "4",
   "Composite": "2.95",
   "Priority_Band": "Reserve",
   "Linked_Refs": "PL-1; OQ-11; OQ-15",
   "Status": "Idea"
  },
  {
   "ID": "EXP-03",
   ...
   "Population": "Smallholder cooperative members on water-constrained plots",
   ...
   "Design": "Single-vehicle demonstration with pre-post and matched comparison; not randomisable at realistic scale",
   "Primary_Outcome": "PPA and crop revenue realisation against model; cost of senior capital achieved",
   ...
   "RQ_Refs": "RQ-05",
   "Candidate_Partners": "Agricultural cooperatives; a DFI blended-finance desk; a utility offtaker",
   "Candidate_Funders": "Green Climate Fund; AFD / Proparco",
   "Research_Significance": "3",
   "PhD_Feasibility": "1",
   "Partner_Availability": "2",
  ...
  },
  {
   ...
   "Population": "Grain-farming households aggregated through savings groups",
   ...
   "Design": "Phased rollout across warehouses with difference-in-differences on sale timing and price realised",
   "Primary_Outcome": "Price realised per unit sold relative to harvest-time spot; distress-sale incidence",
   ...
   "RQ_Refs": "RQ-02; RQ-08",
   "Candidate_Partners": "Warehouse operators; commodity exchanges; VSLA networks",
   "Candidate_Funders": "IDRC; Mastercard Foundation",
   "Research_Significance": "3",
   "PhD_Feasibility": "2",
   "Partner_Availability": "3",
   "Implementation_Ease": "2",
  ...
  },
  {
   ...
   "Population": "Pastoralist households whose livestock is their main asset",
   ...
   "Design": "Cluster RCT on bundled index-based livestock cover, building on an established index protocol",
   "Primary_Outcome": "Livestock mortality and distress sales through a drought season; herd retention",
   "Toolbox_Fit": "Index triggers, monitoring and impact-evaluation modules; schema captures herd and geospatial data.",
   "RQ_Refs": "RQ-02; RQ-26",
   "Candidate_Partners": "Existing index-based livestock insurance programmes; pastoralist associations",
   "Candidate_Funders": "J-PAL King Climate Action Initiative; IDRC",
   "Research_Significance": "2",
   "PhD_Feasibility": "2",
   "Partner_Availability": "3",
   "Implementation_Ease": "2",
   "Grant_Exposure": "4",
  ...
  },
  {
   ...
   "Population": "Urban and peri-urban low-income households in climate-exposed settlements",
   ...
   "Design": "Cluster RCT: settlements randomised to multi-peril cover plus retrofit loan versus loan-only",
   "Primary_Outcome": "Productive-asset retention through a peril event; speed of recovery",
   ...
   "RQ_Refs": "RQ-02; RQ-07; RQ-24; RQ-26",
   "Candidate_Partners": "Urban community-based organisations; municipal partners; a parametric underwriter",
   "Candidate_Funders": "J-PAL King Climate Action Initiative; Rockefeller Foundation; Green Climate Fund",
   "Research_Significance": "4",
   "PhD_Feasibility": "2",
   "Partner_Availability": "2",
   "Implementation_Ease": "2",
   ...
   "Composite": "2.90",
   "Priority_Band": "Reserve",
   "Linked_Refs": "PL-1; OQ-11; OQ-15; OQ-16; LIT-024; OQ-17",
   "Status": "Idea"
  },
  {
   "ID": "EXP-07",
   ...
   "Population": "Remittance-receiving households in climate-vulnerable home regions",
   ...
   "Design": "Encouragement design on the sending side with matched comparison on the receiving side",
   "Primary_Outcome": "Formal savings balance and cover in force at time of shock; consumption smoothing",
   "Toolbox_Fit": "Data schema extended to remittance inflows; underwriting on transfer regularity.",
   "RQ_Refs": "RQ-08",
   "Candidate_Partners": "Remittance service providers; home-side community groups",
   "Candidate_Funders": "IDRC; AFD / Proparco",
   "Research_Significance": "3",
   "PhD_Feasibility": "2",
   "Partner_Availability": "2",
   "Implementation_Ease": "2",
  ...
  },
  {
   ...
   "Population": "Women-led micro-enterprises in the clean-energy value chain",
   ...
   "Design": "Phased facility rollout with matched difference-in-differences on enterprise outcomes",
   "Primary_Outcome": "Enterprise turnover and stockholding; facility loss rate",
   "Toolbox_Fit": "Underwriting engine and securitization modelling on trade receivables.",
   "RQ_Refs": "RQ-03; RQ-05",
   "Candidate_Partners": "Clean-energy distributor networks; women's enterprise associations",
   "Candidate_Funders": "Shell Foundation; Mastercard Foundation",
   "Research_Significance": "2",
   "PhD_Feasibility": "2",
   "Partner_Availability": "3",
   "Implementation_Ease": "2",
  ...
  },
  {
   ...
   "Theme": "Climate + Poverty",
   "Type": "Field RCT",
   "Geography": "East Africa / Latin America (coffee belts)",
   "Population": "Smallholder coffee growers in producer cooperatives",
   "Community_Context": "Smallholder coffee growers organised in producer cooperatives with existing certification and traceability systems",
   "Problem": "Coffee income collapses on the joint hit of price volatility and climate stress (leaf rust, drought, heat), and pre-harvest credit is repaid at exactly the wrong point in the price cycle.",
   "SDG_Refs": "SDG 1; SDG 2; SDG 13",
   "Product_Concept": "Pre-harvest credit through the cooperative bundled with a climate trigger and a price floor, so that repayment obligations flex with realised revenue rather than compounding the shock.",
   "Design": "Cluster RCT randomising cooperatives, or stepped wedge where a lender will not withhold",
   "Primary_Outcome": "Household coffee income through a shock season; loan completion rate at cooperative level",
   "Toolbox_Fit": "RT-1 schema maps onto existing certification records; RT-3 monitors both climate triggers and price; RT-5 pools cooperative receivables that a lender already finances.",
   "RQ_Refs": "RQ-02; RQ-08; RQ-27",
   "Candidate_Partners": "Producer cooperative federations; agricultural value-chain lenders; certification bodies",
   "Candidate_Funders": "IDRC; IKEA Foundation; 3ie",
   "Research_Significance": "4",
   "PhD_Feasibility": "3",
   "Partner_Availability": "4",
   "Implementation_Ease": "3",
   ...
   "Linked_Refs": "PL-1; LC-24; OQ-16; M-33; LIT-031; LIT-032; LIT-033; LIT-035",
   "Status": "Idea"
  },
  {
   "ID": "EXP-10",
   ...
   "Population": "Smallholder coffee growers exposed to leaf rust and heat stress",
   "Community_Context": "Coffee-growing households in cooperatives in rust-prone and heat-stressed altitudes",
   "Problem": "Coffee leaf rust and heat stress destroy multi-year plantings, and the loss is a slow-onset event that conventional indemnity cover prices badly and index cover has rarely been built for.",
   "SDG_Refs": "SDG 1; SDG 2; SDG 13",
   "Product_Concept": "A climate index calibrated to rust and heat-stress conditions rather than rainfall alone, bundled with replanting credit so a payout funds recovery rather than consumption.",
   "Design": "Cluster RCT on cover access, with index performance validated against observed loss",
   "Primary_Outcome": "Plantation survival and replanting rate after a rust or heat event; basis-risk rate of the index",
   "Toolbox_Fit": "Index design and trigger monitoring; schema captures altitude, varietal and plot-level agro-climate tags.",
   "RQ_Refs": "RQ-02; RQ-07; RQ-25",
   "Candidate_Partners": "Coffee research institutes; producer cooperative federations; parametric underwriters",
   "Candidate_Funders": "J-PAL King Climate Action Initiative; IDRC; Green Climate Fund",
   "Research_Significance": "4",
   "PhD_Feasibility": "3",
   "Partner_Availability": "4",
   "Implementation_Ease": "3",
  ...
  },
  {
   "ID": "EXP-11",
   "Theme": "Climate + Poverty",
   "Type": "Design science and administrative data",
   "Geography": "Global coffee origins",
   "Population": "Certified coffee cooperatives and their existing lenders",
   "Community_Context": "Coffee cooperatives already operating under certification and traceability regimes that capture transaction-level data",
   "Problem": "Certification and traceability systems already collect much of what an origination schema would demand, but the data was built for provenance claims rather than for credit, and nobody has tested whether it can carry underwriting.",
   "SDG_Refs": "SDG 1; SDG 8; SDG 12",
   "Product_Concept": "Repurpose existing traceability and certification records as an origination data tape, and test whether receivables against certified sales can be pooled without new field data capture.",
   "Design": "Design-science build against real certification data, validated by out-of-sample default prediction",
   "Primary_Outcome": "Share of RT-1 required fields satisfiable from existing records; predictive lift over a no-data baseline",
   "Toolbox_Fit": "Directly tests RT-1 against a live data source; if it holds, the marginal cost of securitisation-ready capture in this value chain is near zero.",
   "RQ_Refs": "RQ-06; RQ-21; RQ-01",
   "Candidate_Partners": "Certification bodies; agricultural value-chain lenders; cooperative federations",
   "Candidate_Funders": "FSD Africa; IDRC",
   "Research_Significance": "4",
   "PhD_Feasibility": "4",
   "Partner_Availability": "4",
  ...
  },
  {
   ...
   "Theme": "Mechanism",
   "Type": "Field RCT",
   "Geography": "Adaptable - any savings-group or SHG setting",
   "Population": "Savings-group members and the groups themselves as borrowers",
   "Community_Context": "Savings groups receiving external loan capital, in a network large enough to randomise the lending level",
   "Problem": "Securitisation removes the community as the individual-level creditor, which is the layer the evidence says does the actual work. Whether the local information advantage survives depends on where the external creditor attaches.",
   "SDG_Refs": "SDG 1; SDG 8",
   "Product_Concept": "Randomise whether external capital is lent to the group as a single borrower that on-lends to members, or directly to members with the group as guarantor. Contract economics held constant.",
   "Design": "Cluster RCT on lending level, with mechanism measures (screening decisions, monitoring contact, sanction events)",
   "Primary_Outcome": "Member-level default rate; measured local information use in screening decisions",
   "Toolbox_Fit": "This is the empirical test of OQ-13 and it determines which structure RT-1 and RT-5 must be built for.",
   "RQ_Refs": "RQ-01; RQ-04; RQ-16",
   "Candidate_Partners": "Savings-group network operators; an MFI willing to vary its lending structure; an academic field team",
   "Candidate_Funders": "3ie; IDRC; J-PAL",
   "Research_Significance": "5",
   "PhD_Feasibility": "2",
   "Partner_Availability": "2",
   "Implementation_Ease": "2",
   "Grant_Exposure": "4",
  ...
  },
  {
   ...
   "Theme": "Mechanism",
   "Type": "Field RCT",
   "Geography": "Adaptable - any savings-group setting with external funding available",
   "Population": "Savings-group members borrowing from mixed funding sources",
   "Community_Context": "Savings groups where some loan capital is the members' own accumulated savings and some is externally supplied",
   "Problem": "The mechanism evidence points at repeated interaction and members' own money at stake. Securitisation substitutes outside money for community money, and no study has randomised that substitution.",
   "SDG_Refs": "SDG 1; SDG 8",
   "Product_Concept": "Randomise, within treated groups, whether the loan fund is the group's own savings or external wholesale capital, holding terms and lending capacity constant.",
   "Design": "Second-layer randomisation within a cluster RCT (research-framework section 3)",
   "Primary_Outcome": "Repayment rate and arrears trajectory by funding source; informal risk-sharing measures",
   "Toolbox_Fit": "Tests the assumption every downstream tool rests on. A null result clears the pooling thesis; a negative result redirects the venture to the group-level structure.",
   "RQ_Refs": "RQ-01; RQ-04; RQ-15",
   "Candidate_Partners": "Savings-group network operators; an academic field team; a wholesale lender",
   "Candidate_Funders": "3ie; IDRC; J-PAL",
   "Research_Significance": "5",
   "PhD_Feasibility": "2",
   "Partner_Availability": "2",
  ...
  },
  {
   ...
   "Theme": "Mechanism",
   "Type": "Field RCT",
   "Geography": "Adaptable - savings-group networks at formation stage",
   "Population": "Newly formed savings groups",
   "Community_Context": "Savings groups at formation, where promoting NGOs already set constitution rules as a matter of course",
   "Problem": "Group rules on buffers and emergency funds are set by convention rather than evidence, and they plausibly determine whether a shock becomes a default.",
   "SDG_Refs": "SDG 1; SDG 8",
   "Product_Concept": "Randomise the constitution: capital buffer size and whether the group runs a separate emergency fund alongside the loan fund.",
   "Design": "Cluster RCT on rule variation at group formation, low marginal cost because rules are being set anyway",
   "Primary_Outcome": "Default incidence through the cycle; share of shocks absorbed without missed repayment",
   "Toolbox_Fit": "Cheapest way to test whether formal underwriting substitutes for or complements group self-insurance.",
   "RQ_Refs": "RQ-04; RQ-17",
   "Candidate_Partners": "Savings-group promoting NGOs; VSLA network trainers",
   "Candidate_Funders": "3ie; IDRC",
   "Research_Significance": "4",
   "PhD_Feasibility": "3",
   "Partner_Availability": "4",
   "Implementation_Ease": "4",
  ...
  },
  {
   ...
   "Theme": "Mechanism",
   "Type": "Field RCT",
   "Geography": "Adaptable - savings-group networks",
   "Population": "Savings-group members",
   "Community_Context": "Established savings groups where repayment information is currently shared informally or not at all",
   "Problem": "The information channel and the sanction channel can trade against each other. Which one disclosure strengthens is testable and has never been tested directly in this setting.",
   "SDG_Refs": "SDG 1; SDG 8",
   "Product_Concept": "Randomise whether individual repayment performance is disclosed to the full group, to officers only, or not at all.",
   "Design": "Cluster RCT on disclosure regime with measured social-cost outcomes alongside repayment",
   "Primary_Outcome": "Repayment rate; measured social sanction and group cohesion",
   "Toolbox_Fit": "Separates the information and sanction channels that Ghatak and Guinnane describe, using a lever a lender could actually pull.",
   "RQ_Refs": "RQ-04; RQ-17",
   "Candidate_Partners": "Savings-group promoting NGOs; an academic field team",
   "Candidate_Funders": "3ie; IDRC; J-PAL",
   "Research_Significance": "4",
   "PhD_Feasibility": "3",
   "Partner_Availability": "4",
  ...
  },
  {
   ...
   "Theme": "Climate + Poverty",
   "Type": "Field RCT",
   "Geography": "Adaptable - agricultural savings-group settings",
   "Population": "Smallholder borrowers on seasonal income cycles",
   "Community_Context": "Savings groups lending against seasonal agricultural income",
   "Problem": "Rigid repayment schedules are a poor fit for seasonal income and may generate defaults that reflect timing rather than capacity.",
   "SDG_Refs": "SDG 1; SDG 2",
   "Product_Concept": "Randomise repayment structure: rigid schedule, grace period, or income-flexible schedule tied to harvest timing.",
   "Design": "Cluster RCT on repayment structure",
   "Primary_Outcome": "Default rate and arrears volatility; household investment during the cycle",
   "Toolbox_Fit": "Cash-flow shape is exactly what a securitisation prices, so this speaks to both estimands at once.",
   "RQ_Refs": "RQ-02; RQ-03",
   "Candidate_Partners": "MFI and savings-group network partners",
   "Candidate_Funders": "3ie; IDRC",
   "Research_Significance": "3",
   "PhD_Feasibility": "3",
   "Partner_Availability": "4",
  ...
  },
  {
   ...
   "Theme": "Climate + Poverty",
   "Type": "Field RCT",
   "Geography": "Adaptable - any bundled-cover pilot site",
   "Population": "Borrowing households offered climate cover",
   "Community_Context": "Savings-group members offered cover alongside credit",
   "Problem": "Automatic cover financed into principal produces near-universal take-up, but it is then impossible to tell whether measured effects come from protection or from who ends up covered.",
   "SDG_Refs": "SDG 1; SDG 13",
   "Product_Concept": "Offer the same actuarial product three ways: financed into principal, opt-in at the same price, and opt-in with a subsidy that equalises take-up.",
   "Design": "Three-arm cluster RCT separating the protection effect from the take-up effect",
   "Primary_Outcome": "Resilience outcome conditional on shock, decomposed into take-up and protection channels",
   "Toolbox_Fit": "Answers the design question every bundling result depends on, and is a cheap add-on arm to any of the parametric pilots. PROMOTED IN IMPORTANCE 2026-08-22: the LC-04 read makes this the central experiment rather than an add-on arm. LIT-024 and LIT-025 show compulsory priced-in cover suppresses demand; LIT-026 shows demand is strong when cover is offered separately. Separating the take-up effect from the protection effect is therefore the live question in this literature, and this is the design that does it. See OQ-17.",
   "RQ_Refs": "RQ-02; RQ-09",
   "Candidate_Partners": "Any originator running a bundled pilot; an academic field team",
   "Candidate_Funders": "J-PAL King Climate Action Initiative; 3ie",
   "Research_Significance": "4",
   "PhD_Feasibility": "3",
   "Partner_Availability": "3",
   "Implementation_Ease": "3",
   ...
   "Composite": "3.45",
   "Priority_Band": "Strong",
   "Linked_Refs": "PL-1; LC-04; LIT-024; LIT-025; LIT-026; OQ-17",
   "Status": "Idea"
  },
  {
   "ID": "EXP-18",
   "Theme": "Climate + Poverty",
   "Type": "Field RCT",
   "Geography": "Adaptable - climate-exposed agricultural settings",
   "Population": "Smallholder households facing covariate climate risk",
   "Community_Context": "Savings groups in areas with an indexable climate peril",
   "Problem": "Insurance and contingent credit are alternative answers to the same problem, and the sector assumes insurance is better without having raced them directly.",
   "SDG_Refs": "SDG 1; SDG 13",
   "Product_Concept": "A drought-triggered contingent credit line versus a parametric insurance payout of equivalent expected value.",
   "Design": "Three-arm cluster RCT: contingent credit, parametric cover, control",
   "Primary_Outcome": "Consumption smoothing and asset retention conditional on trigger; cost per unit of protection delivered",
   "Toolbox_Fit": "Contingent credit is far cheaper to structure than insurance and needs no underwriter, so a null difference would change the product roadmap.",
   "RQ_Refs": "RQ-02; RQ-07",
   "Candidate_Partners": "MFI partners; parametric underwriters; an academic field team",
   "Candidate_Funders": "J-PAL King Climate Action Initiative; 3ie; IDRC",
   "Research_Significance": "4",
   "PhD_Feasibility": "2",
   "Partner_Availability": "3",
  ...
  },
  {
   ...
   "Theme": "Climate + Poverty",
   "Type": "Field RCT",
   "Geography": "Adaptable - any savings-group setting",
   "Population": "Savings-group member households",
   "Community_Context": "Savings groups where health shocks are a documented cause of default",
   "Problem": "Health shocks are consistently among the largest causes of both household distress and loan default, and they are idiosyncratic - exactly the risk community structures are supposed to be good at.",
   "SDG_Refs": "SDG 1; SDG 3",
   "Product_Concept": "Health microinsurance or a health-contingent repayment holiday bundled into group credit.",
   "Design": "Cluster RCT on bundled health cover versus credit alone",
   "Primary_Outcome": "Default incidence attributable to health events; out-of-pocket health expenditure and asset sales",
   "Toolbox_Fit": "Idiosyncratic risk diversifies inside a pool far better than covariate climate risk, so this may be the stronger securitisation case even where it is the weaker climate story.",
   "RQ_Refs": "RQ-02",
   "Candidate_Partners": "MFI and savings-group networks; health microinsurance providers",
   "Candidate_Funders": "3ie; IDRC; Rockefeller Foundation",
   "Research_Significance": "3",
   "PhD_Feasibility": "2",
   "Partner_Availability": "3",
   "Implementation_Ease": "2",
  ...
  },
  {
   ...
   "Theme": "Climate + Poverty",
   "Type": "Field RCT",
   "Geography": "Adaptable - mixed and single-gender group settings",
   "Population": "Women-only and mixed savings groups",
   "Community_Context": "Savings-group networks containing both women-only and mixed groups",
   "Problem": "Savings groups are predominantly women's institutions, and a design that ignores intra-household bargaining will mis-attribute its own effects.",
   "SDG_Refs": "SDG 1; SDG 5",
   "Product_Concept": "Bundled cover offered across groups of differing composition, with intra-household allocation measured.",
   "Design": "Cluster RCT stratified by group composition, with pre-specified heterogeneity analysis",
   "Primary_Outcome": "Resilience outcome by group composition; intra-household allocation of the payout",
   "Toolbox_Fit": "Heterogeneity here is a publishable result in its own right and a required robustness check on every other bundling estimate.",
   "RQ_Refs": "RQ-02; RQ-04",
   "Candidate_Partners": "Savings-group networks; an academic field team",
   "Candidate_Funders": "3ie; Mastercard Foundation; IDRC",
   "Research_Significance": "3",
   "PhD_Feasibility": "3",
   "Partner_Availability": "4",
   "Implementation_Ease": "3",
  ...
  },
  {
   ...
   "Type": "Field RCT",
   "Geography": "Adaptable - paper-ledger savings-group networks",
   "Population": "Savings groups currently keeping paper ledgers",
   "Community_Context": "Savings-group networks operating on paper record-keeping",
   "Problem": "Digitising the group ledger is a precondition for poolable data, but the act of recording may itself change behaviour - which would make the measurement instrument an intervention.",
   "SDG_Refs": "SDG 1; SDG 8",
   "Product_Concept": "Digital group ledger with standardised fields, rolled out against continued paper record-keeping.",
   "Design": "Cluster RCT on ledger digitisation, measuring behaviour as well as data quality",
   "Primary_Outcome": "Repayment rate change attributable to digitisation; completeness and error rate of captured records",
   "Toolbox_Fit": "Directly tests whether RT-1 capture is behaviourally neutral, which every downstream estimate quietly assumes.",
   "RQ_Refs": "RQ-06; RQ-23",
   "Candidate_Partners": "Savings-group network operators; digital financial services providers",
   "Candidate_Funders": "FSD Africa; Mastercard Foundation; IDRC",
   "Research_Significance": "4",
   "PhD_Feasibility": "4",
   "Partner_Availability": "4",
   "Implementation_Ease": "4",
   ...
   "Composite": "3.90",
   "Priority_Band": "Strong",
   "Linked_Refs": "PL-1; OQ-3; LC-14",
   "Status": "Idea"
  },
  {
   "ID": "EXP-22",
   "Theme": "Data infrastructure",
   "Type": "Field RCT with costing",
   "Geography": "Adaptable - any originator running two protocols",
   "Population": "Loan officers and originating groups",
   "Community_Context": "An originator willing to run two origination protocols side by side",
   "Problem": "The claim that designing for securitisation at origination beats retrofitting it has never been tested, and neither has its cost. Everyone in the sector repeats it; nobody has priced it. Note that the estimand depends on WHAT THE CONTROL ARM ACTUALLY IS: against a professionalised MFI with a working MIS the treatment measures the marginal cost of extra fields, but LIT-031 shows cooperative internal credit funds are often informal and unregulated with weak accounting, and against that counterfactual the treatment measures the cost of building a protocol from near-zero. Different quantities; originator type is a pre-specified moderator, not a nuisance.",
   "SDG_Refs": "SDG 1; SDG 8",
   "Product_Concept": "Securitisation-ready origination protocol (full RT-1 field set) versus the originator's standard protocol, on randomly assigned branches or officers.",
   "Design": "Cluster-randomised protocol assignment (branch level where cluster count allows, otherwise officer level within branch, accepting contamination that biases toward the null) with activity-based costing of both arms. Cluster COUNT is the binding constraint, not household sample size - a mid-size originator has 10-40 branches. Stratify on branch size and maturity; multi-originator recruitment is the fallback. Treatment uses the full RT-1 field set through the originator's EXISTING capture tool, extended - never a new app, which would confound protocol cost with tool-adoption cost. Fallback ladder: branch randomisation, officer randomisation, stepped wedge, then unrandomised time-and-motion, which is a costing exercise and not an experiment.",
   "Primary_Outcome": "ONE primary: marginal operational cost per household originated, treatment minus control, by activity-based costing on timestamped capture logs (self-reported time is systematically biased and is a validity check only). Secondary families: cost structure (the H2 learning curve against cumulative originations; the H3 per-field cost distribution, which yields a ranked cost curve an originator can adopt incrementally), record quality, officer and borrower burden, and - DEFERRED, not gating - default predictability once the cohort seasons. The tracker row previously named cost and predictability as co-primaries; they run on incompatible clocks, so predictability is pre-registered and postponed, and RQ-21 is reallocated to EXP-25's retrospective panels, which already contain seasoned defaults.",
   "Toolbox_Fit": "The direct test of RQ-06 and one of the two falsification tests that can run before any product pilot. Turns RT-1 from a design document into a costed proposition, and its validator doubles as a live test of the schema - a field the validator keeps rejecting is a schema defect, not an officer error. Spec at docs/research/experiments/exp-22-origination-protocol-costing.md.",
   "RQ_Refs": "RQ-01; RQ-06; RQ-21; RQ-22",
   "Candidate_Partners": "An MFI or savings-group network with branch-level operations, or a cooperative union with an internal credit fund (different estimand - see Problem). Screen for CLUSTER COUNT before enthusiasm. Requires HR or staff-representation approval for officer time measurement, which is a separate approval from the data-sharing agreement and is the one that gets forgotten.",
   "Candidate_Funders": "FSD Africa; IDRC",
   "Research_Significance": "5",
   "PhD_Feasibility": "4",
   "Partner_Availability": "3",
   ...
   "Grant_Exposure": "3",
   "Composite": "4.00",
   "Priority_Band": "Flagship candidate",
   "Linked_Refs": "PL-1; OQ-3; RT-1; OQ-15; LIT-031; RQ-21; EXP-25; M-32",
   "Status": "Specified"
  },
  {
   "ID": "EXP-23",
   "Theme": "Capital markets",
   "Type": "Framed experiment with investors",
   "Geography": "No field site required",
   "Population": "Impact investors, structurers and credit analysts",
   "Community_Context": "Professional investors and analysts recruited through fund networks and industry bodies",
   "Problem": "The sector assumes investors will not price community-originated assets because the data is poor, but nobody has measured what disclosure actually changes a price.",
   "SDG_Refs": "SDG 17",
   "Product_Concept": "Present a synthetic community-originated data tape to investors with randomly varied disclosure - track record length, field granularity, verification status - and elicit indicative pricing.",
   "Design": "Framed field experiment with randomised information sets and incentivised elicitation",
   "Primary_Outcome": "Indicative spread quoted, and willingness to engage at all, by disclosure condition",
   "Toolbox_Fit": "Turns RT-5 output into a research instrument. Needs no field site, no IRB burden beyond standard human-subjects review, and no partner NGO.",
   "RQ_Refs": "RQ-05; RQ-19",
   "Candidate_Partners": "Impact-investor networks; microfinance investment vehicle managers; industry associations",
   "Candidate_Funders": "Academic small-grant schemes; institutional research funds",
   "Research_Significance": "5",
   "PhD_Feasibility": "5",
   "Partner_Availability": "3",
   ...
   "Composite": "4.40",
   "Priority_Band": "Flagship candidate",
   "Linked_Refs": "RT-5; OQ-2",
   "Status": "Idea"
  },
  {
   "ID": "EXP-24",
   "Theme": "Capital markets",
   "Type": "Structured elicitation",
   "Geography": "No field site required",
   "Population": "Rating analysts, structurers and DFI credit committees",
   "Community_Context": "Professionals who decide whether an asset class is rateable",
   "Problem": "Whether a rating agency will engage with community-level receivables before a track record exists is the open residual on OQ-2, and it is currently unanswered because nobody has asked systematically.",
   "SDG_Refs": "SDG 17",
   "Product_Concept": "Structured elicitation and scenario review with raters and structurers on eligibility criteria, minimum track record, and what would have to be true to rate this asset class.",
   "Design": "Delphi-style structured elicitation with pre-registered scenario set",
   "Primary_Outcome": "Stated minimum conditions for engagement; convergence across respondents",
   "Toolbox_Fit": "Converts the biggest unknown in the securitisation thesis from speculation into documented expert opinion, and doubles as relationship-building.",
   "RQ_Refs": "RQ-05; RQ-19",
   "Candidate_Partners": "Rating agencies; structuring advisers; DFI blended-finance desks",
   "Candidate_Funders": "Academic small-grant schemes",
   "Research_Significance": "4",
   "PhD_Feasibility": "4",
   "Partner_Availability": "3",
   "Implementation_Ease": "4",
   ...
   "Composite": "3.65",
   "Priority_Band": "Strong",
   "Linked_Refs": "OQ-2; RT-5",
   "Status": "Idea"
  },
  {
   "ID": "EXP-25",
   "Theme": "Risk modelling",
   "Type": "Administrative data study",
   "Geography": "Multi-country, wherever partner data exists",
   "Population": "Existing loan portfolios of savings-group networks and MFIs",
   "Community_Context": "Historical management-information-system data from one or more originators across regions",
   "Problem": "The pooling thesis rests on defaults being idiosyncratic rather than covariate. They are covariate - but through TWO separable channels, and only one of them is diversifiable. The environmental channel (weather, pathogen, price) is agro-climatic and can in principle be diversified across regions. The institutional channel (market saturation, multiple borrowing, contagion) is a MARKET-level factor: LIT-037 finds individual lender growth does not predict portfolio deterioration while market-level penetration does. If that is the operative factor, a pool assembled from several lenders in one country is not diversified against the thing that historically predicts trouble.",
   "SDG_Refs": "SDG 17",
   "Product_Concept": "No product. Estimate default correlation across groups, regions, time and agro-climatic zones from existing portfolio data.",
   "Design": "Retrospective multi-level variance-components study on administrative loan panels. Hierarchical GLMM (discrete-time survival form where censoring is recorded) over borrower / group / branch / agro-climatic zone / lender / market, with lender CROSSED against zone - that crossing is what separates the institutional channel from the environmental one, and it is why the design needs at least two lenders per market and at least two markets. Plus an explicit mapping step: fit a single-factor Vasicek model to recover the asset correlation the tools actually consume.",
   "Primary_Outcome": "The MARKET-level intra-class correlation of loan default, with its confidence interval. Secondary: the full ICC decomposition by level; the penetration interaction (LIT-037 thresholds tested on loan-level data for the first time); cross-market portability of each component (RQ-28); and the recovered asset correlation rho fed to RT-5.",
   "Toolbox_Fit": "Feeds RT-5 the one parameter its own documentation calls the one that matters most, and which it currently handles with a sweep from independence to near-perfect correlation. Also supplies the asset correlation that LIT-038 shows the Pluto-Tasche PD bound takes as an ASSUMED input - so this experiment converts an assumption into an estimate. A falsification test that can run before any pilot exists. Spec at docs/research/experiments/exp-25-default-correlation.md.",
   "RQ_Refs": "RQ-03; RQ-13; RQ-28",
   "Candidate_Partners": "MFI and savings-group networks willing to share historical data; sector data repositories",
   "Candidate_Funders": "FSD Africa; academic research funds",
   "Research_Significance": "5",
   "PhD_Feasibility": "4",
   "Partner_Availability": "3",
   "Implementation_Ease": "4",
   ...
   "Composite": "4.10",
   "Priority_Band": "Flagship candidate",
   "Linked_Refs": "RT-5; OQ-2; LC-08; OQ-15; LIT-031; LIT-036; LIT-037; LIT-038; LIT-030; LIT-035; OQ-17; RQ-28; EXP-22",
   "Status": "Specified"
  },
  {
   "ID": "EXP-26",
   ...
   "Type": "Administrative data study",
   "Geography": "Multi-country, wherever partner data exists",
   "Population": "Existing savings-group and microfinance loan books",
   "Community_Context": "A historical loan book with observed defaults and recoveries",
   "Problem": "There is no published loss curve for community-originated lending in a form a structured-finance analyst would recognise, which is why the asset class cannot be priced.",
   "SDG_Refs": "SDG 17",
   "Product_Concept": "No product. Fit survival and hazard models to time-to-default and time-to-claim, and estimate loss given default from observed recoveries.",
   "Design": "Survival analysis with horizon sensitivity on historical panels",
   "Primary_Outcome": "Fitted default hazard and loss-given-default estimates with stated confidence bounds",
   "Toolbox_Fit": "Produces the loss curve RT-5 currently synthesises, and is publishable independently of any pilot.",
   "RQ_Refs": "RQ-03; RQ-12",
   "Candidate_Partners": "MFI and savings-group networks; sector data repositories",
   "Candidate_Funders": "FSD Africa; academic research funds",
   "Research_Significance": "4",
   "PhD_Feasibility": "4",
   "Partner_Availability": "3",
  ...
  },
  {
   ...
   "Geography": "No field site required",
   "Population": "Simulated pools calibrated to observed parameters",
   "Community_Context": "Model portfolios built from whatever empirical parameters are available",
   "Problem": "The enhancement level required to reach investment grade is asserted from blended-finance averages rather than derived from this asset class, and the sensitivity of that number is unknown.",
   "SDG_Refs": "SDG 17",
   "Product_Concept": "No product. Systematic sensitivity analysis of first-loss thickness, originator diversification and reserve design against modelled loss distributions.",
   "Design": "Monte Carlo waterfall simulation with full parameter sweep",
   "Primary_Outcome": "Required first-loss thickness for investment-grade loss characteristics, and its sensitivity to each input",
   "Toolbox_Fit": "RT-5 already exists; this is the study that turns it from an internal tool into a paper. Weak alone, strong once EXP-25 or EXP-26 supplies real parameters.",
   "RQ_Refs": "RQ-03; RQ-14; RQ-24",
   "Candidate_Partners": "None required",
   "Candidate_Funders": "Institutional research funds",
   "Research_Significance": "3",
   "PhD_Feasibility": "5",
  ...
  },
  {
   ...
   "Geography": "Multi-country, from published replication data",
   "Population": "Participants in published savings-group and microcredit trials",
   "Community_Context": "Replication archives of completed randomised evaluations",
   "Problem": "A large body of savings-group RCT data exists and has been analysed exclusively for treatment effects. Nobody has re-read it for the cash-flow properties a financial engineer would want.",
   "SDG_Refs": "SDG 17",
   "Product_Concept": "No product. Re-analyse published trial data for repayment timing, arrears distribution and variance rather than mean treatment effects.",
   "Design": "Individual participant data re-analysis with hierarchical pooling across trials",
   "Primary_Outcome": "Pooled distributional properties of repayment behaviour across contexts; between-study heterogeneity",
   "Toolbox_Fit": "Cheap, fast, publishable, and it directly tests how far risk parameters travel between sites.",
   "RQ_Refs": "RQ-03; RQ-08; RQ-28",
   "Candidate_Partners": "Trial authors and replication archives; academic collaborators",
   "Candidate_Funders": "Academic research funds",
   "Research_Significance": "4",
   "PhD_Feasibility": "4",
   "Partner_Availability": "4",
   "Implementation_Ease": "4",
   ...
   "Composite": "3.80",
   "Priority_Band": "Strong",
   "Linked_Refs": "LC-08; LC-13",
   "Status": "Idea"
  },
  {
   "ID": "EXP-29",
   "Theme": "Climate + Poverty",
   "Type": "Field pilot and protocol development",
   "Geography": "Israel",
   "Population": "Migrant workers in employer-linked savings and lending arrangements",
   "Community_Context": "Migrant-worker communities operating informal savings arrangements within a regulated employment framework",
   "Problem": "Migrant workers save and lend informally with no formal cover, and a shock at home or in employment cascades into loss of both income and status.",
   "SDG_Refs": "SDG 1; SDG 8; SDG 10",
   "Product_Concept": "Savings product with income-protection cover anchored to an existing worker network, used primarily as a controlled setting to develop the protocol and data pipeline.",
   "Design": "Small-n pilot with matched comparison; the value is protocol development, not identification",
   "Primary_Outcome": "Protocol and instrument performance; take-up and cover-in-force; data completeness",
   "Toolbox_Fit": "Logistically accessible testbed for the RT-1 pipeline, the survey instruments and the consent protocol before deploying somewhere harder.",
   "RQ_Refs": "RQ-08; RQ-29",
   "Candidate_Partners": "Worker associations; Israeli community development organisations; a local academic research centre",
   "Candidate_Funders": "Local foundations and academic funds - note Israel is ineligible for most development-research grant streams",
   "Research_Significance": "3",
   "PhD_Feasibility": "4",
   "Partner_Availability": "3",
   "Implementation_Ease": "4",
  ...
  },
  {
   ...
   "Theme": "Climate + Poverty",
   "Type": "Field RCT",
   "Geography": "Adaptable - any index-insurance pilot site",
   "Population": "Insured smallholder households",
   "Community_Context": "Smallholder farmers under an index insurance product",
   "Problem": "Basis risk is the standard explanation for weak index-insurance demand, but whether reducing it is worth its cost has not been established.",
   "SDG_Refs": "SDG 1; SDG 2; SDG 13",
   "Product_Concept": "The same cover verified two ways: a satellite-derived area index versus picture-based or field-verified loss assessment.",
   "Design": "Cluster RCT on verification method, with both measures collected for every household",
   "Primary_Outcome": "Measured basis-risk rate by method; welfare effect per unit of verification cost",
   "Toolbox_Fit": "Feeds the index-design side of RT-3 and answers whether cheap-and-imperfect is the efficient design.",
   "RQ_Refs": "RQ-07; RQ-25",
   "Candidate_Partners": "Parametric underwriters; agricultural research institutes; an academic field team",
   "Candidate_Funders": "J-PAL King Climate Action Initiative; IDRC; Green Climate Fund",
   "Research_Significance": "4",
   "PhD_Feasibility": "3",
   "Partner_Availability": "3",
 ...
 "driveLinks": [
  {
   "ID": "DRV-01",
   "Drive_ID": "1uT8Q_a8WBN5GnCLzuFoHk6ANz6Tz3zen",
   "Repo_Path": "",
   "Type": "folder",
   "Parent_ID": "",
   "Title": "SFV Drive Workfolder",
   "Category": "",
   "Baseline_Drive_Hash": "",
   "Baseline_Repo_Hash": "",
   "Last_Synced_At": "",
  ...
  {
   "ID": "DRV-02",
   "Drive_ID": "1la3yCx6cPrG7egAeN2U0fs-vrQRQtqP_s5aJXjtn2cw",
   "Repo_Path": "docs/ops/dashboard-design.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
  ...
  {
   "ID": "DRV-03",
   "Drive_ID": "17SPG20JXBlV7ttw9kwQDzys5cY-5D7e1ypI5MVvL1NA",
   "Repo_Path": "docs/ops/drive-vault.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   ...
   "Last_Synced_At": "2026-08-17T22:56:42Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-04",
   "Drive_ID": "1zta0w4UvMMxs8NJ94xT7yFNbLjWemr6W1r6zSL29ULw",
   "Repo_Path": "docs/venture/funding-pipeline.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   ...
   "Last_Synced_At": "2026-08-20T14:03:46Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-05",
   "Drive_ID": "14p075-s_ZTxyP5VLwVbA73sFugJX-mIscAGD9T5GNeI",
   "Repo_Path": "docs/venture/macro-watch.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   "Title": "Macro watch — live values, the watchlist, and the observation log",
   "Category": "Planning",
   "Baseline_Drive_Hash": "aa19956bccabfa4d5978de016de0c533fe1de55d474fbc8f217a358eecaae452",
   "Baseline_Repo_Hash": "aa19956bccabfa4d5978de016de0c533fe1de55d474fbc8f217a358eecaae452",
   "Last_Synced_At": "2026-08-20T10:40:21Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-06",
   "Drive_ID": "1g5y0M1O1LhZiPSeut609m9P_6WNpuJRu4QUwfB4tBcs",
   "Repo_Path": "docs/research/methodology-impact-measurement.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
  ...
  {
   "ID": "DRV-07",
   "Drive_ID": "1PaeZID1UPZu5iiz3Yh_JA9gyTJmPdkwqNcSMhuqLyfs",
   "Repo_Path": "docs/research/methodology-opportunity-mapping.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   "Title": "Methodology: Mapping Underserved SDG Opportunities against Toolbox Capacity",
   "Category": "Planning",
   "Baseline_Drive_Hash": "f8473eef9bf8d1fd65476745fa31f3e158910e51a6e5b5321d8d6486d84b1cf0",
   "Baseline_Repo_Hash": "f8473eef9bf8d1fd65476745fa31f3e158910e51a6e5b5321d8d6486d84b1cf0",
   "Last_Synced_At": "2026-08-22T17:46:01Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-08",
   "Drive_ID": "1eX_22wniy3dQ02ReCC-PKLms-y81EugndVsuinFf9HE",
   "Repo_Path": "docs/venture/milestone-plan.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   "Title": "60/90-Day Milestone Plan",
   "Category": "Planning",
   "Baseline_Drive_Hash": "b0252be70b20e833ed29c0efc05a43120c82f982f5012fbb2c74b7f4b5661ea0",
   "Baseline_Repo_Hash": "b0252be70b20e833ed29c0efc05a43120c82f982f5012fbb2c74b7f4b5661ea0",
   "Last_Synced_At": "2026-08-21T18:16:37Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-09",
   "Drive_ID": "1kq8MEcXwwmt_lY6DlcziHObyjCa8ImrOvvclbKYdLfs",
   "Repo_Path": "docs/phd/phd-funding-landscape.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   "Title": "PhD funding landscape — how the money actually works",
   "Category": "Planning",
   "Baseline_Drive_Hash": "e3774a066eebee18c9988d9163137dcf8eaace2bb7ba17efea14a77c94be94e1",
   "Baseline_Repo_Hash": "e3774a066eebee18c9988d9163137dcf8eaace2bb7ba17efea14a77c94be94e1",
   "Last_Synced_At": "2026-08-19T17:14:37Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-10",
   "Drive_ID": "1MnELrosA3uFYqYLcb0yIbvcV1Bc536Z5rNKdzgWDCrU",
   "Repo_Path": "docs/phd/phd-proposal-master.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
  ...
  {
   "ID": "DRV-11",
   "Drive_ID": "11yrmR1zsr1_lUEZhbauC8mU8XVCIqnS5C0-Ja6a5LwQ",
   "Repo_Path": "docs/phd/phd-scoring-rubric.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   "Title": "PhD Program Scoring Rubric",
   "Category": "Planning",
   "Baseline_Drive_Hash": "ad58cb20489cddfc4a73a03aacec86bbffc34c4eceafa81f2c99a5b2001bd49f",
   "Baseline_Repo_Hash": "ad58cb20489cddfc4a73a03aacec86bbffc34c4eceafa81f2c99a5b2001bd49f",
   "Last_Synced_At": "2026-08-22T14:43:41Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-12",
   "Drive_ID": "1SqbR47CeJzjIIxqb6p4QgRjPYIB7NyrVtYv_0h5dWtk",
   "Repo_Path": "docs/ops/private-overlay.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   ...
   "Last_Synced_At": "2026-08-19T01:48:30Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-13",
   "Drive_ID": "1AM5M88k5m6ysFSUB5ym8MMxis9m7j9tGlh9cCEh2moc",
   "Repo_Path": "docs/ops/publishing.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   ...
   "Baseline_Repo_Hash": "28ac8f45a87123c6e45e32c1be4e48b863d9dd2499230242a4fdd2a6e3092507",
   "Last_Synced_At": "2026-08-19T06:18:39Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-14",
   "Drive_ID": "1jN1FDmjKzt4Q9Mh75kOLTUsxYHxH6IOWhZMRSiBo2kw",
   "Repo_Path": "docs/research/research-agenda.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
  ...
  {
   "ID": "DRV-15",
   "Drive_ID": "1oUfVrJAMGqK6KAca1a3-CrU0kprlkLREzUBIaiZAxRA",
   "Repo_Path": "docs/phd/research-proposal.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
  ...
  {
   "ID": "DRV-16",
   "Drive_ID": "1MeKFsWSMaA-VZLRKU3x8i6Uh9IzrjW9zW9F-NZ4R3KA",
   "Repo_Path": "docs/research/working-doc.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   ...
   "Baseline_Repo_Hash": "e6910b1a8c239ac3a668c46994b1645aafa7e592d2d04b3130a353ad45a9fdc1",
   "Last_Synced_At": "2026-08-05T07:53:52Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-17",
   "Drive_ID": "1Vy8NvPXDT7eYJFjX3m_HNqetMTGIEYblkhD10OPWTn4",
   "Repo_Path": "literature/notes/memo-1-vslas.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
  ...
  {
   "ID": "DRV-18",
   "Drive_ID": "1JUYK8gqH1MJB8XoKrkMk7kAbgjK9JFW6QVwu8of81CM",
   "Repo_Path": "literature/notes/memo-2-microfinance-impact.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
  ...
  {
   "ID": "DRV-19",
   "Drive_ID": "1X0rD5DHEUNvW_Da6fsJbeGd-iQfE04JrNBuKHvFyFUk",
   "Repo_Path": "literature/notes/memo-3-securitization-blended-finance.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   "Title": "Memo 3: Securitization & Blended Finance — Synthesis for Product/Research Design",
   "Category": "Synthesis memos",
   "Baseline_Drive_Hash": "6a87c8f8fea96b0529d4dc6a98f11b8d62553e06ea9fa3a926c4c838265ab3c7",
   "Baseline_Repo_Hash": "6af7a85875c7c6bd6e04705d4ed262f1a920b4a13b7a8ea976ce80560f1b1466",
   "Last_Synced_At": "2026-08-05T07:48:17Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-20",
   "Drive_ID": "181G9h3DtfgpoMk3xQ67QOPT0aA5AZjJovXw7lQyrE2M",
   "Repo_Path": "product-design/business-economics.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   ...
   "Baseline_Repo_Hash": "e99d3171ff11f39096d7e867f4bf8bda17ff89afce0516af592b8f0e1c93b342",
   "Last_Synced_At": "2026-08-21T22:36:06Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-21",
   "Drive_ID": "1HfQnQaVJcmvtmS_-Rma_mzUfbm-6qejEUv8PRbk7_2c",
   "Repo_Path": "product-design/business-plan.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
  ...
  {
   "ID": "DRV-22",
   "Drive_ID": "10_XtI7Es-igYLtJw3nCH-wMV1basvXOx1pIpjv21K5Q",
   "Repo_Path": "product-design/product-lines/agrivoltaic-project-finance.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   ...
   "Last_Synced_At": "2026-08-17T15:44:57Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-23",
   "Drive_ID": "1_gDWYrvkXFUt3py6KKNU23dHlW812L5irBvIQ7GBT0A",
   "Repo_Path": "product-design/product-lines/community-credit-and-insurance.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   "Title": "Product Line 1 — Community Credit & Insurance",
   "Category": "Product & business",
   ...
   "Last_Synced_At": "2026-08-20T17:14:40Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-24",
   "Drive_ID": "1FbdjhbEVueU7CHZSGh-F8OsCQ1_gi-u30TwKJQbT6hw",
   "Repo_Path": "risk-tools/README.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   ...
   "Last_Synced_At": "2026-08-10T20:05:42Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-25",
   "Drive_ID": "15khAisUhFxgKoNL0ly04aEGvy7XbPDy9TmcZZPlAH2A",
   "Repo_Path": "risk-tools/rt-1-origination-schema.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   "Title": "RT-1 — Origination data schema",
   "Category": "Risk tools",
   "Baseline_Drive_Hash": "2fc8901beae11e3e8e5c2317394d16db84d2fdbf2a0dfb90ed8e43a9ec37d462",
   "Baseline_Repo_Hash": "0f77cfd40458bb4c597804aeec39ac3cddbff6fed78bf81bef11f5b7c73bf5a5",
   "Last_Synced_At": "2026-08-05T07:48:17Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-26",
   "Drive_ID": "1qJ1GZ9eO1T5t57QeINlEsz2bjuehzqq4diWjscJIl9o",
   "Repo_Path": "risk-tools/rt-2-rt-3-scaffolds.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   "Title": "RT-2 and RT-3 scaffolds — scorecard and monitor",
   "Category": "Risk tools",
   "Baseline_Drive_Hash": "acc4a2d865f004bbed99da41fde52f2380f00dfed6faf18ccc5b0a67014e5986",
   "Baseline_Repo_Hash": "acc4a2d865f004bbed99da41fde52f2380f00dfed6faf18ccc5b0a67014e5986",
   "Last_Synced_At": "2026-08-21T22:03:24Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-27",
   "Drive_ID": "1neC5mGzsoRwVjbg84rmH8kFAXpNNbdUEVnGhIc010WE",
   "Repo_Path": "risk-tools/rt-2-underwriting-engine.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   "Title": "RT-2 — Underwriting engine",
   "Category": "Risk tools",
   "Baseline_Drive_Hash": "02673e4e29ceb4b96849eb4362eccc59f793aa4aea2f71960cb3234c7dfa4706",
   "Baseline_Repo_Hash": "720a5866013dea9dd75fbbef016cc02226b47a33a0f246d5ae322ac232caa87d",
   "Last_Synced_At": "2026-08-05T07:48:17Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-28",
   "Drive_ID": "1FhZRuW0P4Uhwtvx65HfZ1sPILIx-hs2DyoN2CcDB4UQ",
   "Repo_Path": "risk-tools/rt-3-monitoring-early-warning.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   "Title": "RT-3 — Monitoring and early-warning system",
   "Category": "Risk tools",
   "Baseline_Drive_Hash": "50b1a7c72f56b00b471fc2fae7e91b0aa1ab92e95acb35c4080a100ecb499385",
   "Baseline_Repo_Hash": "e81b72b0b362589e893f85df2d0f8d919bf6530b16fed157136040eb54a78ddd",
   "Last_Synced_At": "2026-08-05T07:48:17Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-29",
   "Drive_ID": "125uBYfD_dhYfhjLkyMkfA7Or4jJZtNHdLX3OX-thULA",
   "Repo_Path": "risk-tools/rt-4-impact-evaluation.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   "Title": "RT-4 — Impact evaluation module",
   "Category": "Risk tools",
   "Baseline_Drive_Hash": "08db230e20bc315bf7c9a79a682f04f7a5f76b3f72caa074f7854804c4a1b9af",
   "Baseline_Repo_Hash": "08db230e20bc315bf7c9a79a682f04f7a5f76b3f72caa074f7854804c4a1b9af",
   "Last_Synced_At": "2026-08-21T16:48:10Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-30",
   "Drive_ID": "1Bc5G63qzc0LZjLn32osz_a3drjA2LnBBn02BI9JvRj0",
   "Repo_Path": "risk-tools/rt-5-securitisation-model.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   "Title": "RT-5 — Securitisation cash-flow model",
   "Category": "Risk tools",
   "Baseline_Drive_Hash": "7b5a3604cfd7693463d6b4b32e899bdbea35a09ad1adf37e5861db4893ed277a",
   "Baseline_Repo_Hash": "f701a5900bb224ac4487ea3b244f039868cc0686be045f38cf1d3ee81fc21b1c",
   "Last_Synced_At": "2026-08-05T07:48:17Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-31",
   "Drive_ID": "1ynCQXfbWsKZxjAKSDL5FXpAZhdC6ipA8bsmeY_BsN04",
   "Repo_Path": "risk-tools/rt-5-simulator.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   "Title": "RT-5 simulator — what it is, what it is not",
   "Category": "Risk tools",
   "Baseline_Drive_Hash": "2252abc02fd0aba052809269dc1e9a26883757578d787d7750a9179c25902a89",
   "Baseline_Repo_Hash": "2252abc02fd0aba052809269dc1e9a26883757578d787d7750a9179c25902a89",
   "Last_Synced_At": "2026-08-20T17:14:49Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-32",
   "Drive_ID": "1orfWI300hUQcwjyUfSRoWGLyv4Xgk5CxnME0kXC0A6I",
   "Repo_Path": "risk-tools/rt-6-economics-model.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   ...
   "Last_Synced_At": "2026-08-20T12:17:03Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-33",
   "Drive_ID": "1Ma2FJeQak-ADQf_-RuNx5NUs7Zourc9vICCOSDw9aRQ",
   "Repo_Path": "risk-tools/schema/README.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   ...
   "Last_Synced_At": "2026-08-14T00:02:35Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-34",
   "Drive_ID": "1rQ1M9CkGN0PEU_ucA2DNXkLcHVktd5mFq7FKkpkwmDM",
   "Repo_Path": "docs/ops/scratchpad.md",
   "Type": "doc",
   "Parent_ID": "DRV-01",
   "Title": "Scratchpad",
   "Category": "Planning",
 ...
 "docs": [
  ...
  {
   "path": ".claude/skills/sync-drive/SKILL.md",
   "group": "AI skills",
   "section": "Working procedures",
   "docId": "",
  ...
  {
   "path": "docs/ops/private-overlay.md",
   "group": "Operations",
   "section": "Publishing & privacy",
   "docId": "",
   "title": "The private overlay — collaborator onboarding",
  ...
  },
  {
   ...
   "docId": "",
   "title": "Content licence — CC BY 4.0",
   "summary": "",
   "words": 282,
   "body": "# Content licence — CC BY 4.0\n\nCopyright 2026 Ben Baichman-Kass\n\nThe **written and tabular content** of this repository is licensed under the\n[Creative Commons Attribution 4.0 International licence (CC BY 4.0)](https://creativecommons.org/licenses/by/4.0/).\n\nFull legal text: https://creativecommons.org/licenses/by/4.0/legalcode\n\n## What this covers\n\nEverything that is writing or data rather than software:\n\n- `docs/` — working doc, research agenda, milestone plan, publishing policy\n- `literature/` — the literature matrix and all synthesis memos\n- `product-design/` — business plan and product-line documents\n- `data/` — all trackers (milestones, open questions, partners, PhD programs, product lines, resources)\n- `archive/` — archived source documents\n- `README.md`, `CLAUDE.md`, and the skills in `.claude/skills/`\n\nSoftware — `dashboard/build.py`, `dashboard/index.html`, and any future analysis\nor modelling code — is licensed under the Apache License 2.0 instead. See\n`LICENSE`.\n\nWhere a single file is arguably both (the dashboard page contains prose), the\nApache licence governs the file and CC BY governs the prose it renders.\n\n## What you may do\n\nShare and adapt this material for any purpose, including commercially, provided\nyou give appropriate credit, link to the licence, and indicate if changes were\nmade.\n\n## Attribution\n\nA reasonable citation:\n\n> Baichman-Kass, B. (2026). *Sustainable Finance Venture: research and product\n> design for securitizing community-originated financial assets.*\n> https://github.com/benbaichmankass/sustainable-finance-venture\n> Licensed under CC BY 4.0.\n\n## What this does not cover\n\nThe literature matrix and memos summarise and cite works published by others.\n**Those works are not licensed by us.** They remain the property of their\nauthors and publishers under their own terms. What CC BY 4.0 covers here is our\nsummary, coding, relevance assessment and analysis — not the sources themselves.\n\nFull texts of cited sources are not distributed with this repository.\n"
  },
  {
   "path": "README.md",
   "group": "Operations",
  ...
  {
   "path": "docs/phd/phd-scoring-rubric.md",
   "group": "PhD track",
   "section": "Applications & funding",
   "docId": "",
   "title": "PhD Program Scoring Rubric",
   "summary": "",
   "words": 1657,
   "body": "# PhD Program Scoring Rubric\n\n*How the 43 candidate programs in `data/phd-programs.csv` are scored and ranked for outreach. Companion to the interactive workbook (`PhD-Program-Tracker.xlsx`, in the project) and the landscape synthesis (`phd-landscape.md`). This is a decision aid, not a verdict: the scores encode the current research, and every program flagged \"to verify\" in `Verification_Status` should be confirmed by direct email before its ranking hardens.*\n\n## The problem the rubric solves\n\nNo single department combines the four pillars this project needs (development economics and impact evaluation; financial inclusion and microinsurance; securitization and structured finance; sustainable and blended finance). So the rubric does not look for one perfect programme. It scores each candidate on six factors, weights them toward what matters most for this project and this applicant, and groups the field so the first wave of supervisor outreach goes to the strongest combined fits rather than the single highest-prestige name.\n\n## The six criteria and their scales\n\nEach program is scored 1 to 5 on each criterion. The anchors below define what a score means so the numbers stay comparable across programs.\n\n**1\\. Supervisor fit** — a named academic actively publishing on the thesis topics (microfinance, financial inclusion, impact evaluation, microinsurance, securitization/structured finance). 5 \\= one or more verified, directly on-topic supervisors. 4 \\= a verified supervisor covering a core pillar strongly, with a caveat (e.g. an RCT/impact-evaluation lead, or a microfinance scholar whose current capacity needs confirming). 3 \\= a plausible or likely fit but no confirmed on-topic supervisor, or a verified but tangential match. 2 \\= weak. 1 \\= none identifiable.\n\n**2\\. Venture and pilot fit** — part-time or fieldwork flexibility, tolerance of running the venture in parallel, and proximity to the Israel and Africa pilot sites. 5 \\= an explicit part-time or venture-parallel route, or a \"the venture is the thesis\" alignment, plus pilot proximity. 3 \\= full-time but fieldwork-friendly and RCT-native. 1 \\= full-time residential, relocation required, venture-incompatible.\n\n**3\\. Funding and cost** — stipend, fee coverage, cost of living, and the likelihood of actually securing an award. 5 \\= a salaried or guaranteed-funded post with low or no fees. 3 \\= a competitive scholarship. 1 \\= self-funded or high total cost.\n\n**4\\. Method / impact-evaluation fit** — strength in RCT and quasi-experimental impact evaluation, the backbone of the verification-heavy design. 5 \\= a leading RCT / field-experiment group. 3 \\= solid econometrics. 1 \\= none.\n\n**5\\. Structured-finance fit** — depth in securitization, tranching, first-loss design, and actuarial / microinsurance pricing. 5 \\= specialist capital-markets or actuarial faculty. 3 \\= general finance. 1 \\= none.\n\n**6\\. Prestige and network** — reputation, DFI and industry links, placement, and credibility. 5 \\= a world-leading brand with strong development-finance ties. 1 \\= limited reach.\n\n## Weights\n\n| Criterion | Weight |\n| :---- | :---- |\n| Supervisor fit | 25% |\n| Venture and pilot fit | 25% |\n| Funding and cost | 20% |\n| Method / impact-evaluation fit | 10% |\n| Structured-finance fit | 10% |\n| Prestige and network | 10% |\n\nThe three factors flagged as priorities — supervisor fit, venture/pilot fit, and funding — carry 70% of the weight between them. Method and structured-finance fit sit at 10% each because, given that no department has everything, those gaps are expected to be filled by a co-supervisor rather than the primary programme, so they inform the choice without dominating it. Prestige is a deliberate 10%: a tie-breaker, not a driver. The weights are the single most important lever; changing them in the workbook re-ranks the field instantly, and it is worth testing (for example, raising venture/pilot fit if staying in Israel becomes non-negotiable, or funding if self-funding is ruled out).\n\n## The uncertainty rule\n\nA program whose on-topic supervisor is not yet confirmed — anything marked \"supervisor to verify / to identify / to secure\" in `Verification_Status` — is capped at 3 out of 5 on Supervisor fit, however promising the department looks. This keeps unproven fits from topping the ranking on the strength of a name we have not yet confirmed can and will supervise. In this pass the cap only moved one program (BRAC/SOAS, from 4 to 3); every other capped program was already at 3 or below, which is a sign the base scores were already honest about where the evidence is thin.\n\n## Tiering\n\nPrograms are grouped by weighted score so the ranking drives action rather than just sorting names:\n\n- **Priority** (score at or above 3.55) — the first wave of supervisor outreach.  \n- **Consider** (2.95 to 3.54) — strong on some axes with a specific caveat; a good second wave, or a first wave if a Priority program's supervisor declines.  \n- **Backup** (below 2.95) — pursue only if a specific supervisor or funding route opens up.\n\n## The ranking (default weights)\n\n**Priority (13)**\n\n| Rank | Score | Program | Region | Why it leads |\n| :---- | :---- | :---- | :---- | :---- |\n| 1 | 4.05 | University of East Anglia (PHD-15) | UK | Verschoor: weather-index insurance \\+ RCTs; int'l-eligible funding; part-time possible |\n| 1 | 4.05 | CERMi, ULB/UMONS (PHD-20) | Europe | The most on-topic microfinance research home in Europe; Belgian funded-PhD models |\n| 1 | 4.05 | IHEID Geneva, CFD (PHD-21) | Europe | Vandewalle: RCTs \\+ financial inclusion; impact-investing framing; UN/DFI ecosystem |\n| 4 | 3.95 | HUJI Business School (PHD-10) | Israel | Best Israel fit: Sade/Yafeh/Bracha, permits outside part-time work, local pilot |\n| 5 | 3.90 | SMU (PHD-31) | Asia | Hao Liang: microfinance \\+ sustainable finance; funded PhD or exec DBA |\n| 6 | 3.85 | SOAS (PHD-13) | UK | Volz; strongest UK thematic breadth; part-time route |\n| 7 | 3.85 | Manchester GDI (PHD-14) | UK | Sen/Savoia/Regasa/Barrientos; development-finance \\+ social-protection cluster |\n| 8 | 3.85 | Krea / IFMR \\+ LEAD (PHD-30) | Asia | Financial-inclusion RCT heartland; rare part-time hybrid route |\n| 9 | 3.80 | Groningen (PHD-22) | Europe | Lensink: microfinance \\+ microinsurance \\+ RCTs; Dutch salaried PhD |\n| 10 | 3.75 | Bath CDS (PHD-16) | UK | Susan Johnson: financial inclusion in Africa (FSD Kenya); part-time possible |\n| 11 | 3.60 | Antwerp IOB (PHD-23) | Europe | Cassimon: development / blended finance; applied, fieldwork-native |\n| 12 | 3.55 | KU Leuven LICOS (PHD-24) | Europe | D'Espallier: microfinance; top department; funded positions |\n| 13 | 3.55 | Wageningen (PHD-27) | Europe | Bulte: RCTs \\+ index insurance; Dutch salaried PhD |\n\n**Consider (21)**\n\n| Rank | Score | Program | Region |\n| :---- | :---- | :---- | :---- |\n| 14 | 3.50 | UNU-MERIT (PHD-26) | Europe |\n| 15 | 3.40 | Mannheim / ZEW (PHD-29) | Europe |\n| 16 | 3.30 | Geneva GFRI (PHD-07) | Europe |\n| 17 | 3.25 | Frankfurt School (PHD-25) | Europe |\n| 18 | 3.25 | Toulouse / Paris SE (PHD-41) | Europe |\n| 19 | 3.25 | Gothenburg / SSE (PHD-42) | Europe |\n| 20 | 3.20 | CERDI (PHD-28) | Europe |\n| 21 | 3.15 | LSE (PHD-05) | UK |\n| 22 | 3.15 | Bayes Actuarial (PHD-18) | UK |\n| 23 | 3.15 | IESEG / KU Leuven (PHD-08) | Europe |\n| 24 | 3.10 | TAU Coller (PHD-02) | Israel |\n| 25 | 3.10 | TAU Berglas Economics (PHD-11) | Israel |\n| 26 | 3.10 | NUS (PHD-32) | Asia |\n| 27 | 3.10 | HKUST (PHD-34) | Asia |\n| 28 | 3.05 | NTU (PHD-33) | Asia |\n| 29 | 3.05 | IE DBA (PHD-38) | Remote |\n| 30 | 3.00 | Technion DDS (PHD-12) | Israel |\n| 31 | 3.00 | Cambridge Judge (PHD-06) | UK |\n| 32 | 3.00 | Nottingham (PHD-40) | UK |\n| 33 | 2.95 | Oxford OSFG (PHD-04) | UK |\n| 34 | 2.95 | Loughborough (PHD-09) | UK |\n\n**Backup (9)**\n\n| Rank | Score | Program | Region |\n| :---- | :---- | :---- | :---- |\n| 35 | 2.85 | HUJI Bogen Economics (PHD-01) | Israel |\n| 36 | 2.80 | BRAC / SOAS joint (PHD-35) | Asia |\n| 37 | 2.80 | Open University (PHD-36) | Remote |\n| 38 | 2.80 | Henley DBA (PHD-39) | Remote |\n| 39 | 2.75 | Heriot-Watt DBA (PHD-37) | Remote |\n| 40 | 2.60 | Reading ICMA (PHD-17) | UK |\n| 41 | 2.55 | IDS / Sussex (PHD-19) | UK |\n| 42 | 2.30 | Ben-Gurion (PHD-03) | Israel |\n| 43 | 2.25 | ISS Rotterdam (PHD-43) | Europe |\n\n## How to read this\n\nThe Priority group is deliberately mixed by region and format so the first outreach wave is not a bet on one geography: it spans a funded RCT-and-insurance fit in the UK (UEA), the two best European microfinance homes (CERMi, IHEID), the strongest Israel option that lets the venture run (HUJI Business School), a part-time-friendly Asian route (Krea), and several salaried-PhD European programmes (Groningen, KU Leuven, Wageningen). Two structural notes carry over from the landscape synthesis: most of these are development-side homes that will need a finance or actuarial co-supervisor for the securitization craft, and the ranking rewards confirmed supervisors, so a \"Consider\" program can jump into Priority the moment a named supervisor there says yes. Re-score in the workbook as replies come in.\n\n## Caveats\n\nThe scores are the author's best reading of the research as of August 2026, not measured values. Stipend figures, deadlines, part-time eligibility and individual supervisors' current capacity all shift year to year and several are still unverified (see `Verification_Status` in the tracker). Treat the ranking as a prioritised worklist for confirmation and outreach, not a final answer.  \n"
  },
  {
   "path": "docs/phd/phd-funding-landscape.md",
   "group": "PhD track",
   "section": "Applications & funding",
   "docId": "",
   "title": "PhD funding landscape — how the money actually works",
  ...
  {
   "path": "docs/phd/phd-proposal-master.md",
   "group": "PhD track",
   "section": "Proposal & positioning",
   "docId": "",
   "title": "Structuring Community Savings-Group Finance into Securitizable, Empirically Verified Risk Assets",
  ...
  },
  {
   ...
   "section": "Evidence synthesis",
   "docId": "MEMO-3",
   "title": "Securitization & Blended Finance — Synthesis for Product/Research Design",
   "summary": "",
   "words": 1578,
  ...
  {
   "path": "docs/research/methodology-impact-measurement.md",
   "group": "Research",
   "section": "Programme & method",
   "docId": "",
   "title": "Methodology: Measuring the SDG Impact of the Financial Products",
  ...
  {
   "path": "risk-tools/rt-2-rt-3-scaffolds.md",
   "group": "Risk tools",
   "section": "Tool specs",
   "docId": "RT-2/3",
  ...
  },
  {
   ...
   "section": "Tool specs",
   "docId": "RT-3",
   "title": "Monitoring and early-warning system",
   "summary": "",
   "words": 622,
  ...
  },
  {
   ...
   "section": "Tool specs",
   "docId": "RT-4",
   "title": "Impact evaluation module",
   "summary": "",
   "words": 750,
  ...
  },
  {
   ...
   "section": "Tool specs",
   "docId": "RT-5a",
   "title": "Securitisation cash-flow model",
   "summary": "",
   "words": 805,
  ...
  {
   "path": "risk-tools/rt-5-simulator.md",
   "group": "Risk tools",
   "section": "Tool specs",
   "docId": "RT-5b",
   "title": "Simulator - what it is, what it is not",
   "summary": "",
   "words": 1050,
  ...
  {
   "path": "docs/venture/funding-pipeline.md",
   "group": "Venture",
   "section": "Delivery & funding",
   "docId": "",
   "title": "Grant & Funding Plan for Research Experiments",
  ...
  },
  {
   ...
   "docId": "PL-1",
   "title": "Community Credit & Insurance",
   "summary": "",
   "words": 627,
   "body": "# Product Line 1 — Community Credit & Insurance\n\n**Status:** Concept, pilot design pending · **Origination layer:** VSLAs, MFIs, NGOs, employer networks · **Asset:** loan repayments and insurance premiums **Lineage:** `archive/google-drive/web3-vsla-business-plan.md` (Feb 2025\\) · **Last updated:** 2026-07-30\n\n## Concept\n\nLoans and insurance originated through community-based financial structures, designed from origination to be standardized, verifiable and poolable. The community structure is not incidental — it is the underwriting mechanism. VSLAs already perform screening, monitoring and social enforcement at the local level, which is what makes small-ticket lending economic where atomized individual underwriting is not.\n\n## Evidence position\n\nThis line rests on the strongest evidence base of the two product lines, and the evidence constrains what we may claim:\n\n- Cluster-RCT evidence and cross-country synthesis show **consistent, replicable gains in savings and resilience** (LIT-001, LIT-002).  \n- Income and business-investment effects are **smaller and more heterogeneous** (LIT-002, LIT-003).  \n- Parametric microinsurance improves resilience and payout speed but suffers from low take-up without bundling, and from basis risk (LIT-007).\n\nThe product must therefore be framed around resilience and consumption smoothing, not income growth. See Memo 2 — this is an alignment rather than a concession, since cash-flow regularity is what an investor underwrites anyway.\n\n## The hard part: data\n\nThe asset is fine. The **data about the asset** is the bottleneck.\n\nVSLA cycles already generate structured, periodic records — contributions, payouts, loan requests, repayments. Turning those into something a rating agency will look at requires a schema designed at origination, not retrofitted (OQ-3).\n\nLIT-014 supplies the policy constraint that shapes the answer: savings-group regulation is heading toward light-touch **registration with digitised group records**, delegated to local authorities, NGOs and federations — not prudential supervision. So the schema must be light enough to live inside that regime, and framed as a benefit to the group (visibility, access to finance) rather than a compliance burden. A schema that only works inside a supervised financial institution will not reach the groups.\n\n## Products\n\n1. **Group-guaranteed credit** — the base instrument.  \n2. **Parametric microinsurance** — bundled rather than sold standalone, given LIT-007's take-up finding. Open design question: can triggers be built around group-level shocks (e.g. remittance disruption for migrant-worker groups) rather than only weather?  \n3. **Bundled credit \\+ cover** — likely the strongest product, and the one that most needs pilot evidence.\n\nWhich of the three goes first is undecided and is on the critical path.\n\n## Pilot direction\n\n**Israel (migrant-worker communities) first**, Africa second. Not because Israel is the larger market — it isn't — but because the first pilot's job is to prove the *data and verification infrastructure*, and that is better done somewhere with logistical proximity, hands-on project management, and an existing regulatory environment around foreign-worker insurance.\n\nAfrica is the scale opportunity: deep community-finance traditions, high exclusion, alignment with blended-finance narratives, and a nascent securitization market offering first-mover advantage in standard-setting.\n\n## What did not survive from the 2025 plan\n\nThe original framing delivered this through blockchain — VSLAs as DAOs, smart-contract governance, liquidity pools. That mechanism is dropped. It solved a trust and governance problem that VSLAs already solve socially, while adding crypto-regulatory exposure, FX risk and unsecured-deposit risk the venture has no reason to carry.\n\nWhat survived: the community-finance core, the pooled-liquidity/structured-product revenue model, the non-controlling investor posture (we take return on capital without taking governance control of the group), and the insurance expansion path.\n\n## Open questions\n\n- OQ-3 — the origination data schema. Blocks everything downstream.  \n- OQ-4 / OQ-5 — cluster randomization vs stepped-wedge for the pilot evaluation.  \n- OQ-7 — which verification partners can provide independent, ideally blinded, outcome data.  \n- Loan vs insurance vs bundled as the first instrument.  \n- Does the RCT effect persist beyond the 1–2 year evaluation window, and without NGO support?\n\n"
  },
  {
   "path": "product-design/product-lines/agrivoltaic-project-finance.md",
   "group": "Venture",
