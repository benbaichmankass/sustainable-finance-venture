...
window.SFV_DATA = {
 ...
 "litComponents": [
  ...
  },
  {
   ...
   "Axis": "5-Insurance",
   "Priority": "P1",
   "Why_It_Matters": "Flagged as a gap in research-proposal.md and never filled. Underpins EXP-01, EXP-06, EXP-30 and the whole of RQ-07. Currently one anchor.",
  ...
  },
  {
   ...
   "Axis": "3-Securitization",
   "Priority": "P1",
   "Why_It_Matters": "Diversification is the whole argument for pooling. If defaults are covariate rather than idiosyncratic, the pooling thesis weakens sharply, and the repo currently has no evidence either way.",
 ...
 "memos": [
  ...
  },
  {
   ...
   "Key_Takeaways": "PARTIAL - only LC-04 of its three components is read, and all four sources are verified from abstracts rather than full texts. The finding: bundling is NOT untested. Compulsory bundling suppressed demand in two RCTs - Gine & Yang 2009 Malawi (take-up 13 points lower off a 33.0% base) and Banerjee, Duflo & Hornbeck 2014 India (16 point, 23 percent rise in microfinance drop-out, measured on the lender's book). Against them, Karlan et al. 2014 Ghana finds uninsured risk rather than capital is the binding constraint and demand for SEPARATELY offered index insurance is strong. The reconciling distinction is offered-separately versus compulsorily-priced-into-the-loan, and Carter, Cheng & Sarris 2016 is the theory that asks it, conditioned on the collateral environment. Consequences: the proposal's novelty claim is false as written (OQ-17), EXP-01's design is the one that failed twice, EXP-17 becomes the centrepiece, and RT-6 can no longer treat bundling as retention-neutral."
  },
  {
   "ID": "MEMO-6",
   "Memo_No": "6",
