...
window.SFV_DATA = {
 ...
 "milestones": [
  ...
  },
  {
   ...
   "Detail": "Expand the shortlisted experiments from tracker rows into full specs at docs/research/experiments/, using the template in docs/research/experiment-spec-template.md. Three to five, no more. Gated on M-27 deciding which ones.",
   "Status": "Not started",
   "Owner": "BB",
   "Linked_Refs": "M-27; OQ-15; EXP-22; EXP-25"
  },
  {
   "ID": "M-31",
   "Phase": "Days 1-30",
 ...
 "experiments": [
  ...
  },
  {
   ...
   "Problem": "The pooling thesis rests on defaults being idiosyncratic rather than covariate. If they are covariate, diversification buys far less than assumed and the structure does not work.",
   "SDG_Refs": "SDG 17",
   ...
   "Design": "Multi-level correlation estimation on historical administrative panels",
   "Primary_Outcome": "Estimated cross-group and cross-region default correlation; covariate share of total variance",
   "Toolbox_Fit": "Feeds RT-5 the one parameter it currently assumes. A falsification test that can run before any pilot exists.",
   ...
   "Composite": "4.10",
   "Priority_Band": "Flagship candidate",
   "Linked_Refs": "RT-5; OQ-2; LC-08; OQ-15; LIT-031; LIT-036; LIT-037; LIT-038",
   "Status": "Selected"
  },
  {
   "ID": "EXP-26",
