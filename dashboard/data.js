...
window.SFV_DATA = {
 ...
 "litComponents": [
  ...
  },
  {
   ...
   "Axis": "5-Insurance",
   "Priority": "P3",
   "Why_It_Matters": "Added 2026-08-22 after the user raised coffee growers as a candidate population. Coffee is attractive because cooperative receivables are already financed, so the counterfactual is legible - but that has to be verified, not assumed.",
   "Serves_RQs": "RQ-02; RQ-08",
 ...
 "openQuestions": [
  ...
  },
  {
   ...
   "Status": "Open",
   "Owner": "BB",
   "Notes": "Raised 2026-08-22. WHAT THE SCORING SAYS: top of the ranking is EXP-23 (investor framed experiment, 4.40), EXP-25 (portfolio correlation on partner MIS, 4.10) and EXP-22 (securitisation-ready origination protocol with costing, 4.00). The trio scores EXP-01 3.15, EXP-02 2.95, EXP-06 2.90. The coffee cluster added this pass scores well: EXP-11 3.90, EXP-09 and EXP-10 3.60. THE CAVEAT THAT MATTERS: the rubric weights PhD feasibility at 30 percent, and desk studies beat multi-year field pilots on that criterion by construction. This is not an artefact to be corrected - feasibility genuinely is a PhD constraint - but it means the ranking should not be read as a straight swap. The trio are field pilots that GENERATE the primary data the high-scoring desk studies re-analyse; EXP-25, EXP-26 and EXP-28 all depend on somebody else's portfolio existing, and a thesis composed only of secondary-data studies has no field contribution and does not support RQ-02 at all. THE READING WE THINK IS HONEST: a sequenced portfolio rather than a replacement. Run the cheap falsification tests FIRST - EXP-25 and EXP-22 are the two that could kill the thesis before any field money is spent (research-framework section 11) - then commit to one field pilot as the anchor, chosen with the advisor and the site actually available. On current scores the field anchor is more likely EXP-09/EXP-10 (coffee cooperatives, better partner access and existing data rails) than EXP-01, but that depends on partner access that has not been tested. OQ-11's answer STANDS until BB decides. Priority_Band in data/experiments.csv is the rubric's view; Status is the decision, and the trio remain Selected. To resolve: pick a sequence, update the Status column, and either confirm or supersede OQ-11.",
   "Evidence_Refs": "EXP-22; EXP-23; EXP-25; EXP-09; EXP-11; OQ-11; OQ-9"
  }
 ],
 "productLines": [
  {
 ...
 "milestones": [
  ...
  },
  {
   ...
   "Detail": "Read the nine P1 components in data/lit-components.csv (about 77 new anchors) and draft synthesis memos 5, 6 and 7. LC-04 (bundled credit and insurance) goes first because it can invalidate the proposal's central novelty claim - the master proposal asserts the literature raises but rarely tests bundling, and that assertion is currently unverified. Done when the nine components read Reviewed and the three memos exist, not when an anchor count is hit.",
   "Status": "Not started",
   "Owner": "BB",
   "Linked_Refs": "LC-04; LC-03; LC-05; LC-07; LC-08; MEMO-5; MEMO-6; MEMO-7; M-01"
  },
  {
   "ID": "M-27",
   "Phase": "Days 1-30",
   "Milestone": "Resolve OQ-15: fix the experiment portfolio and its sequence",
   "Detail": "The 2026-08-22 scoring pass ranks the OQ-11 flagship trio below nine desk-feasible studies. Decide the portfolio: which cheap falsification tests run first (EXP-25, EXP-22), which single field pilot is the anchor, and whether OQ-11 is confirmed or superseded. This is a decision rather than research and should not wait on the literature.",
   "Status": "Not started",
   "Owner": "BB",
 ...
 "memos": [
  ...
  },
  {
   ...
   "Key_Takeaways": "Scope: the practical rails - digital capture, PAYGO receivables, value-chain and warehouse finance, cost-to-serve, remittances, the coffee sector, and data governance. Not yet drafted."
  }
 ],
 "resources": [
  {
