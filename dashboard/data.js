...
window.SFV_DATA = {
 ...
 "milestones": [
  ...
  },
  {
   ...
   "Detail": "Read the ten P1 components in data/lit-components.csv (96 targets, 13 filled, so 83 new anchors) and draft synthesis memos 5, 6 and 7. LC-04 (bundled credit and insurance) goes first because it can invalidate the proposal's central novelty claim - the master proposal asserts the literature raises but rarely tests bundling, and that assertion is currently unverified. LC-24 (coffee-sector economics) joined this tier on 2026-08-22, not because coffee was chosen but because it was not: the coffee cluster outscores every other field candidate on assumptions about partner reachability and certification data that nobody has tested, and reading is the cheap way to test them before OQ-16 is decided. Done when the ten components read Reviewed and the three memos exist, not when an anchor count is hit.",
   "Status": "Not started",
   "Owner": "BB",
   "Linked_Refs": "LC-04; LC-03; LC-05; LC-07; LC-08; LC-24; MEMO-5; MEMO-6; MEMO-7; M-01; OQ-16"
  },
  {
   "ID": "M-27",
   "Phase": "Days 1-30",
  ...
  },
  {
   "ID": "M-33",
   "Phase": "Days 60-120",
   "Milestone": "Choose the single field anchor experiment (OQ-16)",
   "Detail": "Pick one field pilot from EXP-01, EXP-06, EXP-09 and EXP-10, with the advisor and against the site actually available. Gated on three things: a supervisor conversation (which shapes the lead RQ strand, OQ-14), tested partner access, and the LC-04 and LC-24 reads. Whichever is chosen should carry the second randomisation layer (funding source) from research-framework section 3, since that is the design contribution and it needs a field setting. On resolution, set that experiment to Selected and spec it against docs/research/experiment-spec-template.md (M-30).",
   "Status": "Not started",
   "Owner": "BB",
   "Linked_Refs": "OQ-16; OQ-14; M-26; M-29; M-30; M-32"
  },
  {
   "ID": "M-34",
   "Phase": "Days 1-30",
 ...
 "driveLinks": [
  ...
  },
  {
   ...
   "Category": "Planning",
   "Baseline_Drive_Hash": "c01dd7ce489422c48302cdf5d1dc465dd7cc6f1157945fd4b18acf497f36e1da",
   "Baseline_Repo_Hash": "c01dd7ce489422c48302cdf5d1dc465dd7cc6f1157945fd4b18acf497f36e1da",
   "Last_Synced_At": "2026-08-21T14:47:36Z",
   "Status": "Synced"
  },
  {
   "ID": "DRV-11",
